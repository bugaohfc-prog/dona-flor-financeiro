...
const RUBRICA_CENTRO_SUGERIDO = new Map([
  ...
  [RUBRICA_IMPOSTOS_FOLHA, CENTROS_CUSTO_ATUAIS.ENCARGOS_TRABALHISTAS],
  [RUBRICA_IMPOSTOS_VENDAS, CENTROS_CUSTO_ATUAIS.TRIBUTOS_VENDAS],
  ...
  [RUBRICA_IMPOSTOS_PARCELADOS, CENTROS_CUSTO_ATUAIS.PARCELAMENTOS_TRIBUTARIOS],
