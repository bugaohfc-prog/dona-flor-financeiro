    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        <div style={styles.filtros}>
          <button style={filtro === 'todas' ? styles.filtroAtivo : styles.filtro} onClick={() => setFiltro('todas')}>
            Todas
          </button>
          <button style={filtro === 'pendentes' ? styles.filtroAtivo : styles.filtro} onClick={() => setFiltro('pendentes')}>
            Pendentes
          </button>
          <button style={filtro === 'pagas' ? styles.filtroAtivo : styles.filtro} onClick={() => setFiltro('pagas')}>
            Pagas
          </button>
          <button style={filtro === 'vencidas' ? styles.filtroAtivo : styles.filtro} onClick={() => setFiltro('vencidas')}>
            Vencidas
          </button>
        </div>

        <div style={styles.formCard}>
          <h2 style={styles.subTitle}>➕ Nova Conta</h2>
          ...
          <button onClick={adicionarConta} style={styles.botaoSalvar}>
            Salvar Conta
          </button>
        </div>
