...
export default function Relatorios({ voltar }) {
  ...
  if (temSemCentro && semCentro?.percentual >= 80) {
    insights.push({
      tipo: 'critico',
      texto: 'Toda ou grande parte da despesa está sem classificação por centro de custo. Isso significa que hoje não é possível identificar com precisão onde o dinheiro está sendo gasto. Sem essa divisão, decisões de corte, investimento ou expansão ficam menos seguras.'
    })
  }
