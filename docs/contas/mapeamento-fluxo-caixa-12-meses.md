...
- filial obrigatória;
- mês/ano final obrigatório.

Regra:

- o usuário escolhe o mês final, por exemplo `2026-04`;
- o sistema calcula os 11 meses anteriores;
- o relatório monta 12 colunas mensais em ordem cronológica;
- movimentos com data de caixa dentro de cada mês entram na coluna correspondente;
- meses sem movimento devem sair com `0`.
...
- Listar contas pagas dos últimos 12 meses por filial.
...
- O usuário escolhe filial e mês/ano final.
- O relatório gera exatamente 12 meses.
