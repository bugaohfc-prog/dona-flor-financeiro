    ...
    <div style={styles.page}>
      ...
      <section style={styles.filtrosBox}>
        ...
        <div style={styles.acoes}>
          <button style={styles.btnCinza} onClick={limparFiltros}>Limpar filtros</button>
