-- DONA FLOR V11 FINAL - SUPABASE
-- Rode no SQL Editor. Se aparecer aviso, clique em "Executar sem RLS".
...
values ('Administrador', 'admin', 'admin123', 'admin', null, true, true);

select usuario, senha, tipo, ativo from public.df_usuarios;
