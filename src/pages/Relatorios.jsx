...
export default function Relatorios({ voltar }) {
  ...
  if (scoreSaude < 75 && scoreSaude >= 45) {
    statusSaude = {
      ...
      emoji: '⚠️',
      cor: '#ffc107',
      descricao: 'Existem pontos que merecem acompanhamento, principalmente concentração e variação mensal.'
    }
  }
  ...
  if (scoreSaude < 45) {
    statusSaude = {
      ...
      emoji: '🚨',
      cor: '#dc3545',
      descricao: 'Há sinais relevantes de risco. Priorize vencidos, concentração de custos e aumento mensal.'
    }
  }
  ...
  if (!filtroCentro && principalCentro && principalCentro.percentual >= 50) {
    ...
    if (principalCentro.nome === 'Sem centro') {
      insights.push({
        tipo: 'ação',
        texto: 'Há valores sem centro de custo. Sugestão: classificar essas despesas para melhorar a leitura gerencial.'
      })
    }
  ...
  // =========================
  // BLOCO 7 — GRÁFICO DE PIZZA SIMPLES
  // =========================
