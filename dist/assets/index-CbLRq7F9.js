import{r as c,j as e,a as es,R as ts}from"./vendor-react-CAFUplbN.js";import{c as as}from"./vendor-supabase-D2gm834s.js";import{R as va,L as ii,C as so,X as lo,Y as co,T as ja,a as oo,B as ji,b as yi,P as wi,c as ki,d as Ci}from"./vendor-charts-BQjpdmhu.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const d of n)if(d.type==="childList")for(const l of d.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function o(n){const d={};return n.integrity&&(d.integrity=n.integrity),n.referrerPolicy&&(d.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?d.credentials="include":n.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(n){if(n.ep)return;n.ep=!0;const d=o(n);fetch(n.href,d)}})();const os=void 0;function rs(){return!!os}function is(){return rs()?"":"Configure VITE_SUPABASE_URL e VITE_SUPABASE_ANON_KEY antes de usar o sistema."}const D=as("https://placeholder.supabase.co","placeholder-anon-key",{auth:{persistSession:!0,autoRefreshToken:!0,detectSessionInUrl:!0}});function Zt(t){const a=String(t||"").toLowerCase().trim();return["admin","adm","administrador","master","owner"].includes(a)?"admin":["gerente","gerencia","gestor","manager"].includes(a)?"gerente":["financeiro","financas","finanças","financial"].includes(a)?"financeiro":["operacional","operacao","operação","atendente"].includes(a)?"operacional":["visualizacao","visualização","viewer","leitura","consulta"].includes(a)?"visualizacao":(["operador","usuario","usuário","user"].includes(a),"operador")}function ns(t=[],a=null){const o=(t||[]).map(n=>({...n,empresa_id:n.empresa_id||a,email:String(n.email||"").trim().toLowerCase(),perfil:Zt(n.perfil)})).filter(n=>!a||n.empresa_id===a),i=new Map;for(const n of o){const d=n.user_id||n.email||n.id,l=i.get(d);if(!l){i.set(d,n);continue}i.set(d,{...l,...n,id:l.id||n.id,nome:l.nome||n.nome,email:l.email||n.email,user_id:l.user_id||n.user_id,perfil:l.perfil==="admin"?l.perfil:n.perfil,created_at:l.created_at||n.created_at})}return Array.from(i.values())}async function ss(t){const{data:a,error:o}=await D.functions.invoke("listar-usuarios-empresa",{body:{empresaId:t}});if(o)throw o;if((a==null?void 0:a.ok)===!1)throw new Error((a==null?void 0:a.message)||"Não foi possível listar usuários pela Edge Function.");return ns((a==null?void 0:a.usuarios)||[],t)}async function ls(t){return t?ss(t):[]}async function ds({empresaId:t,email:a,nome:o,perfil:i,senhaProvisoria:n,criarAuthManual:d=!1}){const l=String(a||"").trim().toLowerCase(),m=String(o||"").trim()||l.split("@")[0],f=Zt(i),b=String(n||"").trim();if(!t)throw new Error("Empresa não identificada.");if(!l||!l.includes("@"))throw new Error("Informe um e-mail válido.");if(d&&b.length<6)throw new Error("Informe uma senha provisória com pelo menos 6 caracteres.");if(d){const{data:P,error:z}=await D.functions.invoke("criar-usuario-manual",{body:{empresaId:t,email:l,nome:m,perfil:f,senhaProvisoria:b}});if(z){const H=String((z==null?void 0:z.message)||(z==null?void 0:z.details)||"");throw H.includes("Failed to send a request")?new Error("Não foi possível conectar à Edge Function criar-usuario-manual. Confirme se ela foi publicada no Supabase e se o projeto está correto."):new Error(H||"A Edge Function criar-usuario-manual retornou erro. Verifique os logs no Supabase.")}if((P==null?void 0:P.ok)===!1)throw new Error((P==null?void 0:P.message)||"Não foi possível criar o usuário manualmente.");return(P==null?void 0:P.usuario)||(P==null?void 0:P.vinculo)||{empresa_id:t,email:l,nome:m,perfil:f,user_id:(P==null?void 0:P.userId)||null}}const{data:_,error:k}=await D.from("df_usuarios_empresas").select("id, email, user_id").eq("empresa_id",t).eq("email",l).maybeSingle();if(k)throw k;if(_)throw new Error("Este e-mail já está cadastrado nesta empresa.");const S={empresa_id:t,user_id:null,email:l,nome:m,perfil:f},{data:g,error:T}=await D.from("df_usuarios_empresas").insert([S]).select("*").single();if(T)throw T;return g}async function cs({empresaId:t,usuario:a,perfil:o}){const i=Zt(o);let n=D.from("df_usuarios_empresas").update({perfil:i}).eq("empresa_id",t);a.id?n=n.eq("id",a.id):a.user_id?n=n.eq("user_id",a.user_id):n=n.eq("email",a.email);const{error:d}=await n;if(d)throw d}async function ps({empresaId:t,usuario:a}){let o=D.from("df_usuarios_empresas").delete().eq("empresa_id",t);a.id?o=o.eq("id",a.id):a.user_id?o=o.eq("user_id",a.user_id):o=o.eq("email",a.email);const{error:i}=await o;if(i)throw i}async function ms({usuario:t}){const a=String((t==null?void 0:t.email)||"").trim().toLowerCase();if(!a||!a.includes("@"))throw new Error("Este usuário não possui e-mail válido para envio de acesso.");const o=`${window.location.origin}/reset-password`,{data:i,error:n}=await D.functions.invoke("convidar-usuario",{body:{email:a,nome:t.nome||"",redirectTo:o}});if(!n)return{tipo:"convite",mensagem:(i==null?void 0:i.message)||"Convite enviado para o e-mail do usuário."};const{error:d}=await D.auth.resetPasswordForEmail(a,{redirectTo:o});if(d)throw d;return{tipo:"reset",mensagem:"Envio solicitado. Se este e-mail já existir no Auth, o usuário receberá o link para criar/redefinir a senha."}}async function us({userId:t,email:a,nome:o}){const i=String(o||"").trim(),n=String(a||"").trim().toLowerCase();if(!t)throw new Error("Usuário não identificado.");if(i.length<2)throw new Error("Informe um nome com pelo menos 2 caracteres.");const d=[],{error:l}=await D.from("profiles").upsert({id:t,name:i},{onConflict:"id"});l&&d.push(l);const{error:m}=await D.from("df_usuarios_empresas").update({nome:i}).eq("user_id",t);if(m&&d.push(m),n){const{error:f}=await D.from("df_usuarios_empresas").update({nome:i}).eq("email",n);f&&d.push(f)}if(d.length>0)throw d[0];return{nome:i}}async function fs(t){if(!t)return[];const{data:a,error:o}=await D.from("df_usuarios_filiais").select("id, empresa_id, usuario_id, filial_id, created_at").eq("empresa_id",t);if(o)throw o;return a||[]}async function xs({empresaId:t,usuario:a,filialIds:o}){if(!t)throw new Error("Empresa não identificada.");if(!(a!=null&&a.id))throw new Error("Usuário da empresa não identificado.");const i=Array.from(new Set((o||[]).filter(Boolean))),{error:n}=await D.from("df_usuarios_filiais").delete().eq("empresa_id",t).eq("usuario_id",a.id);if(n)throw n;if(i.length===0)return[];const d=i.map(f=>({empresa_id:t,usuario_id:a.id,filial_id:f})),{data:l,error:m}=await D.from("df_usuarios_filiais").insert(d).select("id, empresa_id, usuario_id, filial_id, created_at");if(m)throw m;return l||[]}function kt(t){return t?String(t).charAt(0).toUpperCase()+String(t).slice(1):""}function it(t){return Number(t||0).toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}function Pt(t){return t?new Date(String(t).slice(0,10)+"T00:00:00").toLocaleDateString("pt-BR"):"-"}function ro(t){if(!t)return null;const a=String(t).trim();if(/^\d{4}-\d{2}-\d{2}$/.test(a))return a;if(/^\d{2}\/\d{2}\/\d{4}$/.test(a)){const[o,i,n]=a.split("/");return`${n}-${i}-${o}`}return a.slice(0,10)}function Io(t){if(!t)return"";const a=String(t);if(a.includes("-"))return a.slice(0,10);const o=a.replace(/\D/g,"").slice(0,8);return o.length<=2?o:o.length<=4?`${o.slice(0,2)}/${o.slice(2)}`:`${o.slice(0,2)}/${o.slice(2,4)}/${o.slice(4,8)}`}function Ni(t){const a=String(t||"").trim();if(!a)return 0;const o=a.replace(/[^\d,.-]/g,""),n=o.includes(",")?o.replace(/\./g,"").replace(",","."):o.replace(/,/g,""),d=Number(n);return Number.isFinite(d)?d:0}function te(t){return it(t)}function io(t){return Pt(t)}const hs=";";function Si(t,a){if(!(a instanceof Blob))throw new Error("Arquivo de exportação inválido.");const o=URL.createObjectURL(a),i=document.createElement("a");i.href=o,i.download=t,i.rel="noopener",document.body.appendChild(i),i.click(),i.remove(),window.setTimeout(()=>URL.revokeObjectURL(o),1200)}function gs(t,a){const o=Array.isArray(a)?a:[],i=[t,...o].map(n=>n.map(vs).join(hs)).join(`\r
`);return new Blob([`\uFEFF${i}`],{type:"text/csv;charset=utf-8"})}function bs({filename:t,headers:a,rows:o}){Si(t,gs(a,o))}function vs(t){return`"${String(t??"").replace(/\r|\n/g," ").replace(/"/g,'""')}"`}function js(t,a){if(!t||typeof t!="string"){a==null||a(new Error("Conteúdo de impressão vazio."));return}const o=document.createElement("iframe");o.title="Relatório para impressão",o.style.position="fixed",o.style.left="-10000px",o.style.top="0",o.style.width="794px",o.style.height="1123px",o.style.border="0",o.style.background="#ffffff",o.style.opacity="0.01",o.setAttribute("aria-hidden","true");let i=!1,n,d;const l=()=>{window.clearTimeout(n),window.clearTimeout(d),d=window.setTimeout(()=>o.remove(),3e3)},m=()=>{if(!i){i=!0;try{const _=o.contentWindow;if(!_)throw new Error("Janela de impressão indisponível.");_.focus(),_.print(),l()}catch(_){l(),a==null||a(_)}}},f=async(_=0)=>{var g,T,P;if(i)return;const k=o.contentDocument;if(!!!((T=(g=k==null?void 0:k.body)==null?void 0:g.innerText)!=null&&T.trim())){if(_<12){n=window.setTimeout(()=>f(_+1),250);return}l(),a==null||a(new Error("Documento de impressão não foi renderizado."));return}try{(P=k.fonts)!=null&&P.ready&&await k.fonts.ready;const z=Array.from(k.images||[]);await Promise.all(z.map(H=>H.complete?Promise.resolve():new Promise(ie=>{H.onload=ie,H.onerror=ie}))),window.requestAnimationFrame(()=>{window.setTimeout(m,350)})}catch(z){if(_<12){n=window.setTimeout(()=>f(_+1),250);return}l(),a==null||a(z)}};o.onload=()=>f(),document.body.appendChild(o);const b=o.contentDocument;if(!b){l(),a==null||a(new Error("Documento de impressão indisponível."));return}b.open(),b.write(t),b.close(),n=window.setTimeout(()=>f(),500)}function ys(t){const a=(Array.isArray(t)?t:[]).map(f=>({name:Ns(f.name),rows:Array.isArray(f.rows)?f.rows:[]}));a.length===0&&a.push({name:"Relatório",rows:[["Sem dados para exportar"]]});const o=ba(`
<workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  <sheets>
    ${a.map((f,b)=>`<sheet name="${_i(f.name)}" sheetId="${b+1}" r:id="rId${b+1}"/>`).join("")}
  </sheets>
</workbook>`),i=ba(`
        ...
        <body>
          <div class="cover">
            ...
            <div class="meta">
              ...
              Centro: ${Ve(ae?(re==null?void 0:re.nome)||"Selecionado":"Todos")} • Filial: ${Ve(M?((ge=P.find(xe=>xe.id===M))==null?void 0:ge.nome)||"Selecionada":"Todas")} • Status: ${Ve(ne)}
            </div>
...
`,u={page:{padding:20,maxWidth:1180,margin:"auto",fontFamily:"Inter, Arial, sans-serif",background:"linear-gradient(180deg, #f8fbfb 0%, #eef7f5 100%)",minHeight:"100vh",paddingBottom:90,color:"#0f172a"},hero:{display:"flex",justifyContent:"space-between",gap:16,alignItems:"center",marginBottom:14,flexWrap:"wrap"},actionsTop:{display:"flex",gap:8,marginBottom:10,flexWrap:"wrap"},titulo:{fontSize:30,margin:0},descricaoTela:{fontSize:14,color:"#64748b",marginTop:4,marginBottom:0},heroBadge:{minWidth:130,background:"#fff",border:"1px solid #dbeafe",borderRadius:20,padding:16,boxShadow:"0 10px 30px rgba(15,23,42,0.08)",display:"flex",flexDirection:"column",alignItems:"center",gap:3},subtitulo:{fontSize:22,marginBottom:12},bloco:{marginTop:20},filtrosBox:{...Mt(),position:"relative",top:"auto",zIndex:1,border:"1px solid #e2e8f0",marginBottom:12,padding:12,boxShadow:"0 8px 22px rgba(15,23,42,0.05)",background:"rgba(255,255,255,0.92)"},filtroHeader:{display:"grid",gridTemplateColumns:"auto 1fr auto",alignItems:"center",gap:10,marginBottom:8},filtroResumo:{color:"#64748b",fontSize:13,fontWeight:700,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},filtrosGrid:{display:"grid",gridTemplateColumns:"1.05fr 1.2fr 1.2fr 0.9fr 0.9fr",gap:8,alignItems:"center"},input:{width:"100%",padding:"9px 11px",borderRadius:11,border:"1px solid #d1d5db",boxSizing:"border-box",background:"#fff",minHeight:38,fontWeight:700,color:"#0f172a"},filtros:{display:"flex",gap:7,flexWrap:"wrap",marginTop:8},filtro:{border:"1px solid #d1d5db",background:"#fff",padding:"7px 12px",borderRadius:999,fontWeight:800,color:"#334155"},filtroAtivo:{border:"1px solid #0d9488",background:"#0d9488",color:"#fff",padding:"7px 12px",borderRadius:999,fontWeight:800},kpiGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(210px, 1fr))",gap:14,marginBottom:16},kpiCard:{...Mt(),minHeight:130},kpiIcon:{width:38,height:38,borderRadius:14,background:"#f1f5f9",display:"grid",placeItems:"center",fontSize:20,marginBottom:8},kpiTitulo:{color:"#64748b",fontSize:13,fontWeight:700,textTransform:"uppercase",letterSpacing:.3},kpiValor:{display:"block",fontSize:22,marginTop:4,marginBottom:4},dashboardGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(320px, 1fr))",gap:14,marginBottom:14},advancedPanel:{...Mt(),marginBottom:16,border:"1px solid #bfdbfe",background:"linear-gradient(135deg, #ffffff 0%, #eff6ff 100%)"},advancedGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(330px, 1fr))",gap:14},dreLinha:{display:"grid",gridTemplateColumns:"1fr auto",gap:18,padding:"12px 0",borderBottom:"1px solid #eef2f7",alignItems:"center"},dreTexto:{display:"flex",flexDirection:"column",gap:4,minWidth:0},dreTitulo:{fontSize:16,lineHeight:1.2},dreDescricao:{color:"#64748b",fontSize:13,lineHeight:1.25,display:"block"},dreValor:{fontSize:16,whiteSpace:"nowrap",textAlign:"right"},chartBox:{width:"100%",height:250,minWidth:0},twoColumns:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(330px, 1fr))",gap:14,marginBottom:14},card:Mt(),cardDestaque:{background:"linear-gradient(135deg, #ffffff 0%, #ecfeff 100%)",border:"1px solid #ccfbf1"},cardAlerta:{...Mt(),background:"#fff5f5",border:"1px solid #fecaca",display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,flexWrap:"wrap"},cardMeta:{...Mt(),border:"1px solid #fef3c7"},predictivePanel:{...Mt(),marginBottom:16,border:"1px solid #ddd6fe",background:"linear-gradient(135deg, #ffffff 0%, #f5f3ff 100%)"},predictiveGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(150px, 1fr))",gap:10,marginBottom:8},metaForecastBox:{marginTop:12,padding:12,borderRadius:16,background:"#f8fafc",border:"1px solid #e2e8f0",display:"grid",gap:4},widgetHeader:{display:"flex",justifyContent:"space-between",gap:10,alignItems:"center",marginBottom:10,flexWrap:"wrap"},executivoTexto:{fontSize:16,lineHeight:1.5,margin:"6px 0 12px 0"},miniStats:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(130px, 1fr))",gap:8},miniStat:{background:"#f8fafc",border:"1px solid #eef2f7",borderRadius:14,padding:10,display:"flex",flexDirection:"column",gap:2,minWidth:0},grid3Compacto:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(110px, 1fr))",gap:8,marginTop:10},compareGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(130px, 1fr))",gap:10},resultGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(120px, 1fr))",gap:10},badge:{border:"1px solid",borderRadius:999,padding:"5px 9px",fontSize:12,fontWeight:800,background:"#fff"},barraFundo:{height:9,background:"#e2e8f0",borderRadius:99,overflow:"hidden",margin:"10px 0"},barraValor:{height:"100%",borderRadius:99},insightList:{display:"grid",gap:8},insightItem:{display:"grid",gridTemplateColumns:"30px 1fr",gap:8,alignItems:"flex-start",background:"#f8fafc",borderRadius:14,padding:10,fontSize:14},insightEmoji:{width:30,height:30,borderRadius:12,background:"#fff",display:"grid",placeItems:"center"},itemGrafico:{marginTop:10},topItem:{display:"grid",gridTemplateColumns:"34px 1fr auto",gap:10,alignItems:"center",padding:"10px 0",borderBottom:"1px solid #eef2f7"},medalha:{width:30,height:30,borderRadius:999,background:"#eef2ff",color:"#3730a3",display:"grid",placeItems:"center",fontWeight:800},topText:{display:"flex",flexDirection:"column",gap:2},rankingGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))",gap:12},cardRanking:Mt(),contasGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(280px, 1fr))",gap:10},cardConta:Mt(),cardLinha:{display:"flex",justifyContent:"space-between",gap:8,alignItems:"flex-start",flexWrap:"wrap"},maiorCusto:{display:"block",color:"#12b886",fontWeight:"bold",fontSize:12},alertaTexto:{color:"#dc3545",fontWeight:"bold"},vazio:{opacity:.7,fontSize:14},skeletonArea:{display:"grid",gap:14,marginTop:12},skeletonGrid:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(210px, 1fr))",gap:14},skeletonCard:{height:130,borderRadius:20,border:"1px solid #e2e8f0",background:"linear-gradient(90deg, #f1f5f9 0%, #ffffff 50%, #f1f5f9 100%)"},skeletonCardAlto:{height:250,borderRadius:20,border:"1px solid #e2e8f0",background:"linear-gradient(90deg, #f1f5f9 0%, #ffffff 50%, #f1f5f9 100%)"},skeletonPanel:{...Mt(),display:"grid",gap:12},skeletonLineGrande:{height:22,width:"55%",borderRadius:999,background:"#e2e8f0"},skeletonLine:{height:14,width:"80%",borderRadius:999,background:"#e2e8f0"},skeletonLineCurta:{height:14,width:"35%",borderRadius:999,background:"#e2e8f0"},muted:{color:"#64748b",lineHeight:1.45},btnVoltar:xa("#64748b"),btnExcel:xa("#16a34a"),btnPDF:xa("#7c3aed"),btnCSV:xa("#0d9488"),btnLimpar:{...xa("#64748b"),padding:"7px 10px"},btnAcao:xa("#dc3545")};function Mt(){return{background:"#fff",padding:16,borderRadius:20,marginBottom:0,boxShadow:"0 12px 30px rgba(15,23,42,0.07)",border:"1px solid rgba(226,232,240,0.9)"}}function xa(t){return{background:t,color:"#fff",border:"none",padding:"9px 13px",borderRadius:12,fontWeight:800,cursor:"pointer"}}function Ta(t){if(!t)return null;const a=String(t).slice(0,10);return new Date(a+"T00:00:00")}function ha(t){const a=new Date;a.setHours(0,0,0,0);const o=Ta(t);if(!o)return 999999;const i=o-a;return Math.round(i/(1e3*60*60*24))}function Us(t){const a=Ta(t);if(!a)return!1;const o=new Date;return a.getMonth()===o.getMonth()&&a.getFullYear()===o.getFullYear()}function Vs(t,a,o){const i=new Date(t,a,0).getDate(),n=Math.min(Number(o||1),i);return`${t}-${String(a).padStart(2,"0")}-${String(n).padStart(2,"0")}`}function Gs(t,a,o){if(!(t!=null&&t.ativo)||(t.tipo_recorrencia||t.frequencia||"mensal")!=="mensal")return!1;const i=t.data_inicio?Ta(t.data_inicio):null;if(!i)return!0;const n=new Date(a,o-1,1),d=new Date(a,o,0);return i<=d&&n>=new Date(i.getFullYear(),i.getMonth(),1)}function zi(t){var o;const a=((o=t==null?void 0:t.df_contas_recorrentes)==null?void 0:o.tipo_recorrencia)||(t==null?void 0:t.tipo_recorrencia)||"";return String(a||"mensal")}function Pi(t){const a=String(t||"mensal").toLowerCase();return{mensal:"Mensal",semanal:"Semanal",anual:"Anual",quinzenal:"Quinzenal"}[a]||kt(a)}function Ws({styles:t,formatarValor:a,navegarPara:o,contasAbertasDashboard:i,mostrarContasDashboard:n,setMostrarContasDashboard:d,busca:l,setBusca:m,estaVencida:f,formatarData:b,abrirConfirmacao:_,marcarComoPago:k}){return e.jsxs("section",{className:`dashboard-open-accounts content-block ${n?"accounts-expanded":"accounts-collapsed"}`,style:t.bloco,children:[e.jsxs("div",{className:"dashboard-section-header dashboard-section-header-accounts",children:[e.jsxs("div",{className:"dashboard-section-title-wrap",children:[e.jsx("strong",{children:"💳 Contas em aberto"}),e.jsxs("small",{children:["Mais novas primeiro • ",i.length," conta(s)"]})]}),e.jsxs("div",{className:"dashboard-section-actions",children:[e.jsx("button",{className:"dashboard-see-all-link",type:"button",onClick:()=>o("contas"),children:"Ver todas"}),e.jsx("button",{className:"note-toggle-small",type:"button",onClick:()=>d(!n),title:n?"Recolher contas em aberto":"Expandir contas em aberto","aria-label":n?"Recolher contas em aberto":"Expandir contas em aberto",children:n?"−":"+"})]})]}),n&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"dashboard-inline-filter",children:e.jsx("input",{style:t.input,placeholder:"Buscar por conta, data, centro ou observação...",value:l,onChange:S=>m(S.target.value)})}),i.length===0&&e.jsx("p",{style:t.mensagemVazia,children:"Nenhuma conta em aberto para os filtros atuais."}),e.jsx("div",{className:"dashboard-open-list",children:i.slice(0,8).map(S=>{var T;const g=f(S.data_vencimento,S.status);return e.jsxs("div",{className:`dashboard-account-row ${g?"account-row-vencido":"account-row-pendente"}`,children:[e.jsxs("div",{children:[e.jsx("strong",{children:S.descricao}),e.jsxs("div",{className:"dashboard-account-meta",children:[e.jsxs("span",{className:"account-date-badge",children:["📅 ",b(S.data_vencimento)]}),e.jsx("span",{className:"account-center-label",children:((T=S.df_centros_custo)==null?void 0:T.nome)||"Sem centro"}),S.recorrencia_id&&e.jsxs("span",{className:"account-recurring-badge",children:["🔁 ",Pi(zi(S))]})]}),S.observacao&&e.jsxs("small",{className:"account-note-preview",children:["Obs: ",S.observacao]})]}),e.jsxs("div",{className:"dashboard-account-row-actions",children:[e.jsx("span",{className:"dashboard-account-value",children:a(S.valor)}),e.jsx("span",{className:`status-pill ${g?"status-vencido":"status-pendente"}`,children:g?"Vencido":"Pendente"}),e.jsx("button",{className:"dashboard-paid-button",style:t.btnPago,onClick:()=>_({titulo:"Confirmar pagamento",mensagem:`Deseja marcar a conta ${S.descricao} como paga?`,textoConfirmar:"Marcar como pago",tipo:"sucesso",acao:()=>k(S.id)}),children:"Pago"})]})]},S.id)})})]})]})}function Hs({styles:t,navegarPara:a,notasPendentes:o,notasCriticas:i,notasUrgentes:n,mostrarNotas:d,setMostrarNotas:l,formatarData:m,alternarNotaConcluida:f,abrirEdicaoNota:b,abrirConfirmacao:_,excluirNota:k}){return e.jsxs("section",{className:`no-print dashboard-notes-card ${d?"notes-expanded":"notes-collapsed"}`,children:[e.jsxs("div",{style:t.notasHeaderNovo,className:"notes-header-clean dashboard-notes-content",children:[e.jsxs("div",{className:"notes-title-wrap",children:[e.jsx("strong",{className:"notes-title",children:"📝 Bloco de Notas"}),e.jsxs("div",{className:"notes-stats-row",children:[e.jsxs("span",{className:"note-stat note-stat-pendente",children:[o.length," pendente(s)"]}),e.jsxs("span",{className:"note-stat note-stat-critico",children:[i," crítica(s)"]}),e.jsxs("span",{className:"note-stat note-stat-urgente",children:[n," urgente(s)"]})]})]}),e.jsxs("div",{className:"notes-header-actions",children:[e.jsx("button",{className:"dashboard-see-all-link",type:"button",onClick:()=>a("notas"),children:"Ver notas"}),e.jsx("button",{className:"note-toggle-small",onClick:()=>l(!d),title:d?"Recolher bloco de notas":"Expandir bloco de notas","aria-label":d?"Recolher bloco de notas":"Expandir bloco de notas",children:d?"−":"+"})]})]}),o.length===0&&e.jsx("p",{style:t.mensagemVazia,children:"Nenhuma nota pendente no momento."}),d&&e.jsx("div",{style:t.notasListaNova,className:"notes-list-dashboard",children:o.slice(0,6).map(S=>{const g=S.prioridade||"normal";return e.jsxs("div",{className:`note-card-action note-card-${g}`,style:{...t.cardNotaAcao,...g==="critico"?t.cardNotaCritico:g==="urgente"?t.cardNotaUrgente:t.cardNotaNormal,opacity:S.concluida?.65:1},children:[e.jsxs("div",{style:t.cardTopo,children:[e.jsx("strong",{style:{textDecoration:S.concluida?"line-through":"none"},children:S.titulo}),e.jsx("span",{className:`note-priority-badge note-priority-${g}`,style:{...t.badgePrioridade,...g==="critico"?t.badgeCritico:g==="urgente"?t.badgeUrgente:t.badgeNormal},children:g==="critico"?"Crítico":g==="urgente"?"Urgente":"Normal"})]}),S.data_evento&&e.jsxs("small",{className:"note-event-date",children:["📅 ",m(S.data_evento)]}),S.conteudo&&e.jsx("p",{style:t.textoNota,children:S.conteudo}),e.jsxs("div",{style:t.acoes,children:[e.jsx("button",{style:t.btnPago,onClick:()=>f(S),children:S.concluida?"Reabrir":"Concluir"}),e.jsx("button",{style:t.btnEditar,onClick:()=>b(S),children:"Editar"}),e.jsx("button",{style:t.btnExcluir,onClick:()=>_({titulo:"Mover nota para lixeira",mensagem:`Deseja mover a nota ${S.titulo} para a lixeira? Ela ficará em quarentena por 60 dias.`,textoConfirmar:"Mover",tipo:"perigo",acao:()=>k(S.id)}),children:"Excluir"})]})]},S.id)})})]})}function ht({className:t="",style:a={}}){return e.jsx("div",{className:`df-skeleton ${t}`.trim(),style:a,"aria-hidden":"true"})}function Ks({items:t=4}){return e.jsx("div",{className:"summary-grid df-skeleton-summary","aria-label":"Carregando resumo",children:Array.from({length:t}).map((a,o)=>e.jsxs("div",{className:"df-skeleton-card df-skeleton-summary-card",children:[e.jsx(ht,{className:"df-skeleton-line df-skeleton-line-sm"}),e.jsx(ht,{className:"df-skeleton-line df-skeleton-line-lg"})]},o))})}function Ri({items:t=3}){return e.jsx("div",{className:"df-skeleton-list","aria-label":"Carregando contas",children:Array.from({length:t}).map((a,o)=>e.jsxs("div",{className:"df-skeleton-card df-skeleton-account-card",children:[e.jsxs("div",{className:"df-skeleton-card-top",children:[e.jsx(ht,{className:"df-skeleton-line df-skeleton-line-title"}),e.jsx(ht,{className:"df-skeleton-line df-skeleton-line-value"})]}),e.jsxs("div",{className:"df-skeleton-chip-row",children:[e.jsx(ht,{className:"df-skeleton-chip"}),e.jsx(ht,{className:"df-skeleton-chip"}),e.jsx(ht,{className:"df-skeleton-chip"})]}),e.jsxs("div",{className:"df-skeleton-actions-row",children:[e.jsx(ht,{className:"df-skeleton-button"}),e.jsx(ht,{className:"df-skeleton-button"})]})]},o))})}function Ys({items:t=3}){return e.jsx("div",{className:"notes-page-grid df-skeleton-notes","aria-label":"Carregando notas",children:Array.from({length:t}).map((a,o)=>e.jsxs("div",{className:"df-skeleton-card df-skeleton-note-card",children:[e.jsxs("div",{className:"df-skeleton-card-top",children:[e.jsx(ht,{className:"df-skeleton-line df-skeleton-line-title"}),e.jsx(ht,{className:"df-skeleton-pill"})]}),e.jsx(ht,{className:"df-skeleton-line df-skeleton-line-sm"}),e.jsx(ht,{className:"df-skeleton-line df-skeleton-line-full"}),e.jsx(ht,{className:"df-skeleton-line df-skeleton-line-mid"})]},o))})}function Xs({styles:t,formatarValor:a,total:o,pago:i,pendente:n,vencido:d,contas:l,diferencaDias:m,navegarPara:f,contasAbertasDashboard:b,mostrarContasDashboard:_,setMostrarContasDashboard:k,busca:S,setBusca:g,estaVencida:T,formatarData:P,abrirConfirmacao:z,marcarComoPago:H,notasPendentes:ie,notasCriticas:V,notasUrgentes:q,mostrarNotas:ne,setMostrarNotas:G,alternarNotaConcluida:ae,abrirEdicaoNota:I,excluirNota:M,loading:Y=!1,nomeUsuario:je="usuário",filiais:ce=[],filtroFilial:he="",setFiltroFilial:Ce=()=>{},contasOperacionaisFiliais:oe=[]}){const y=$=>Number($||0),pe=(ce||[]).find($=>$.id===he);l.filter($=>$.status==="pago"),l.filter($=>$.status!=="pago");const A=oe&&oe.length>0?oe:l,Z=(ce||[]).map($=>{const re=A.filter(Ye=>Ye.filial_id===$.id),et=re.reduce((Ye,lt)=>Ye+y(lt.valor),0),st=re.filter(Ye=>Ye.status==="pago").reduce((Ye,lt)=>Ye+y(lt.valor),0),Oe=re.filter(Ye=>T(Ye.data_vencimento,Ye.status)).reduce((Ye,lt)=>Ye+y(lt.valor),0),It=et-st;return{id:$.id,nome:$.nome||"Filial sem nome",total:et,pago:st,pendente:It,vencido:Oe,contas:re.length}}).filter($=>$.total>0||$.contas>0).sort(($,re)=>re.total-$.total),K=Z[0],Q=[...Z].sort(($,re)=>re.pendente-$.pendente)[0],N=[...Z].sort(($,re)=>re.vencido-$.vencido)[0],J=[{name:"Pago",value:y(i),color:"#22c55e"},{name:"Pendente",value:Math.max(y(n)-y(d),0),color:"#f59e0b"},{name:"Vencido",value:y(d),color:"#ef4444"}].filter($=>$.value>0),Me=[{name:"Pago",valor:y(i)},{name:"Aberto",valor:y(n)},{name:"Vencido",valor:y(d)}],_e=Object.values(l.reduce(($,re)=>{var st;const et=((st=re.df_centros_custo)==null?void 0:st.nome)||"Sem centro";return $[et]||($[et]={name:et,valor:0}),$[et].valor+=y(re.valor),$},{})).sort(($,re)=>re.valor-$.valor).slice(0,5),we=o>0?Math.round(i/o*100):0,U=o>0?Math.round(d/o*100):0,fe=l.filter($=>$.status!=="pago").sort(($,re)=>m($.data_vencimento)-m(re.data_vencimento)),Ae=fe.filter($=>m($.data_vencimento)===0),C=fe.filter($=>{const re=m($.data_vencimento);return re>0&&re<=7}),be=fe.find($=>m($.data_vencimento)>=0)||fe[0],ze=Ae.reduce(($,re)=>$+y(re.valor),0),me=C.reduce(($,re)=>$+y(re.valor),0);return e.jsxs(e.Fragment,{children:[e.jsx("section",{className:"dashboard-branch-filter no-print","aria-label":"Filtro de filial do dashboard",children:e.jsxs("div",{className:"dashboard-branch-filter-card",children:[e.jsxs("div",{children:[e.jsx("span",{className:"analytics-kicker",children:"Visão por filial"}),e.jsx("strong",{children:pe?pe.nome:"Todas as filiais"}),e.jsx("small",{children:"Os KPIs, gráficos e contas em aberto respeitam a filial selecionada."})]}),e.jsxs("select",{style:t.input,value:he,onChange:$=>Ce($.target.value),"aria-label":"Filtrar dashboard por filial",children:[e.jsx("option",{value:"",children:"Todas as filiais"}),(ce||[]).map($=>e.jsx("option",{value:$.id,children:$.nome},$.id))]})]})}),e.jsx("section",{className:"dashboard-kpi-row","aria-label":"Resumo financeiro",children:Y?e.jsx(Ks,{items:4}):e.jsxs("div",{className:"summary-grid",style:t.resumo,children:[e.jsxs("div",{style:t.boxTotal,children:[e.jsx("span",{children:"Total"}),e.jsx("strong",{children:a(o)})]}),e.jsxs("div",{style:t.boxPago,children:[e.jsx("span",{children:"Pago"}),e.jsx("strong",{children:a(i)})]}),e.jsxs("div",{style:t.boxPendente,children:[e.jsx("span",{children:"Pendente"}),e.jsx("strong",{children:a(n)})]}),e.jsxs("div",{style:t.boxVencido,children:[e.jsx("span",{children:"Vencido"}),e.jsx("strong",{children:a(d)})]})]})}),!Y&&e.jsxs("section",{className:"dashboard-operational-grid no-print","aria-label":"Dashboard operacional por filial",children:[e.jsxs("article",{className:"dashboard-operational-card highlight",children:[e.jsx("span",{className:"analytics-kicker",children:"Ranking de unidades"}),e.jsx("strong",{children:K?K.nome:"Sem movimento"}),e.jsx("small",{children:K?`${a(K.total)} em volume financeiro`:"Cadastre contas vinculadas às filiais."})]}),e.jsxs("article",{className:"dashboard-operational-card",children:[e.jsx("span",{className:"analytics-kicker",children:"Maior pendência"}),e.jsx("strong",{children:Q?Q.nome:"Sem pendências"}),e.jsx("small",{children:Q?a(Q.pendente):"Nenhuma conta pendente encontrada."})]}),e.jsxs("article",{className:"dashboard-operational-card",children:[e.jsx("span",{className:"analytics-kicker",children:"Risco vencido"}),e.jsx("strong",{children:N&&N.vencido>0?N.nome:"Sem vencidos"}),e.jsx("small",{children:N&&N.vencido>0?a(N.vencido):"Operação sem vencidos no filtro atual."})]}),e.jsxs("article",{className:"dashboard-operational-card ranking",children:[e.jsxs("div",{className:"analytics-card-header compact",children:[e.jsxs("div",{children:[e.jsx("span",{className:"analytics-kicker",children:"Comparativo por filial"}),e.jsx("strong",{children:"Top unidades"})]}),e.jsx("span",{className:"analytics-badge neutral",children:Z.length})]}),Z.length>0?e.jsx("div",{className:"branch-ranking-list",children:Z.slice(0,5).map(($,re)=>{const et=(K==null?void 0:K.total)>0?Math.max(5,Math.round($.total/K.total*100)):0;return e.jsxs("div",{className:"branch-ranking-row",children:[e.jsxs("div",{className:"branch-ranking-info",children:[e.jsx("span",{children:re+1}),e.jsxs("div",{children:[e.jsx("strong",{children:$.nome}),e.jsxs("small",{children:[$.contas," conta(s) • pendente ",a($.pendente)]})]})]}),e.jsxs("div",{className:"branch-ranking-value",children:[e.jsx("strong",{children:a($.total)}),e.jsx("div",{className:"cost-center-track",children:e.jsx("span",{style:{width:`${et}%`}})})]})]},$.id)})}):e.jsx("div",{className:"analytics-empty",children:"Sem contas com filial no filtro atual."})]})]}),!Y&&e.jsxs("section",{className:"dashboard-analytics-grid no-print",children:[e.jsxs("div",{className:"dashboard-analytics-card dashboard-analytics-card-primary",children:[e.jsxs("div",{className:"analytics-card-header",children:[e.jsxs("div",{children:[e.jsx("span",{className:"analytics-kicker",children:"Saúde financeira"}),e.jsx("strong",{children:"Distribuição das contas"})]}),e.jsxs("span",{className:"analytics-badge",children:[we,"% pago"]})]}),J.length>0?e.jsxs("div",{className:"analytics-chart-row",children:[e.jsxs("div",{className:"donut-chart-wrap",children:[e.jsx(va,{width:"100%",height:190,children:e.jsxs(wi,{children:[e.jsx(ki,{data:J,dataKey:"value",nameKey:"name",innerRadius:54,outerRadius:82,paddingAngle:3,children:J.map($=>e.jsx(Ci,{fill:$.color},$.name))}),e.jsx(ja,{formatter:$=>a($)})]})}),e.jsxs("div",{className:"donut-center-label",children:[e.jsxs("strong",{children:[we,"%"]}),e.jsx("span",{children:"quitado"})]})]}),e.jsx("div",{className:"analytics-legend",children:J.map($=>e.jsxs("div",{children:[e.jsx("span",{style:{background:$.color}}),e.jsx("small",{children:$.name}),e.jsx("strong",{children:a($.value)})]},$.name))})]}):e.jsx("div",{className:"analytics-empty",children:"Sem dados financeiros para montar o gráfico."})]}),e.jsxs("div",{className:"dashboard-analytics-card",children:[e.jsxs("div",{className:"analytics-card-header",children:[e.jsxs("div",{children:[e.jsx("span",{className:"analytics-kicker",children:"Fluxo atual"}),e.jsx("strong",{children:"Pago x Aberto x Vencido"})]}),e.jsxs("span",{className:U>0?"analytics-badge danger":"analytics-badge success",children:[U,"% risco"]})]}),e.jsx(va,{width:"100%",height:220,children:e.jsxs(ji,{data:Me,margin:{top:14,right:18,left:24,bottom:4},children:[e.jsx(so,{strokeDasharray:"3 3",vertical:!1}),e.jsx(lo,{dataKey:"name",tickLine:!1,axisLine:!1}),e.jsx(co,{width:82,tickLine:!1,axisLine:!1,tickMargin:10,tickFormatter:$=>`R$ ${Math.round($/1e3)}k`}),e.jsx(ja,{formatter:$=>a($)}),e.jsx(yi,{dataKey:"valor",radius:[10,10,4,4],fill:"#0f766e"})]})})]}),e.jsxs("div",{className:"dashboard-analytics-card dashboard-cost-center-card",children:[e.jsxs("div",{className:"analytics-card-header",children:[e.jsxs("div",{children:[e.jsx("span",{className:"analytics-kicker",children:"Centros de custo"}),e.jsx("strong",{children:"Top 5 por volume financeiro"})]}),e.jsxs("span",{className:"analytics-badge neutral",children:[_e.length," centros"]})]}),_e.length>0?e.jsx("div",{className:"cost-center-bars",children:_e.map($=>{const re=o>0?Math.max(4,Math.round($.valor/o*100)):0;return e.jsxs("div",{className:"cost-center-row",children:[e.jsxs("div",{children:[e.jsx("strong",{children:$.name}),e.jsx("span",{children:a($.valor)})]}),e.jsx("div",{className:"cost-center-track",children:e.jsx("span",{style:{width:`${re}%`}})})]},$.name)})}):e.jsx("div",{className:"analytics-empty",children:"Cadastre centros de custo para visualizar o ranking."})]}),e.jsxs("div",{className:"dashboard-analytics-card executive-agenda-widget",children:[e.jsxs("div",{className:"analytics-card-header",children:[e.jsxs("div",{children:[e.jsx("span",{className:"analytics-kicker",children:"Agenda executiva"}),e.jsx("strong",{children:"Próximos vencimentos"})]}),e.jsxs("span",{className:"analytics-badge neutral",children:[fe.length," abertas"]})]}),e.jsxs("div",{className:"executive-agenda-metrics",children:[e.jsxs("div",{children:[e.jsx("small",{children:"Hoje"}),e.jsx("strong",{children:a(ze)})]}),e.jsxs("div",{children:[e.jsx("small",{children:"7 dias"}),e.jsx("strong",{children:a(me)})]})]}),be?e.jsxs("div",{className:"executive-agenda-next",children:[e.jsx("span",{children:"Próximo compromisso"}),e.jsx("strong",{children:be.descricao}),e.jsxs("small",{children:[P(be.data_vencimento)," • ",a(be.valor)]})]}):e.jsx("div",{className:"analytics-empty executive-agenda-empty",children:"Agenda financeira limpa."}),e.jsx("button",{className:"executive-agenda-cta",onClick:()=>f("agenda"),children:"Abrir agenda completa"})]})]}),Y?e.jsxs("section",{className:"content-block",style:t.bloco,children:[e.jsx("div",{className:"dashboard-section-header-accounts",children:e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"💰 Contas em aberto"}),e.jsx("p",{style:t.textoNota,children:"Carregando contas e vencimentos..."})]})}),e.jsx(Ri,{items:2})]}):e.jsx(Ws,{styles:t,formatarValor:a,navegarPara:f,contasAbertasDashboard:b,mostrarContasDashboard:_,setMostrarContasDashboard:k,busca:S,setBusca:g,estaVencida:T,formatarData:P,abrirConfirmacao:z,marcarComoPago:H}),Y?e.jsxs("section",{className:"content-block",style:t.bloco,children:[e.jsx("div",{className:"notes-header-clean",children:e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"📝 Notas"}),e.jsx("p",{style:t.textoNota,children:"Carregando lembretes..."})]})}),e.jsx(Ys,{items:2})]}):e.jsx(Hs,{styles:t,navegarPara:f,notasPendentes:ie,notasCriticas:V,notasUrgentes:q,mostrarNotas:ne,setMostrarNotas:G,formatarData:P,alternarNotaConcluida:ae,abrirEdicaoNota:I,abrirConfirmacao:z,excluirNota:M})]})}function Qs(t){return e.jsx(Xs,{...t})}function Js({icon:t,title:a,description:o,actionLabel:i,onAction:n}){return e.jsxs("div",{className:"empty-state-card",children:[e.jsx("div",{className:"empty-state-icon",children:t}),e.jsx("strong",{children:a}),e.jsx("p",{children:o}),i&&n&&e.jsx("button",{className:"empty-state-action",onClick:n,children:i})]})}function Zs({styles:t,busca:a,setBusca:o,mostrarFiltros:i,setMostrarFiltros:n,limparFiltros:d,imprimirPDF:l,exportarCSV:m,filtroStatus:f,setFiltroStatus:b,centros:_,filtroCentro:k,setFiltroCentro:S,filiais:g,filtroFilial:T,setFiltroFilial:P,filtroMes:z,setFiltroMes:H,dataInicial:ie,setDataInicial:V,dataFinal:q,setDataFinal:ne,limitarDataInput:G,contasFiltradas:ae,total:I,formatarValor:M,loading:Y,HeaderExpansivel:je,mostrarContas:ce,setMostrarContas:he,estaVencida:Ce,formatarData:oe,formatarTipoRecorrencia:y,obterTipoRecorrenciaConta:pe,abrirConfirmacao:A,marcarComoPago:Z,voltarParaPendente:K,abrirEdicaoConta:Q,excluirConta:N,navegarPara:J}){function Me(){var _e,we;return e.jsxs(e.Fragment,{children:[e.jsxs("section",{className:"no-print filters-desktop",style:t.filtrosBox,children:[e.jsx("input",{style:t.input,placeholder:"Buscar por conta, data, centro, observação ou status...",value:a,onChange:U=>o(U.target.value)}),e.jsx("button",{className:"filter-toggle-button",onClick:()=>n(!i),children:i?"Ocultar filtros":"Filtros"}),e.jsxs("div",{className:"export-actions",style:t.acoes,children:[e.jsx("button",{style:t.btnCinza,onClick:d,children:"Limpar"}),e.jsx("button",{style:t.btnRoxo,onClick:l,children:"PDF"}),e.jsx("button",{style:t.btnVerde,onClick:m,children:"CSV"})]}),i&&e.jsxs("div",{className:"advanced-filters",children:[e.jsxs("div",{className:"status-tabs filter-tabs-fixed",style:t.filtros,children:[e.jsx("button",{style:f==="todas"?t.filtroAtivo:t.filtro,onClick:()=>b("todas"),children:"Todas"}),e.jsx("button",{style:f==="pendentes"?t.filtroAtivo:t.filtro,onClick:()=>b("pendentes"),children:"Pendentes"}),e.jsx("button",{style:f==="pagas"?t.filtroAtivo:t.filtro,onClick:()=>b("pagas"),children:"Pagas"}),e.jsx("button",{style:f==="vencidas"?t.filtroAtivo:t.filtro,onClick:()=>b("vencidas"),children:"Vencidas"})]}),e.jsxs("select",{style:t.input,value:T,onChange:U=>P(U.target.value),children:[e.jsx("option",{value:"",children:"Todas as filiais"}),(g||[]).map(U=>e.jsx("option",{value:U.id,children:U.nome},U.id))]}),e.jsxs("select",{style:t.input,value:k,onChange:U=>S(U.target.value),children:[e.jsx("option",{value:"",children:"Todos os centros"}),_.map(U=>e.jsx("option",{value:U.id,children:U.nome},U.id))]}),e.jsx("input",{style:t.input,type:"month",value:z,onChange:U=>H(U.target.value)}),e.jsx("input",{style:t.input,type:"date",value:ie,onChange:U=>V(G(U.target.value))}),e.jsx("input",{style:t.input,type:"date",value:q,onChange:U=>ne(G(U.target.value))})]})]}),e.jsxs("section",{className:"result-summary",style:t.resumoFiltro,children:[e.jsx("strong",{children:"Resultado filtrado"}),e.jsxs("span",{children:[ae.length," conta(s) • Total ",M(I)]}),e.jsxs("small",{children:["Filial: ",T?((_e=(g||[]).find(U=>U.id===T))==null?void 0:_e.nome)||"Selecionada":"Todas"," • Centro: ",k?((we=_.find(U=>U.id===k))==null?void 0:we.nome)||"Selecionado":"Todos"," • Status: ",f," • Mês: ",z||"Todos"]})]}),e.jsxs("section",{className:"content-block",style:t.bloco,children:[Y&&e.jsx(Ri,{items:3}),e.jsx(je,{titulo:"💰 Contas",aberto:ce,onClick:()=>he(!ce)}),!Y&&ce&&ae.length===0&&e.jsx(Js,{icon:"💳",title:"Nenhuma conta encontrada",description:"Ajuste os filtros ou cadastre uma nova conta para acompanhar os vencimentos da empresa."}),!Y&&ce&&ae.map(U=>{var Ae,C;const fe=Ce(U.data_vencimento,U.status);return e.jsxs("div",{className:`print-card account-card-desktop ${fe?"account-card-vencida":U.status==="pago"?"account-card-paga":"account-card-pendente"}`,style:{...t.cardConta,background:U.status==="pago"?"#d4edda":fe?"#ffb3b3":"#fff3cd"},children:[e.jsxs("div",{style:t.cardTopo,children:[e.jsx("strong",{children:U.descricao}),e.jsx("span",{children:M(U.valor)})]}),e.jsxs("div",{style:t.cardInfo,className:"account-meta-line",children:[e.jsxs("span",{className:"account-date-badge",children:["📅 ",oe(U.data_vencimento)]}),e.jsx("span",{children:((Ae=U.df_filiais)==null?void 0:Ae.nome)||"Sem filial"}),e.jsx("span",{children:((C=U.df_centros_custo)==null?void 0:C.nome)||"-"}),U.recorrencia_id&&e.jsxs("span",{className:"account-recurring-badge",children:["🔁 ",y(pe(U))]}),e.jsx("span",{className:`status-pill ${fe?"status-vencido":U.status==="pago"?"status-pago":"status-pendente"}`,children:fe?"Vencido":U.status==="pago"?"Pago":"Pendente"})]}),e.jsxs("div",{className:"account-actions",style:t.acoes,children:[U.status!=="pago"?e.jsx("button",{style:t.btnPago,onClick:()=>A({titulo:"Confirmar pagamento",mensagem:`Deseja marcar a conta ${U.descricao} como paga?`,textoConfirmar:"Marcar como pago",tipo:"sucesso",acao:()=>Z(U.id)}),children:"Pago"}):e.jsx("button",{style:t.btnVoltar,onClick:()=>A({titulo:"Voltar para pendente",mensagem:`Deseja voltar a conta ${U.descricao} para pendente?`,textoConfirmar:"Voltar",tipo:"aviso",acao:()=>K(U.id)}),children:"Voltar"}),e.jsx("button",{style:t.btnEditar,onClick:()=>Q(U),children:"Editar"}),e.jsx("button",{style:t.btnExcluir,onClick:()=>A({titulo:"Mover para lixeira",mensagem:`Deseja mover a conta ${U.descricao} para a lixeira? Ela ficará em quarentena por 60 dias.`,textoConfirmar:"Mover",tipo:"perigo",acao:()=>N(U.id)}),children:"Excluir"})]})]},U.id)})]})]})}return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"page-title-actions",children:[e.jsxs("div",{children:[e.jsx("h1",{style:t.titulo,children:"💳 Contas"}),e.jsx("p",{style:t.textoNota,children:"Consulte, filtre, exporte e administre as contas da empresa em uma página dedicada."})]}),e.jsx("div",{className:"page-actions-row",children:e.jsx("button",{style:t.btnCinza,onClick:()=>J("dashboard"),children:"← Dashboard"})})]}),Me()]})}function el({icon:t,title:a,description:o}){return e.jsxs("div",{className:"empty-state-card",children:[e.jsx("div",{className:"empty-state-icon",children:t}),e.jsx("strong",{children:a}),e.jsx("p",{children:o})]})}function tl({styles:t,navegarPara:a,notasFiltradas:o,notasPendentes:i,notasCriticas:n,notasUrgentes:d,buscaNota:l,setBuscaNota:m,formatarData:f,alternarNotaConcluida:b,abrirEdicaoNota:_,abrirConfirmacao:k,excluirNota:S,filtroFilial:g,setFiltroFilial:T,filiais:P}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"page-title-actions",children:[e.jsxs("div",{children:[e.jsx("h1",{style:t.titulo,children:"📝 Notas"}),e.jsx("p",{style:t.textoNota,children:"Central de notas e lembretes da empresa, separada do painel financeiro para reduzir poluição visual."})]}),e.jsx("div",{className:"page-actions-row",children:e.jsx("button",{style:t.btnCinza,onClick:()=>a("dashboard"),children:"← Dashboard"})})]}),e.jsxs("section",{style:t.cardConfiguracao,className:"notes-page-section",children:[e.jsxs("div",{className:"notes-page-header",children:[e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"Todas as notas"}),e.jsxs("p",{style:t.textoNota,children:[o.length," nota(s) encontrada(s) • ",i.length," pendente(s)"]})]}),e.jsxs("div",{className:"notes-page-stats",children:[e.jsxs("span",{className:"note-stat note-stat-pendente",children:[i.length," pendente(s)"]}),e.jsxs("span",{className:"note-stat note-stat-critico",children:[n," crítica(s)"]}),e.jsxs("span",{className:"note-stat note-stat-urgente",children:[d," urgente(s)"]})]})]}),e.jsxs("div",{className:"notes-toolbar",children:[e.jsxs("select",{style:t.input,value:g,onChange:z=>T(z.target.value),children:[e.jsx("option",{value:"",children:"Todas as filiais"}),(P||[]).map(z=>e.jsx("option",{value:z.id,children:z.nome},z.id))]}),e.jsx("input",{style:t.input,placeholder:"Buscar por título, conteúdo ou prioridade...",value:l,onChange:z=>m(z.target.value)})]}),o.length===0&&e.jsx(el,{icon:"📝",title:"Nenhuma nota encontrada",description:"Use as notas para registrar pendências, lembretes e prioridades da operação."}),e.jsx("div",{className:"notes-page-grid",children:o.map(z=>{var ie;const H=z.prioridade||"normal";return e.jsxs("div",{className:`note-card-action note-card-${H}`,style:{...t.cardNotaAcao,...H==="critico"?t.cardNotaCritico:H==="urgente"?t.cardNotaUrgente:t.cardNotaNormal,opacity:z.concluida?.65:1},children:[e.jsxs("div",{style:t.cardTopo,children:[e.jsx("strong",{style:{textDecoration:z.concluida?"line-through":"none"},children:z.titulo}),e.jsx("span",{className:`note-priority-badge note-priority-${H}`,style:{...t.badgePrioridade,...H==="critico"?t.badgeCritico:H==="urgente"?t.badgeUrgente:t.badgeNormal},children:H==="critico"?"Crítico":H==="urgente"?"Urgente":"Normal"})]}),z.data_evento&&e.jsxs("small",{className:"note-event-date",children:["📅 ",f(z.data_evento)]}),((ie=z.df_filiais)==null?void 0:ie.nome)&&e.jsxs("small",{className:"note-event-date",children:["🏢 ",z.df_filiais.nome]}),z.conteudo&&e.jsx("p",{style:t.textoNota,children:z.conteudo}),e.jsxs("div",{style:t.acoes,children:[e.jsx("button",{style:t.btnPago,onClick:()=>b(z),children:z.concluida?"Reabrir":"Concluir"}),e.jsx("button",{style:t.btnEditar,onClick:()=>_(z),children:"Editar"}),e.jsx("button",{style:t.btnExcluir,onClick:()=>k({titulo:"Mover nota para lixeira",mensagem:`Deseja mover a nota ${z.titulo} para a lixeira? Ela ficará em quarentena por 60 dias.`,textoConfirmar:"Mover",tipo:"perigo",acao:()=>S(z.id)}),children:"Excluir"})]})]},z.id)})})]})]})}function Uo(t){return String(t||"").trim().replace(/\s+/g," ")}async function al(){const{data:t,error:a}=await D.from("df_empresas").select("id, nome, created_at").order("nome",{ascending:!0});if(a)throw a;const{data:o,error:i}=await D.from("df_usuarios_empresas").select("empresa_id, user_id, email, perfil");if(i)throw i;const n=new Map;return(o||[]).forEach(d=>{if(!(d!=null&&d.empresa_id))return;const l=d.user_id||String(d.email||"").trim().toLowerCase();if(!l)return;const m=n.get(d.empresa_id)||new Set;m.add(l),n.set(d.empresa_id,m)}),(t||[]).map(d=>{var l;return{...d,totalUsuarios:((l=n.get(d.id))==null?void 0:l.size)||0}})}async function ol({nome:t,masterUserId:a,masterEmail:o,masterNome:i}){const n=Uo(t);if(n.length<2)throw new Error("Informe o nome da empresa.");const{data:d,error:l}=await D.from("df_empresas").select("id, nome").ilike("nome",n).limit(1);if(l)throw l;if(Array.isArray(d)&&d.length>0)throw new Error("Já existe uma empresa com esse nome.");const{data:m,error:f}=await D.from("df_empresas").insert([{nome:n}]).select("id, nome, created_at").single();if(f)throw f;if(o||a){const b={empresa_id:m.id,user_id:a||null,email:String(o||"").trim().toLowerCase()||null,nome:Uo(i)||String(o||"").split("@")[0]||"Administrador",perfil:"admin"},{error:_}=await D.from("df_usuarios_empresas").insert([b]);_&&console.warn("Empresa criada, mas não foi possível vincular o master automaticamente:",_.message)}return m}async function rl({empresaId:t,nome:a}){const o=Uo(a);if(!t)throw new Error("Empresa não identificada.");if(o.length<2)throw new Error("Informe o nome da empresa.");const{data:i,error:n}=await D.from("df_empresas").update({nome:o}).eq("id",t).select("id, nome, created_at").single();if(n)throw n;return i}function Fi(t){return String(t||"").trim().replace(/\s+/g," ")}function $i(t){const a=String(t||"").trim();if(!a)throw new Error("Empresa não identificada para gerenciar filiais.");return a}async function Ho(t){const a=$i(t),{data:o,error:i}=await D.from("df_filiais").select("id, empresa_id, nome, ativo, created_at").eq("empresa_id",a).order("nome",{ascending:!0});if(i)throw i;return o||[]}async function il({empresaId:t,nome:a}){const o=$i(t),i=Fi(a);if(i.length<2)throw new Error("Informe o nome da filial.");const{data:n,error:d}=await D.from("df_filiais").select("id, nome").eq("empresa_id",o).ilike("nome",i).limit(1);if(d)throw d;if(Array.isArray(n)&&n.length>0)throw new Error("Já existe uma filial com esse nome nesta empresa.");const{data:l,error:m}=await D.from("df_filiais").insert([{empresa_id:o,nome:i,ativo:!0}]).select("id, empresa_id, nome, ativo, created_at").single();if(m)throw m;return l}async function nl({filialId:t,nome:a}){const o=String(t||"").trim(),i=Fi(a);if(!o)throw new Error("Filial não identificada.");if(i.length<2)throw new Error("Informe o nome da filial.");const{data:n,error:d}=await D.from("df_filiais").update({nome:i}).eq("id",o).select("id, empresa_id, nome, ativo, created_at").single();if(d)throw d;return n}async function sl({filialId:t,ativo:a}){const o=String(t||"").trim();if(!o)throw new Error("Filial não identificada.");const{data:i,error:n}=await D.from("df_filiais").update({ativo:!!a}).eq("id",o).select("id, empresa_id, nome, ativo, created_at").single();if(n)throw n;return i}function ll(t){if(!t)return"—";try{return new Intl.DateTimeFormat("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}).format(new Date(t))}catch{return"—"}}function dl({styles:t,usuarioLogado:a,nomeUsuarioCompleto:o,empresaId:i,empresasDisponiveis:n=[],trocarEmpresaAtiva:d,trocandoEmpresa:l,mostrarAviso:m,onEmpresasAtualizadas:f,voltarPainel:b,abaInicial:_="empresas"}){const[k,S]=c.useState(_==="filiais"?"filiais":"empresas"),[g,T]=c.useState([]),[P,z]=c.useState(""),[H,ie]=c.useState(""),[V,q]=c.useState(!1),[ne,G]=c.useState(!0),[ae,I]=c.useState(null),[M,Y]=c.useState(""),[je,ce]=c.useState([]),[he,Ce]=c.useState(""),[oe,y]=c.useState(""),[pe,A]=c.useState(!1),[Z,K]=c.useState(null),[Q,N]=c.useState(""),J=c.useMemo(()=>n.find(C=>C.id===i)||g.find(C=>C.id===i)||null,[i,g,n]);async function Me(){G(!0);try{const C=await al();T(C)}catch(C){m==null||m((C==null?void 0:C.message)||"Não foi possível carregar empresas.","erro")}finally{G(!1)}}async function _e(){if(!i){ce([]);return}A(!0);try{const C=await Ho(i);ce(C)}catch(C){m==null||m((C==null?void 0:C.message)||"Não foi possível carregar filiais.","erro")}finally{A(!1)}}c.useEffect(()=>{Me()},[]),c.useEffect(()=>{k==="filiais"&&_e()},[k,i]);const we=c.useMemo(()=>{const C=String(P||"").trim().toLowerCase();return C?g.filter(be=>String(be.nome||"").toLowerCase().includes(C)):g},[P,g]);c.useMemo(()=>{const C=String(he||"").trim().toLowerCase();return C?je.filter(be=>String(be.nome||"").toLowerCase().includes(C)):je},[he,je]);async function U(C){if(C.preventDefault(),!V){q(!0);try{await ol({nome:H,masterUserId:a==null?void 0:a.id,masterEmail:a==null?void 0:a.email,masterNome:o==null?void 0:o()}),ie(""),await Me(),await(f==null?void 0:f()),m==null||m("Empresa criada com sucesso.","sucesso")}catch(be){m==null||m((be==null?void 0:be.message)||"Não foi possível criar a empresa.","erro")}finally{q(!1)}}}async function fe(C){if(!(!(C!=null&&C.id)||V)){q(!0);try{await rl({empresaId:C.id,nome:M}),I(null),Y(""),await Me(),await(f==null?void 0:f()),m==null||m("Empresa atualizada com sucesso.","sucesso")}catch(be){m==null||m((be==null?void 0:be.message)||"Não foi possível atualizar a empresa.","erro")}finally{q(!1)}}}function Ae(){return e.jsxs(e.Fragment,{children:[e.jsxs("section",{style:t.cardConfiguracao,className:"master-create-card",children:[e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"Nova empresa"}),e.jsx("p",{style:t.textoNota,children:"Crie um novo tenant e vincule automaticamente seu usuário master."})]}),e.jsxs("form",{className:"master-create-form",onSubmit:U,children:[e.jsx("input",{style:t.input,value:H,onChange:C=>ie(C.target.value),placeholder:"Nome da empresa"}),e.jsx("button",{style:t.btnSalvar,type:"submit",disabled:V,children:V?"Salvando...":"Criar empresa"})]})]}),e.jsxs("section",{style:t.cardConfiguracao,children:[e.jsxs("div",{className:"master-list-header",children:[e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"Empresas cadastradas"}),e.jsx("p",{style:t.textoNota,children:"Controle inicial das empresas disponíveis no SaaS."})]}),e.jsx("input",{style:t.input,className:"master-search-input",value:P,onChange:C=>z(C.target.value),placeholder:"Buscar empresa"})]}),ne?e.jsx("p",{style:t.textoNota,children:"Carregando empresas..."}):we.length===0?e.jsxs("div",{className:"empty-state-card",children:[e.jsx("div",{className:"empty-state-icon",children:"🏢"}),e.jsx("strong",{children:"Nenhuma empresa encontrada"}),e.jsx("p",{children:"Crie a primeira empresa ou ajuste a busca."})]}):e.jsx("div",{className:"master-companies-list",children:we.map(C=>{const be=C.id===i,ze=ae===C.id;return e.jsxs("article",{className:`master-company-card ${be?"active":""}`,children:[e.jsxs("div",{className:"master-company-main",children:[e.jsx("span",{className:"master-company-icon",children:"🏢"}),e.jsxs("div",{children:[ze?e.jsx("input",{style:t.input,value:M,onChange:me=>Y(me.target.value),autoFocus:!0}):e.jsx("h3",{children:C.nome||"Empresa sem nome"}),e.jsxs("small",{children:["ID: ",C.id]})]})]}),e.jsxs("div",{className:"master-company-meta",children:[e.jsxs("span",{children:[C.totalUsuarios||0," usuário(s)"]}),e.jsxs("span",{children:["Criada em ",ll(C.created_at)]}),be&&e.jsx("strong",{children:"Ativa"})]}),e.jsx("div",{className:"master-company-actions",children:ze?e.jsxs(e.Fragment,{children:[e.jsx("button",{style:t.btnSalvar,type:"button",disabled:V,onClick:()=>fe(C),children:"Salvar"}),e.jsx("button",{style:t.btnCinza,type:"button",onClick:()=>{I(null),Y("")},children:"Cancelar"})]}):e.jsxs(e.Fragment,{children:[e.jsx("button",{style:t.btnCinza,type:"button",onClick:()=>{I(C.id),Y(C.nome||"")},children:"Editar"}),!be&&e.jsx("button",{style:t.btnSalvar,type:"button",disabled:l,onClick:()=>d==null?void 0:d(C.id),children:"Ativar"})]})})]},C.id)})})]})]})}return e.jsxs("div",{className:"master-panel-page",children:[e.jsxs("div",{className:"master-page-hero",children:[e.jsxs("div",{children:[e.jsx("span",{className:"master-kicker",children:"Painel Master SaaS"}),e.jsx("h1",{style:t.titulo,children:"🏢 Painel Master"}),e.jsx("p",{style:t.textoNota,children:"Gerencie empresas e tenants da plataforma. Filiais ficam nas Configurações de cada empresa."})]}),e.jsx("button",{style:t.btnCinza,type:"button",onClick:b,children:"← Dashboard"})]}),e.jsxs("div",{className:"master-stats-grid",children:[e.jsxs("section",{className:"master-stat-card",children:[e.jsx("small",{children:"Empresas cadastradas"}),e.jsx("strong",{children:g.length})]}),e.jsxs("section",{className:"master-stat-card",children:[e.jsx("small",{children:"Empresa ativa"}),e.jsx("strong",{children:(J==null?void 0:J.nome)||"—"})]}),e.jsxs("section",{className:"master-stat-card",children:[e.jsx("small",{children:"Administração SaaS"}),e.jsx("strong",{children:"Tenants"})]})]}),Ae()]})}function cl(t){if(!t)return"—";try{return new Intl.DateTimeFormat("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}).format(new Date(t))}catch{return"—"}}function pl({styles:t,empresaId:a,empresaNome:o,mostrarAviso:i,voltarPainel:n}){const[d,l]=c.useState([]),[m,f]=c.useState(""),[b,_]=c.useState(""),[k,S]=c.useState(!0),[g,T]=c.useState(!1),[P,z]=c.useState(null),[H,ie]=c.useState("");async function V(){if(!a){l([]),S(!1);return}S(!0);try{const I=await Ho(a);l(I)}catch(I){i==null||i((I==null?void 0:I.message)||"Não foi possível carregar filiais.","erro")}finally{S(!1)}}c.useEffect(()=>{V()},[a]);const q=c.useMemo(()=>{const I=String(m||"").trim().toLowerCase();return I?d.filter(M=>String(M.nome||"").toLowerCase().includes(I)):d},[m,d]);async function ne(I){if(I.preventDefault(),!g){T(!0);try{await il({empresaId:a,nome:b}),_(""),await V(),i==null||i("Filial criada com sucesso.","sucesso")}catch(M){i==null||i((M==null?void 0:M.message)||"Não foi possível criar a filial.","erro")}finally{T(!1)}}}async function G(I){if(!(!(I!=null&&I.id)||g)){T(!0);try{await nl({filialId:I.id,nome:H}),z(null),ie(""),await V(),i==null||i("Filial atualizada com sucesso.","sucesso")}catch(M){i==null||i((M==null?void 0:M.message)||"Não foi possível atualizar a filial.","erro")}finally{T(!1)}}}async function ae(I){if(!(!(I!=null&&I.id)||g)){T(!0);try{await sl({filialId:I.id,ativo:!I.ativo}),await V(),i==null||i(I.ativo?"Filial desativada.":"Filial ativada.","sucesso")}catch(M){i==null||i((M==null?void 0:M.message)||"Não foi possível alterar a filial.","erro")}finally{T(!1)}}}return e.jsxs("div",{className:"branches-settings-page",children:[e.jsxs("div",{className:"master-page-hero",children:[e.jsxs("div",{children:[e.jsx("span",{className:"master-kicker",children:"Configurações da empresa"}),e.jsx("h1",{style:t.titulo,children:"🏬 Filiais / Unidades"}),e.jsx("p",{style:t.textoNota,children:"Cadastre unidades operacionais dentro da empresa ativa. As próximas fases ligarão contas e relatórios a essas filiais."}),e.jsxs("small",{style:t.textoAjuda,children:["Empresa ativa: ",e.jsx("strong",{children:o||"—"})]})]}),e.jsx("button",{style:t.btnCinza,type:"button",onClick:n,children:"← Configurações"})]}),e.jsxs("section",{style:t.cardConfiguracao,className:"master-create-card",children:[e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"Nova filial"}),e.jsx("p",{style:t.textoNota,children:"Use nomes como Loja Centro, Loja Shopping, Produção, Delivery ou Administração."})]}),e.jsxs("form",{className:"master-create-form",onSubmit:ne,children:[e.jsx("input",{style:t.input,value:b,onChange:I=>_(I.target.value),placeholder:"Nome da filial",disabled:!a}),e.jsx("button",{style:t.btnSalvar,type:"submit",disabled:g||!a,children:g?"Salvando...":"Criar filial"})]})]}),e.jsxs("section",{style:t.cardConfiguracao,children:[e.jsxs("div",{className:"master-list-header",children:[e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"Filiais cadastradas"}),e.jsx("p",{style:t.textoNota,children:"Cada empresa enxerga apenas suas próprias unidades."})]}),e.jsx("input",{style:t.input,className:"master-search-input",value:m,onChange:I=>f(I.target.value),placeholder:"Buscar filial"})]}),k?e.jsx("p",{style:t.textoNota,children:"Carregando filiais..."}):q.length===0?e.jsxs("div",{className:"empty-state-card",children:[e.jsx("div",{className:"empty-state-icon",children:"🏬"}),e.jsx("strong",{children:"Nenhuma filial encontrada"}),e.jsx("p",{children:"Crie unidades para organizar contas por local de operação."})]}):e.jsx("div",{className:"master-companies-list",children:q.map(I=>{const M=P===I.id;return e.jsxs("article",{className:`master-company-card ${I.ativo?"active":""}`,children:[e.jsxs("div",{className:"master-company-main",children:[e.jsx("span",{className:"master-company-icon",children:"🏬"}),e.jsxs("div",{children:[M?e.jsx("input",{style:t.input,value:H,onChange:Y=>ie(Y.target.value),autoFocus:!0}):e.jsx("h3",{children:I.nome||"Filial sem nome"}),e.jsxs("small",{children:["ID: ",I.id]})]})]}),e.jsxs("div",{className:"master-company-meta",children:[e.jsxs("span",{children:["Criada em ",cl(I.created_at)]}),e.jsx("strong",{children:I.ativo?"Ativa":"Inativa"})]}),e.jsx("div",{className:"master-company-actions",children:M?e.jsxs(e.Fragment,{children:[e.jsx("button",{style:t.btnSalvar,type:"button",disabled:g,onClick:()=>G(I),children:"Salvar"}),e.jsx("button",{style:t.btnCinza,type:"button",onClick:()=>{z(null),ie("")},children:"Cancelar"})]}):e.jsxs(e.Fragment,{children:[e.jsx("button",{style:t.btnCinza,type:"button",onClick:()=>{z(I.id),ie(I.nome||"")},children:"Editar"}),e.jsx("button",{style:I.ativo?t.btnCinza:t.btnSalvar,type:"button",disabled:g,onClick:()=>ae(I),children:I.ativo?"Desativar":"Ativar"})]})})]},I.id)})})]})]})}const da=[{codigo:"starter",nome:"Starter",descricao:"Base para operação pequena com uma unidade.",limite_filiais:1,limite_usuarios:3,valor_mensal:0,recursos:["1 filial","3 usuários","Contas e notas","Dashboard básico"]},{codigo:"profissional",nome:"Profissional",descricao:"Operação multiunidade com dashboard operacional.",limite_filiais:5,limite_usuarios:15,valor_mensal:149,recursos:["Até 5 filiais","Até 15 usuários","Dashboard operacional","Relatórios gerenciais"]},{codigo:"enterprise",nome:"Enterprise",descricao:"Estrutura avançada para redes, permissões e expansão SaaS.",limite_filiais:null,limite_usuarios:null,valor_mensal:null,recursos:["Filiais ilimitadas","Usuários ilimitados","Permissões avançadas","Suporte prioritário"]}];function Mi(t){const a=String((t==null?void 0:t.message)||"").toLowerCase();return(t==null?void 0:t.code)==="42P01"||a.includes("does not exist")||a.includes("schema cache")}function ml(t="profissional"){return da.find(a=>a.codigo===t)||da[1]}async function ul(){const{data:t,error:a}=await D.from("df_planos").select("id, codigo, nome, descricao, limite_filiais, limite_usuarios, valor_mensal, ativo").eq("ativo",!0).order("valor_mensal",{ascending:!0,nullsFirst:!1});if(a){if(Mi(a))return da;throw a}return!Array.isArray(t)||t.length===0?da:t.map(o=>({...o,recursos:gl(o)}))}async function fl(t){if(!t)return null;const{data:a,error:o}=await D.from("df_assinaturas").select("id, empresa_id, plano_codigo, status, trial_inicio, trial_fim, assinatura_inicio, assinatura_fim, limite_filiais, limite_usuarios").eq("empresa_id",t).order("created_at",{ascending:!1}).limit(1).maybeSingle();if(o){if(Mi(o))return null;throw o}return a||null}async function xl(t){const[a,o]=await Promise.all([ul(),fl(t)]),i=a.find(n=>n.codigo===(o==null?void 0:o.plano_codigo))||ml(o==null?void 0:o.plano_codigo);return{planos:a,assinatura:o,planoAtual:{...i,limite_filiais:(o==null?void 0:o.limite_filiais)??i.limite_filiais,limite_usuarios:(o==null?void 0:o.limite_usuarios)??i.limite_usuarios}}}async function hl({empresaId:t,planoCodigo:a,limiteFiliais:o,limiteUsuarios:i,status:n="trial"}){if(!t)throw new Error("Empresa não identificada.");if(!a)throw new Error("Selecione um plano.");const d={empresa_id:t,plano_codigo:a,status:n,limite_filiais:o,limite_usuarios:i,updated_at:new Date().toISOString()},{data:l,error:m}=await D.from("df_assinaturas").select("id").eq("empresa_id",t).order("created_at",{ascending:!1}).limit(1).maybeSingle();if(m)throw m;if(l!=null&&l.id){const{data:_,error:k}=await D.from("df_assinaturas").update(d).eq("id",l.id).select("*").single();if(k)throw k;return _}const{data:f,error:b}=await D.from("df_assinaturas").insert([{...d,trial_inicio:new Date().toISOString().slice(0,10)}]).select("*").single();if(b)throw b;return f}function gl(t){const a=[];return a.push(t.limite_filiais?`Até ${t.limite_filiais} filial(is)`:"Filiais ilimitadas"),a.push(t.limite_usuarios?`Até ${t.limite_usuarios} usuário(s)`:"Usuários ilimitados"),a.push("Dashboard operacional"),a.push("Base para billing SaaS"),a}function ni(t,a,o){if(t==null||t==="")return"Ilimitado";const i=Number(t);return Number.isFinite(i)?`${i} ${i===1?a:o}`:"Ilimitado"}function si(t){return t==null?"Sob consulta":Number(t)===0?"R$ 0,00":Number(t).toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}function ga(t){return t==null?"":String(t)}function bl(t){if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?String(t):a.toLocaleDateString("pt-BR")}function vl({styles:t,empresaId:a,empresaNome:o,filiais:i=[],usuarios:n=[],mostrarAviso:d,podeEditar:l=!1,voltarPainel:m}){const[f,b]=c.useState(!0),[_,k]=c.useState(!1),[S,g]=c.useState(da),[T,P]=c.useState(null),[z,H]=c.useState("profissional"),[ie,V]=c.useState("trial"),[q,ne]=c.useState(5),[G,ae]=c.useState(15),[I,M]=c.useState(null);c.useEffect(()=>{let N=!0;async function J(){var Me,_e,we,U,fe,Ae;if(a){b(!0);try{const C=await xl(a);if(!N)return;g(C.planos||da),P(C.assinatura);const be=((Me=C.assinatura)==null?void 0:Me.plano_codigo)||((_e=C.assinatura)==null?void 0:_e.plano_slug)||((we=C.planoAtual)==null?void 0:we.codigo)||"profissional",ze=((U=C.assinatura)==null?void 0:U.status)||"trial",me=((fe=C.planoAtual)==null?void 0:fe.limite_filiais)??"",$=((Ae=C.planoAtual)==null?void 0:Ae.limite_usuarios)??"";H(be),V(ze),ne(me),ae($),M({planoSelecionado:be,statusSelecionado:ze,limiteFiliais:ga(me),limiteUsuarios:ga($)})}catch(C){console.error("Erro ao carregar billing:",C),N&&(d==null||d("Não foi possível carregar o billing: "+C.message,"erro"))}finally{N&&b(!1)}}}return J(),()=>{N=!1}},[a,d]);const Y=c.useMemo(()=>S.find(N=>N.codigo===z)||da.find(N=>N.codigo==="profissional"),[S,z]),je=i.length,ce=n.length,he=q===""?null:Number(q),Ce=G===""?null:Number(G),oe=he?Math.min(100,Math.round(je/he*100)):100,y=Ce?Math.min(100,Math.round(ce/Ce*100)):100,pe=he!==null&&je>=he,A=Ce!==null&&ce>=Ce,Z=!!I&&(I.planoSelecionado!==z||I.statusSelecionado!==ie||I.limiteFiliais!==ga(q)||I.limiteUsuarios!==ga(G));function K(N){const J=S.find(Me=>Me.codigo===N);H(N),ne((J==null?void 0:J.limite_filiais)??""),ae((J==null?void 0:J.limite_usuarios)??"")}async function Q(){if(l){k(!0);try{const N=await hl({empresaId:a,planoCodigo:z,status:ie,limiteFiliais:q===""?null:Number(q),limiteUsuarios:G===""?null:Number(G)});P(N),M({planoSelecionado:z,statusSelecionado:ie,limiteFiliais:ga(q),limiteUsuarios:ga(G)}),d==null||d("Billing atualizado com sucesso.","info")}catch(N){console.error("Erro ao salvar billing:",N),d==null||d("Erro ao salvar billing: "+N.message,"erro")}finally{k(!1)}}}return e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:t.titulo,children:"💼 Billing Foundation"}),e.jsx("button",{style:t.btnCinza,onClick:m,children:"← Voltar"}),e.jsxs("section",{style:t.cardConfiguracao,className:"billing-hero",children:[e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"Base comercial SaaS"}),e.jsxs("p",{style:t.textoNota,children:["Empresa: ",e.jsx("strong",{children:o||"Empresa atual"})," • Status: ",e.jsx("strong",{children:(T==null?void 0:T.status)||"trial estrutural"})]}),e.jsx("p",{style:t.textoAjuda,children:"Esta fase cria a fundação de planos, limites e assinatura. Ainda não bloqueia o uso do app; os bloqueios comerciais ficam para o hardening posterior."})]}),e.jsxs("div",{className:"billing-current-plan",children:[e.jsx("span",{children:"Plano atual"}),e.jsx("strong",{children:(Y==null?void 0:Y.nome)||"Profissional"}),e.jsxs("small",{children:[si(Y==null?void 0:Y.valor_mensal)," / mês"]})]})]}),e.jsxs("section",{className:"billing-kpi-grid",children:[e.jsxs("div",{className:`billing-kpi-card ${pe?"warning":""}`,children:[e.jsx("span",{children:"Filiais em uso"}),e.jsx("strong",{children:je}),e.jsx("small",{children:ni(he,"filial liberada","filiais liberadas")}),e.jsx("div",{className:"billing-progress",children:e.jsx("span",{style:{width:`${oe}%`}})})]}),e.jsxs("div",{className:`billing-kpi-card ${A?"warning":""}`,children:[e.jsx("span",{children:"Usuários em uso"}),e.jsx("strong",{children:ce}),e.jsx("small",{children:ni(Ce,"usuário liberado","usuários liberados")}),e.jsx("div",{className:"billing-progress",children:e.jsx("span",{style:{width:`${y}%`}})})]}),e.jsxs("div",{className:"billing-kpi-card",children:[e.jsx("span",{children:"Status comercial"}),e.jsx("strong",{children:ie}),e.jsx("small",{children:T!=null&&T.trial_fim?`Trial até ${bl(T.trial_fim)}`:"Trial preparado"})]})]}),e.jsxs("section",{style:t.cardConfiguracao,children:[e.jsx("h2",{style:t.subtitulo,children:"Planos disponíveis"}),e.jsx("div",{className:"billing-plan-grid",children:S.map(N=>e.jsxs("button",{type:"button",className:`billing-plan-card ${z===N.codigo?"selected":""}`,onClick:()=>K(N.codigo),disabled:!l,children:[e.jsx("span",{children:N.nome}),e.jsx("strong",{children:si(N.valor_mensal)}),e.jsx("small",{children:N.descricao}),e.jsx("ul",{children:(N.recursos||[]).map(J=>e.jsx("li",{children:J},J))})]},N.codigo))})]}),e.jsxs("section",{style:t.cardConfiguracao,children:[e.jsxs("div",{className:"billing-section-header",children:[e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"Assinatura e limites"}),e.jsx("p",{style:t.textoNota,children:"Defina os limites comerciais da empresa sem alterar os dados operacionais já validados."})]}),!l&&e.jsx("span",{className:"billing-readonly",children:"Somente leitura"}),l&&Z&&e.jsx("span",{className:"billing-pending",children:"● Alterações pendentes"})]}),e.jsxs("div",{className:"billing-form-grid",children:[e.jsxs("label",{children:[e.jsx("span",{children:"Plano"}),e.jsx("select",{style:t.input,value:z,disabled:!l,onChange:N=>K(N.target.value),children:S.map(N=>e.jsx("option",{value:N.codigo,children:N.nome},N.codigo))})]}),e.jsxs("label",{children:[e.jsx("span",{children:"Status"}),e.jsxs("select",{style:t.input,value:ie,disabled:!l,onChange:N=>V(N.target.value),children:[e.jsx("option",{value:"trial",children:"Trial"}),e.jsx("option",{value:"ativa",children:"Ativa"}),e.jsx("option",{value:"pausada",children:"Pausada"}),e.jsx("option",{value:"cancelada",children:"Cancelada"})]})]}),e.jsxs("label",{children:[e.jsx("span",{children:"Limite de filiais"}),e.jsx("input",{style:t.input,type:"number",min:"0",placeholder:"Ilimitado",value:q,disabled:!l,onChange:N=>ne(N.target.value)})]}),e.jsxs("label",{children:[e.jsx("span",{children:"Limite de usuários"}),e.jsx("input",{style:t.input,type:"number",min:"0",placeholder:"Ilimitado",value:G,disabled:!l,onChange:N=>ae(N.target.value)})]})]}),l&&e.jsx("button",{style:{...t.btnSalvar,opacity:f||_||!Z?.65:1},disabled:f||_||!Z,onClick:Q,children:_?"Salvando...":Z?"Salvar alterações do billing":"Billing salvo"})]})]})}function jl(){return new Date().toISOString().slice(0,10)}function Bo(t){return String(t||"").trim().replace(/\s+/g," ")}function Fa({numero:t,titulo:a,descricao:o,concluido:i,ativo:n,children:d}){return e.jsxs("section",{className:`onboarding-step-card ${i?"done":""} ${n?"active":""}`,children:[e.jsxs("div",{className:"onboarding-step-head",children:[e.jsx("div",{className:"onboarding-step-number",children:i?"✓":t}),e.jsxs("div",{children:[e.jsx("span",{children:i?"Concluído":n?"Próximo passo":"Pendente"}),e.jsx("h3",{children:a}),e.jsx("p",{children:o})]})]}),n&&e.jsx("div",{className:"onboarding-step-body",children:d})]})}function yl({styles:t,empresaId:a,empresaNome:o,filiais:i=[],centros:n=[],contas:d=[],mostrarAviso:l,onRefresh:m,voltarPainel:f,abrirDashboard:b}){var K,Q;const[_,k]=c.useState(!1),[S,g]=c.useState("Loja Centro"),[T,P]=c.useState("Operacional"),[z,H]=c.useState("Primeira conta de teste"),[ie,V]=c.useState("100,00"),[q,ne]=c.useState(jl()),[G,ae]=c.useState(""),[I,M]=c.useState(""),Y=c.useMemo(()=>i.filter(N=>(N==null?void 0:N.ativo)!==!1),[i]),je=c.useMemo(()=>d.filter(N=>(N==null?void 0:N.excluido)!==!0),[d]),ce={empresa:!!a,filial:Y.length>0,centro:n.length>0,conta:je.length>0},he=Math.round([ce.empresa,ce.filial,ce.centro,ce.conta].filter(Boolean).length/4*100),Ce=he===100,oe=ce.empresa?ce.filial?ce.centro?ce.conta?"dashboard":"conta":"centro":"filial":"empresa";async function y(){await(m==null?void 0:m())}async function pe(){const N=Bo(S);if(!a)return l==null?void 0:l("Empresa não identificada para onboarding.","erro");if(N.length<2)return l==null?void 0:l("Informe o nome da primeira filial.","erro");k(!0);try{const{error:J}=await D.from("df_filiais").insert([{empresa_id:a,nome:N,ativo:!0}]);if(J)throw J;l==null||l("Primeira filial criada com sucesso.","info"),await y()}catch(J){l==null||l("Erro ao criar filial: "+J.message,"erro")}finally{k(!1)}}async function A(){const N=Bo(T);if(!a)return l==null?void 0:l("Empresa não identificada para onboarding.","erro");if(N.length<2)return l==null?void 0:l("Informe o nome do primeiro centro de custo.","erro");k(!0);try{const{error:J}=await D.from("df_centros_custo").insert([{empresa_id:a,nome:N}]);if(J)throw J;l==null||l("Centro de custo criado com sucesso.","info"),await y()}catch(J){l==null||l("Erro ao criar centro de custo: "+J.message,"erro")}finally{k(!1)}}async function Z(){var we,U;if(!a)return l==null?void 0:l("Empresa não identificada para onboarding.","erro");const N=Bo(z),J=Ni(ie),Me=G||((we=Y[0])==null?void 0:we.id)||null,_e=I||((U=n[0])==null?void 0:U.id)||null;if(N.length<2)return l==null?void 0:l("Informe a descrição da primeira conta.","erro");if(!J||J<=0)return l==null?void 0:l("Informe um valor válido para a primeira conta.","erro");if(!q)return l==null?void 0:l("Informe o vencimento da primeira conta.","erro");k(!0);try{const fe={empresa_id:a,descricao:N,valor:J,data_vencimento:q,vencimento:q,status:"pendente",centro_custo_id:_e,filial_id:Me,excluido:!1},{error:Ae}=await D.from("df_contas").insert([fe]);if(Ae)throw Ae;l==null||l("Primeira conta criada. Dashboard pronto para uso.","info"),await y()}catch(fe){l==null||l("Erro ao criar primeira conta: "+fe.message,"erro")}finally{k(!1)}}return e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:t.titulo,children:"🚀 Onboarding SaaS"}),e.jsx("button",{style:t.btnCinza,onClick:f,children:"← Voltar"}),e.jsxs("section",{style:t.cardConfiguracao,className:"onboarding-hero",children:[e.jsxs("div",{children:[e.jsx("span",{className:"onboarding-eyebrow",children:"Configuração inicial"}),e.jsx("h2",{style:t.subtitulo,children:"Deixe a empresa pronta para operar"}),e.jsxs("p",{style:t.textoNota,children:["Empresa: ",e.jsx("strong",{children:o||"Empresa atual"}),". Este fluxo prepara a primeira unidade, centro de custo e conta para liberar o dashboard operacional."]})]}),e.jsxs("div",{className:"onboarding-progress-box",children:[e.jsxs("span",{children:[he,"%"]}),e.jsx("small",{children:Ce?"Onboarding completo":"Em implantação"}),e.jsx("div",{className:"onboarding-progress",children:e.jsx("i",{style:{width:`${he}%`}})})]})]}),e.jsxs("section",{className:"onboarding-kpi-grid",children:[e.jsxs("div",{children:[e.jsx("span",{children:"Filiais"}),e.jsx("strong",{children:Y.length})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Centros de custo"}),e.jsx("strong",{children:n.length})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Contas ativas"}),e.jsx("strong",{children:je.length})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Status"}),e.jsx("strong",{children:Ce?"Pronto":"Guiado"})]})]}),e.jsxs("div",{className:"onboarding-steps-grid",children:[e.jsx(Fa,{numero:"1",titulo:"Empresa ativa",descricao:"A empresa atual já está definida no tenant selecionado.",concluido:ce.empresa,ativo:oe==="empresa",children:e.jsx("p",{style:t.textoNota,children:"Selecione ou crie uma empresa pelo Painel Master antes de continuar."})}),e.jsxs(Fa,{numero:"2",titulo:"Primeira filial",descricao:"Crie a unidade inicial para separar operação e indicadores.",concluido:ce.filial,ativo:oe==="filial",children:[e.jsx("input",{style:t.input,value:S,onChange:N=>g(N.target.value),placeholder:"Ex: Loja Centro"}),e.jsx("button",{style:t.btnSalvar,disabled:_,onClick:pe,children:_?"Criando...":"Criar primeira filial"})]}),e.jsxs(Fa,{numero:"3",titulo:"Centro de custo",descricao:"Crie uma classificação financeira básica para as primeiras contas.",concluido:ce.centro,ativo:oe==="centro",children:[e.jsx("input",{style:t.input,value:T,onChange:N=>P(N.target.value),placeholder:"Ex: Operacional"}),e.jsx("button",{style:t.btnSalvar,disabled:_,onClick:A,children:_?"Criando...":"Criar centro de custo"})]}),e.jsxs(Fa,{numero:"4",titulo:"Primeira conta",descricao:"Registre uma conta inicial para alimentar KPIs, ranking e dashboard.",concluido:ce.conta,ativo:oe==="conta",children:[e.jsxs("div",{className:"onboarding-form-grid",children:[e.jsx("input",{style:t.input,value:z,onChange:N=>H(N.target.value),placeholder:"Descrição"}),e.jsx("input",{style:t.input,value:ie,onChange:N=>V(N.target.value),placeholder:"Valor"}),e.jsx("input",{style:t.input,type:"date",value:q,onChange:N=>ne(N.target.value)}),e.jsxs("select",{style:t.input,value:G,onChange:N=>ae(N.target.value),children:[e.jsx("option",{value:"",children:((K=Y[0])==null?void 0:K.nome)||"Filial padrão"}),Y.map(N=>e.jsx("option",{value:N.id,children:N.nome},N.id))]}),e.jsxs("select",{style:t.input,value:I,onChange:N=>M(N.target.value),children:[e.jsx("option",{value:"",children:((Q=n[0])==null?void 0:Q.nome)||"Centro padrão"}),n.map(N=>e.jsx("option",{value:N.id,children:N.nome},N.id))]})]}),e.jsx("button",{style:t.btnSalvar,disabled:_,onClick:Z,children:_?"Criando...":"Criar primeira conta"})]}),e.jsxs(Fa,{numero:"5",titulo:"Dashboard pronto",descricao:"A operação inicial já pode ser acompanhada no dashboard.",concluido:Ce,ativo:oe==="dashboard",children:[e.jsx("p",{style:t.textoNota,children:"Base inicial concluída. Revise os KPIs, ranking de unidades e filtros por filial."}),e.jsx("button",{style:t.btnSalvar,onClick:b,children:"Ir para o dashboard"})]})]})]})}function wl({novoEmailUsuario:t,setNovoEmailUsuario:a,novaSenhaUsuario:o,setNovaSenhaUsuario:i,confirmarNovaSenhaUsuario:n,setConfirmarNovaSenhaUsuario:d,salvarMeuEmail:l,salvarMinhaSenha:m,styles:f}){return e.jsxs("div",{className:"users-account-grid users-security-grid",children:[e.jsxs("div",{className:"users-form-card users-security-card",children:[e.jsxs("div",{className:"users-security-card-header",children:[e.jsx("strong",{children:"Alterar e-mail"}),e.jsx("small",{style:f.textoAjuda,children:"Confirmação pode ser solicitada."})]}),e.jsx("input",{style:f.input,type:"email",placeholder:"Novo e-mail",value:t,onChange:b=>a(b.target.value)}),e.jsx("button",{style:f.btnSalvar,onClick:l,children:"Atualizar e-mail"})]}),e.jsxs("div",{className:"users-form-card users-security-card",children:[e.jsxs("div",{className:"users-security-card-header",children:[e.jsx("strong",{children:"Alterar senha"}),e.jsx("small",{style:f.textoAjuda,children:"Mínimo de 6 caracteres."})]}),e.jsxs("div",{className:"users-security-password-grid",children:[e.jsx("input",{style:f.input,type:"password",placeholder:"Nova senha",value:o,onChange:b=>i(b.target.value)}),e.jsx("input",{style:f.input,type:"password",placeholder:"Confirmar nova senha",value:n,onChange:b=>d(b.target.value)})]}),e.jsx("button",{style:f.btnSalvar,onClick:m,children:"Atualizar senha"})]})]})}function kl({styles:t,EmptyState:a,podeAcessarConfiguracoes:o,podeAdministrarUsuarios:i,navegarPara:n,usuarioLogado:d,normalizarPerfil:l,perfilUsuario:m,permissoesUsuario:f,novoEmailUsuario:b,setNovoEmailUsuario:_,novaSenhaUsuario:k,setNovaSenhaUsuario:S,confirmarNovaSenhaUsuario:g,setConfirmarNovaSenhaUsuario:T,salvarMeuEmail:P,salvarMinhaSenha:z,empresasDisponiveis:H,empresaId:ie,trocandoEmpresa:V,trocarEmpresaAtiva:q,buscarUsuariosEmpresa:ne,primeiraLetraMaiuscula:G,nomeConviteUsuario:ae,setNomeConviteUsuario:I,emailConviteUsuario:M,setEmailConviteUsuario:Y,senhaConviteUsuario:je,setSenhaConviteUsuario:ce,perfilConviteUsuario:he,setPerfilConviteUsuario:Ce,criandoUsuarioManual:oe,adicionarUsuarioEmpresa:y,usuariosCarregando:pe,usuariosInicializados:A,usuariosErro:Z,usuariosEmpresa:K,filiais:Q,filiaisUsuariosEmpresa:N,salvandoFilialUsuario:J,liberarTodasFiliaisUsuario:Me,alternarFilialUsuario:_e,atualizarPerfilUsuarioEmpresa:we,enviarAcessoUsuarioEmpresa:U,removerUsuarioEmpresa:fe}){if(!o())return e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:t.titulo,children:"👥 Usuários"}),e.jsxs("section",{style:t.cardConfiguracao,children:[e.jsx("h2",{style:t.subtitulo,children:"Acesso restrito"}),e.jsx("p",{style:t.textoNota,children:"Seu perfil atual não permite acessar a gestão de usuários."}),e.jsx("button",{style:t.btnCinza,onClick:()=>n("contas"),children:"← Voltar"})]})]});const Ae=(d==null?void 0:d.email)||"";return e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:t.titulo,children:"👥 Gestão de usuários"}),e.jsx("button",{style:t.btnCinza,onClick:()=>n("dashboard"),children:"← Voltar"}),e.jsxs("section",{style:t.cardConfiguracao,className:"users-page-section",children:[e.jsx("h2",{style:t.subtitulo,children:"Minha conta"}),e.jsxs("p",{style:t.textoNota,children:["Usuário conectado: ",e.jsx("strong",{children:Ae})," • Perfil: ",e.jsx("strong",{children:l(m)}),f!=null&&f.isMaster?e.jsxs(e.Fragment,{children:[" • Global: ",e.jsx("strong",{children:"master"})]}):null]}),e.jsx(wl,{novoEmailUsuario:b,setNovoEmailUsuario:_,novaSenhaUsuario:k,setNovaSenhaUsuario:S,confirmarNovaSenhaUsuario:g,setConfirmarNovaSenhaUsuario:T,salvarMeuEmail:P,salvarMinhaSenha:z,styles:t})]}),(f==null?void 0:f.canSwitchCompany)&&H.length>1&&e.jsxs("section",{style:t.cardConfiguracao,className:"users-page-section",children:[e.jsxs("div",{className:"users-header-row",children:[e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"🏢 Empresas disponíveis"}),e.jsx("p",{style:t.textoNota,children:"Troque a empresa ativa para recarregar os usuários e dados do tenant selecionado."})]}),e.jsx("span",{className:"roleBadge admin",children:"master"})]}),e.jsx("select",{style:t.input,value:ie||"",disabled:V,onChange:C=>q(C.target.value),children:H.map(C=>e.jsx("option",{value:C.id,children:C.nome||C.id},C.id))})]}),e.jsxs("section",{style:t.cardConfiguracao,className:"users-page-section",children:[e.jsxs("div",{className:"users-header-row",children:[e.jsxs("div",{children:[e.jsx("h2",{style:t.subtitulo,children:"Usuários da empresa"}),e.jsx("p",{style:t.textoNota,children:"Defina perfil e escopo por filial. Sem filial marcada = acesso a todas as filiais da empresa."})]}),e.jsx("button",{style:t.btnCinza,onClick:()=>ne(),children:"Atualizar"})]}),e.jsxs("div",{className:"users-permission-guide",children:[e.jsxs("span",{children:[e.jsx("strong",{children:"Admin:"})," acesso total"]}),e.jsxs("span",{children:[e.jsx("strong",{children:"Gerente:"})," contas, notas, relatórios e configurações operacionais"]}),e.jsxs("span",{children:[e.jsx("strong",{children:"Financeiro:"})," contas, notas e relatórios"]}),e.jsxs("span",{children:[e.jsx("strong",{children:"Operacional:"})," contas e notas operacionais"]}),e.jsxs("span",{children:[e.jsx("strong",{children:"Visualização:"})," somente consulta"]}),e.jsxs("span",{children:[e.jsx("strong",{children:"Operador:"})," compatibilidade com acessos antigos"]}),e.jsxs("span",{children:[e.jsx("strong",{children:"Filiais:"})," limita o usuário às unidades selecionadas"]})]}),i()&&e.jsxs("div",{className:"users-add-card",children:[e.jsx("input",{style:t.input,type:"text",placeholder:"Nome do usuário",value:ae,onChange:C=>I(G(C.target.value))}),e.jsx("input",{style:t.input,type:"email",placeholder:"E-mail do usuário",value:M,onChange:C=>Y(C.target.value)}),e.jsx("input",{style:t.input,type:"text",placeholder:"Senha provisória manual",value:je,onChange:C=>ce(C.target.value)}),e.jsxs("select",{style:t.input,value:he,onChange:C=>Ce(C.target.value),children:[e.jsx("option",{value:"visualizacao",children:"Visualização"}),e.jsx("option",{value:"operacional",children:"Operacional"}),e.jsx("option",{value:"financeiro",children:"Financeiro"}),e.jsx("option",{value:"operador",children:"Operador"}),e.jsx("option",{value:"gerente",children:"Gerente"}),e.jsx("option",{value:"admin",children:"Admin"})]}),e.jsx("button",{style:t.btnSalvar,onClick:y,disabled:oe,children:oe?"Criando acesso...":"Criar acesso manual"}),e.jsx("small",{style:t.textoNota,children:"Sem envio de e-mail: o admin entrega o e-mail e a senha provisória manualmente."})]}),e.jsxs("div",{className:"users-list users-list-stable","aria-busy":pe,children:[pe&&!A&&e.jsx(a,{icon:"⏳",title:"Carregando usuários",description:"Buscando acessos cadastrados nesta empresa."}),!pe&&Z&&e.jsx(a,{icon:"⚠️",title:"Não foi possível carregar usuários",description:Z}),!pe&&!Z&&A&&K.length===0&&e.jsx(a,{icon:"👥",title:"Nenhum usuário cadastrado",description:"Adicione usuários para dividir a operação com segurança e níveis de acesso."}),K.map(C=>{const be=C.user_id&&(d==null?void 0:d.id)&&C.user_id===d.id,ze=!C.user_id;return e.jsxs("div",{className:"user-card userCard",children:[e.jsxs("div",{className:"user-card-header",children:[e.jsxs("div",{className:"user-main-info userInfo",children:[e.jsx("strong",{children:C.nome||C.email||"Usuário sem nome"}),e.jsx("small",{children:C.email||C.user_id||"Sem e-mail vinculado"}),e.jsxs("div",{className:"user-status-row",children:[be&&e.jsx("span",{className:"user-badge user-badge-self",children:"Você"}),ze&&e.jsx("span",{className:"user-badge user-badge-pending",children:"Pendente de vínculo"})]})]}),e.jsxs("div",{className:"user-card-controls",children:[e.jsx("span",{className:`roleBadge ${l(C.perfil)}`,children:l(C.perfil)}),e.jsxs("select",{className:"user-role-select",style:t.input,value:l(C.perfil),disabled:!i(),onChange:me=>we(C,me.target.value),children:[e.jsx("option",{value:"admin",children:"Admin"}),e.jsx("option",{value:"gerente",children:"Gerente"}),e.jsx("option",{value:"financeiro",children:"Financeiro"}),e.jsx("option",{value:"operacional",children:"Operacional"}),e.jsx("option",{value:"visualizacao",children:"Visualização"}),e.jsx("option",{value:"operador",children:"Operador"})]})]})]}),e.jsxs("div",{className:"user-branch-scope",children:[e.jsxs("div",{className:"user-branch-scope-header",children:[e.jsx("strong",{children:"Filiais permitidas"}),e.jsx("button",{type:"button",className:"user-branch-clear",disabled:!i()||J===C.id,onClick:()=>Me(C),title:"Deixar o usuário com acesso a todas as filiais da empresa",children:"Todas"})]}),e.jsx("div",{className:"user-branch-list",children:Q.length===0?e.jsx("small",{children:"Nenhuma filial ativa cadastrada."}):Q.map(me=>{const $=(N[C.id]||[]).includes(me.id);return e.jsxs("label",{className:`user-branch-chip ${$?"selected":""}`,children:[e.jsx("input",{type:"checkbox",checked:$,disabled:!i()||J===C.id,onChange:()=>_e(C,me.id)}),e.jsx("span",{children:me.nome||"Filial"})]},me.id)})}),(N[C.id]||[]).length===0&&e.jsx("small",{className:"user-branch-all",children:"Acesso a todas as filiais da empresa."})]}),i()&&e.jsxs("div",{className:"user-actions",children:[e.jsx("button",{style:t.btnSecundario,onClick:()=>U(C),title:"Fallback por e-mail. O acesso principal agora é criação manual com senha provisória.",children:"Enviar link"}),e.jsx("button",{style:t.btnExcluir,disabled:be,onClick:()=>fe(C),title:be?"Você não pode remover o próprio acesso.":"Remover usuário",children:"Remover"})]})]},C.id||C.user_id||C.email)})]})]})]})}const Ti=c.createContext(null),Vo="df_empresa_ativa";function Cl(){if(typeof window>"u")return null;try{return JSON.parse(window.localStorage.getItem(Vo)||"null")}catch{return null}}function li(t){if(!(typeof window>"u")){if(!(t!=null&&t.id)){window.localStorage.removeItem(Vo);return}window.localStorage.setItem(Vo,JSON.stringify(t))}}const Nl={sucesso:"Sucesso",success:"Sucesso",erro:"Atenção",error:"Atenção",alerta:"Atenção",warning:"Atenção",info:"Aviso"};function Sl(t){return t==="success"?"sucesso":t==="error"?"erro":t==="warning"?"alerta":t||"info"}function _l({children:t}){const[a,o]=c.useState(!1),[i,n]=c.useState(()=>Cl()),[d,l]=c.useState([]),[m,f]=c.useState(null),b=c.useRef(null),_=c.useCallback(z=>{const H=z!=null&&z.id?{id:z.id,nome:z.nome||"",perfil:z.perfil||"operador"}:null;n(H),li(H)},[]),k=c.useCallback(()=>{n(null),li(null)},[]),S=c.useCallback(()=>{b.current&&(window.clearTimeout(b.current),b.current=null),f(null)},[]),g=c.useCallback((z,H="info",ie={})=>{if(!z)return;const V=Sl(H),q=ie.duration??5200;b.current&&window.clearTimeout(b.current),f({id:Date.now(),message:String(z),type:V,title:ie.title||Nl[V]||"Aviso"}),b.current=window.setTimeout(()=>{f(null),b.current=null},q)},[]),T=c.useCallback(async z=>{o(!0);try{return await z()}finally{o(!1)}},[]),P=c.useMemo(()=>({globalLoading:a,setGlobalLoading:o,empresaAtiva:i,empresaId:(i==null?void 0:i.id)||null,perfilEmpresaAtiva:(i==null?void 0:i.perfil)||"",setEmpresaAtiva:_,limparEmpresaAtiva:k,empresasDisponiveis:d,setEmpresasDisponiveis:l,toast:m,showToast:g,hideToast:S,runWithLoading:T}),[a,i,d,m,g,S,T,_,k]);return e.jsx(Ti.Provider,{value:P,children:t})}function Di(){const t=c.useContext(Ti);if(!t)throw new Error("useApp deve ser usado dentro do AppProvider");return t}function El({onLogin:t}){const{showToast:a}=Di(),[o,i]=c.useState(""),[n,d]=c.useState(""),[l,m]=c.useState(!1);async function f(b){if(b.preventDefault(),!o||!n){a("Informe e-mail e senha","erro");return}const _=is();if(_){a(_,"erro");return}m(!0);const{data:k,error:S}=await D.auth.signInWithPassword({email:o,password:n});if(m(!1),S){a("E-mail ou senha inválidos","erro");return}const{error:g}=await D.rpc("vincular_usuario_logado");g&&console.warn("Não foi possível executar vínculo automático:",g.message),t(k.user)}return e.jsx("div",{style:Jt.page,children:e.jsxs("form",{style:Jt.card,onSubmit:f,children:[e.jsx("h1",{style:Jt.titulo,children:"Dona Flor Financeiro"}),e.jsx("p",{style:Jt.subtitulo,children:"Acesse sua conta para continuar"}),e.jsx("input",{style:Jt.input,type:"email",placeholder:"E-mail",value:o,onChange:b=>i(b.target.value)}),e.jsx("input",{style:Jt.input,type:"password",placeholder:"Senha",value:n,onChange:b=>d(b.target.value)}),e.jsx("button",{style:Jt.botao,disabled:l,children:l?"Entrando...":"Entrar"}),e.jsx("small",{style:Jt.ajuda,children:"Login seguro via Supabase Auth."})]})})}const Jt={page:{minHeight:"100vh",background:"#f8f9fa",display:"flex",alignItems:"center",justifyContent:"center",padding:16,fontFamily:"Arial"},card:{width:"100%",maxWidth:360,background:"#fff",borderRadius:18,padding:20,boxShadow:"0 8px 24px rgba(0,0,0,0.10)",display:"flex",flexDirection:"column",gap:10},titulo:{margin:0,fontSize:26},subtitulo:{margin:"0 0 10px",color:"#666",fontSize:14},input:{width:"100%",padding:12,borderRadius:10,border:"1px solid #ccc",boxSizing:"border-box",fontSize:15},botao:{width:"100%",padding:12,borderRadius:10,border:"none",background:"#198754",color:"#fff",fontWeight:"bold",fontSize:15},ajuda:{color:"#666",textAlign:"center",marginTop:8}};function zl({styles:t,nomeEmpresa:a,navegarPara:o,menuNavegacaoAberto:i,setMenuNavegacaoAberto:n,canSwitchCompany:d=!1,empresasDisponiveis:l=[],empresaId:m="",trocarEmpresaAtiva:f,trocandoEmpresa:b=!1,nomeUsuario:_,abrirPerfilUsuario:k,sairDoSistema:S}){const g=d&&l.length>0,T=l.find(P=>P.id===m);return e.jsxs("section",{className:"no-print top-shell top-shell-clean",style:t.usuarioTopo,children:[e.jsx("div",{className:"top-shell-context",children:e.jsxs("button",{className:"top-shell-logo",style:t.logoMarca,onClick:()=>o("dashboard"),title:"Ir para o dashboard",children:[e.jsx("img",{src:"/icon-192.png",alt:"DF Gestão Financeira",style:t.logoImagem}),e.jsxs("span",{children:[e.jsx("strong",{children:a||"Dona Flor"}),e.jsx("small",{children:"Gestão Financeira"})]})]})}),e.jsxs("div",{className:"top-shell-actions",style:t.usuarioAcoes,children:[g&&(l.length>1?e.jsxs("label",{className:"company-switcher",title:"Trocar empresa ativa",children:[e.jsx("span",{children:"Empresa"}),e.jsx("select",{value:m||"",disabled:b,onChange:P=>f==null?void 0:f(P.target.value),"aria-label":"Empresa ativa",children:l.map(P=>e.jsx("option",{value:P.id,children:P.nome||P.id},P.id))})]}):e.jsxs("div",{className:"company-switcher company-switcher-static",title:"Empresa ativa",children:[e.jsx("span",{children:"Empresa"}),e.jsx("strong",{children:(T==null?void 0:T.nome)||a||"Empresa ativa"})]})),e.jsx("button",{type:"button",className:"top-user-profile-button top-user-profile-icon",title:`Meu perfil${typeof _=="function"?`: ${_()}`:""}`,onClick:()=>k==null?void 0:k(),"aria-label":"Abrir meu perfil",children:e.jsx("span",{"aria-hidden":"true",children:"👤"})}),e.jsx("button",{className:"mobile-menu-trigger",style:t.btnMenuTopo,onClick:()=>n(!i),children:"☰"})]})]})}function Pl({tela:t,icon:a,label:o,telaAtual:i,sidebarCompacta:n,navegarPara:d}){const l=t&&i===t;return e.jsxs("button",{className:l?"active":"",title:o,onClick:()=>d(t),children:[e.jsx("span",{className:"menu-icon",children:a}),!n&&e.jsx("span",{className:"menu-text",children:o})]})}function Rl({id:t,titulo:a,children:o,sidebarCompacta:i,gruposMenu:n,toggleGrupoMenu:d}){return e.jsxs("div",{className:"sidebar-group-clean",children:[e.jsxs("button",{className:"sidebar-group-toggle",onClick:()=>d(t),title:a,children:[e.jsx("span",{children:i?"•":a}),!i&&e.jsx("strong",{children:n[t]?"−":"+"})]}),(i||n[t])&&e.jsx("nav",{className:"desktop-sidebar-nav",children:o})]})}function Fl({sidebarCompacta:t,setSidebarCompacta:a,nomeUsuario:o,normalizarPerfil:i,perfilUsuario:n,menuSections:d,telaAtual:l,navegarPara:m,gruposMenu:f,toggleGrupoMenu:b,sairDoSistema:_}){const k=o(),S=i(n||"usuário");return e.jsxs("aside",{className:`desktop-sidebar no-print ${t?"compacta":""}`,children:[e.jsxs("div",{className:"desktop-sidebar-brand sidebar-brand-clean",title:"DF Gestão Financeira",children:[e.jsx("img",{src:"/icon-192.png",alt:"DF Gestão Financeira"}),!t&&e.jsxs("div",{children:[e.jsx("strong",{children:"DF Gestão"}),e.jsx("small",{children:"Painel financeiro"})]})]}),e.jsxs("div",{className:"desktop-sidebar-user sidebar-user-clean",title:`${k} • ${S}`,children:[e.jsx("span",{className:"sidebar-user-avatar",children:String(k||"U").slice(0,1).toUpperCase()}),!t&&e.jsxs("div",{children:[e.jsx("strong",{children:k}),e.jsx("small",{children:S})]})]}),e.jsx("button",{className:"sidebar-collapse-btn sidebar-collapse-icon",onClick:()=>a(!t),title:t?"Expandir menu":"Recolher menu","aria-label":t?"Expandir menu":"Recolher menu",children:e.jsx("span",{className:"sidebar-collapse-arrow",children:t?"→":"←"})}),e.jsx("div",{className:"desktop-sidebar-scroll",children:d.map(g=>e.jsx(Rl,{id:g.id,titulo:g.titulo,sidebarCompacta:t,gruposMenu:f,toggleGrupoMenu:b,children:g.items.map(T=>e.jsx(Pl,{tela:T.tela,icon:T.icon,label:T.label,telaAtual:l,sidebarCompacta:t,navegarPara:m},T.tela))},g.id))}),e.jsx("div",{className:"desktop-sidebar-spacer"}),e.jsx("nav",{className:"desktop-sidebar-nav sidebar-exit",children:e.jsxs("button",{onClick:_,title:"Sair",children:[e.jsx("span",{className:"menu-icon",children:"🚪"}),!t&&e.jsx("span",{children:"Sair"})]})})]})}function $l({visible:t,styles:a,setMenuNavegacaoAberto:o,nomeUsuario:i,nomeUsuarioAtual:n,normalizarPerfil:d,perfilUsuario:l,menuSections:m,navegarPara:f,sairDoSistema:b,canSwitchCompany:_=!1,empresasDisponiveis:k=[],empresaId:S="",trocarEmpresaAtiva:g,trocandoEmpresa:T=!1,abrirPerfilUsuario:P}){if(!t)return null;const z=_&&k.length>0,H=k.find(q=>q.id===S),ie=n||(typeof i=="function"?i():i)||"usuário",V=(q,ne,G,ae)=>e.jsxs("button",{type:"button",style:a.menuNavItem,onClick:ae,children:[e.jsx("span",{children:q}),e.jsxs("div",{children:[e.jsx("strong",{children:ne}),e.jsx("small",{children:G})]})]});return e.jsx("div",{className:"no-print mobile-menu-backdrop",style:a.menuBackdrop,onClick:()=>o(!1),onTouchMove:q=>q.preventDefault(),children:e.jsxs("div",{className:"mobile-menu-panel",style:a.menuNavegacao,role:"dialog","aria-label":"Menu de navegação",onClick:q=>q.stopPropagation(),onWheel:q=>q.stopPropagation(),onTouchMove:q=>q.stopPropagation(),children:[e.jsxs("div",{style:a.menuPerfil,children:[e.jsx("img",{src:"/icon-192.png",alt:"DF Gestão Financeira",style:a.menuPerfilIcone}),e.jsxs("div",{children:[e.jsx("strong",{children:ie}),e.jsx("small",{children:d(l||"usuário")})]})]}),z&&e.jsxs("div",{className:"mobile-company-switcher",style:{margin:"12px 0 18px",padding:"12px 14px",border:"1px solid rgba(20, 184, 166, 0.22)",borderRadius:18,background:"rgba(240, 253, 250, 0.9)",display:"grid",gap:8},children:[e.jsx("span",{style:{fontSize:11,fontWeight:900,color:"#0f766e",textTransform:"uppercase",letterSpacing:".08em"},children:"Empresa ativa"}),k.length>1?e.jsx("select",{value:S||"",disabled:T,onChange:q=>{g==null||g(q.target.value),o(!1)},"aria-label":"Empresa ativa",style:{width:"100%",border:"0",background:"transparent",color:"#111827",fontWeight:900,fontSize:15,outline:"none"},children:k.map(q=>e.jsx("option",{value:q.id,children:q.nome||q.id},q.id))}):e.jsx("strong",{style:{color:"#111827",fontSize:15},children:(H==null?void 0:H.nome)||"Empresa ativa"})]}),e.jsxs("button",{type:"button",style:a.menuNavItem,onClick:()=>{o(!1),P==null||P()},children:[e.jsx("span",{children:"👤"}),e.jsxs("div",{children:[e.jsx("strong",{children:"Meu perfil"}),e.jsx("small",{children:"Editar nome do usuário"})]})]}),m.map((q,ne)=>e.jsxs("details",{className:"mobile-menu-group",open:ne===0,children:[e.jsx("summary",{children:q.titulo}),q.items.map(G=>V(G.icon,G.label,G.desc,()=>f(G.tela))),q.id==="sistema"&&e.jsxs("button",{type:"button",style:a.menuSairItem,onClick:b,children:[e.jsx("span",{children:"🚪"}),e.jsxs("div",{children:[e.jsx("strong",{children:"Sair"}),e.jsx("small",{children:"Encerrar sessão"})]})]})]},q.id))]})})}function Ml({styles:t,editandoContaId:a,descricao:o,setDescricao:i,valor:n,setValor:d,dataVencimento:l,setDataVencimento:m,centroCustoId:f,setCentroCustoId:b,centros:_,filialId:k,setFilialId:S,filiais:g,observacaoConta:T,setObservacaoConta:P,contaRecorrente:z,setContaRecorrente:H,tipoRecorrencia:ie,setTipoRecorrencia:V,diaVencimentoRecorrencia:q,setDiaVencimentoRecorrencia:ne,fecharConta:G,salvarConta:ae,primeiraLetraMaiuscula:I,limitarDataInput:M,formatarDataParaBanco:Y,fecharNota:je,setModalCentro:ce,setMenuAberto:he,setMenuNavegacaoAberto:Ce}){function oe(){G(),je(),ce(!1),he(!1),Ce(!1)}return e.jsx("div",{style:t.overlay,onClick:oe,children:e.jsxs("div",{style:t.modal,onClick:y=>y.stopPropagation(),children:[e.jsx("h3",{children:a?"Editar Conta":"Nova Conta"}),e.jsx("input",{style:t.inputModal,placeholder:"Descrição",value:o,onChange:y=>i(I(y.target.value))}),e.jsx("input",{style:t.inputModal,placeholder:"Valor. Ex: 150,90",value:n,onChange:y=>d(y.target.value)}),e.jsx("input",{style:t.inputModal,type:"date",value:l,onChange:y=>m(M(y.target.value))}),e.jsxs("select",{style:t.inputModal,value:k,onChange:y=>S(y.target.value),children:[e.jsx("option",{value:"",children:"Filial / unidade"}),(g||[]).map(y=>e.jsx("option",{value:y.id,children:y.nome},y.id))]}),e.jsxs("select",{style:t.inputModal,value:f,onChange:y=>b(y.target.value),children:[e.jsx("option",{value:"",children:"Centro de custo"}),_.map(y=>e.jsx("option",{value:y.id,children:y.nome},y.id))]}),e.jsx("textarea",{style:t.textareaModal,placeholder:"Observação ou comentário da conta...",value:T,onChange:y=>P(I(y.target.value))}),e.jsxs("div",{className:"recurrence-box",style:t.blocoRecorrenciaConta,children:[e.jsxs("label",{className:"checkbox-row-fix",style:t.switchLinhaCompacta,children:[e.jsxs("span",{children:[e.jsx("strong",{children:"🔁 Conta recorrente"}),e.jsx("small",{style:t.textoAjuda,children:"Ideal para aluguel, internet, sistema, mensalidades e contas fixas."})]}),e.jsx("input",{type:"checkbox",checked:z,onChange:y=>{const pe=y.target.checked;H(pe),pe&&l&&ne(String(Number(Y(l).slice(8,10))))}})]}),z&&e.jsxs("div",{className:"recurrence-fields",children:[e.jsx("select",{style:t.inputModal,value:ie,onChange:y=>V(y.target.value),children:e.jsx("option",{value:"mensal",children:"Mensal"})}),e.jsx("input",{style:t.inputModal,type:"number",min:"1",max:"31",placeholder:"Dia de vencimento mensal. Ex: 5",value:q||(l?String(Number(Y(l).slice(8,10))):""),onChange:y=>ne(y.target.value)}),e.jsx("small",{style:t.textoAjuda,children:"O sistema criará automaticamente essa conta no mês vigente quando ela ainda não existir."})]})]}),e.jsx("button",{style:t.btnSalvar,type:"button",onClick:y=>{y.preventDefault(),y.stopPropagation(),ae()},children:"Salvar"}),e.jsx("button",{style:t.btnCancelar,type:"button",onClick:G,children:"Cancelar"})]})})}function Tl({styles:t,editandoNotaId:a,tituloNota:o,setTituloNota:i,prioridadeNota:n,setPrioridadeNota:d,dataEventoNota:l,setDataEventoNota:m,conteudoNota:f,setConteudoNota:b,filialNotaId:_,setFilialNotaId:k,filiais:S,salvarNota:g,fecharNota:T,fecharConta:P,setModalCentro:z,setMenuAberto:H,setMenuNavegacaoAberto:ie,primeiraLetraMaiuscula:V,limitarDataInput:q}){function ne(){P(),T(),z(!1),H(!1),ie(!1)}return e.jsx("div",{style:t.overlay,onClick:ne,children:e.jsxs("div",{style:t.modal,onClick:G=>G.stopPropagation(),children:[e.jsx("h3",{children:a?"Editar Nota":"Nova Nota"}),e.jsx("input",{style:t.inputModal,placeholder:"Título",value:o,onChange:G=>i(V(G.target.value))}),e.jsxs("select",{style:t.inputModal,value:n,onChange:G=>d(G.target.value),children:[e.jsx("option",{value:"normal",children:"Prioridade normal"}),e.jsx("option",{value:"urgente",children:"Urgente"}),e.jsx("option",{value:"critico",children:"Crítico"})]}),e.jsxs("select",{style:t.inputModal,value:_,onChange:G=>k(G.target.value),children:[e.jsx("option",{value:"",children:"Todas as filiais"}),(S||[]).map(G=>e.jsx("option",{value:G.id,children:G.nome},G.id))]}),e.jsx("input",{style:t.inputModal,type:"date",value:l,onChange:G=>m(q(G.target.value))}),e.jsx("textarea",{style:t.textareaModal,placeholder:"Conteúdo...",value:f,onChange:G=>b(G.target.value)}),e.jsx("button",{style:t.btnSalvar,onClick:g,children:"Salvar"}),e.jsx("button",{style:t.btnCancelar,onClick:T,children:"Cancelar"})]})})}function Dl({styles:t,novoCentro:a,setNovoCentro:o,salvarCentro:i,centros:n,abrirConfirmacao:d,excluirCentro:l,fecharConta:m,fecharNota:f,setModalCentro:b,setMenuAberto:_,setMenuNavegacaoAberto:k}){function S(){m(),f(),b(!1),_(!1),k(!1)}return e.jsx("div",{style:t.overlay,onClick:S,children:e.jsxs("div",{style:t.modal,onClick:g=>g.stopPropagation(),children:[e.jsx("h3",{children:"Centros de Custo"}),e.jsx("input",{style:t.inputModal,placeholder:"Novo centro",value:a,onChange:g=>o(g.target.value),autoFocus:!0}),e.jsx("button",{style:t.btnSalvar,onClick:i,children:"Salvar Centro"}),n.map(g=>e.jsxs("div",{style:t.itemCentro,children:[e.jsx("span",{children:g.nome}),e.jsx("button",{style:t.btnMiniExcluir,onClick:()=>d({titulo:"Excluir centro de custo",mensagem:`Deseja excluir o centro ${g.nome}?`,textoConfirmar:"Excluir",tipo:"perigo",acao:()=>l(g.id)}),children:"excluir"})]},g.id)),e.jsx("button",{style:t.btnCancelar,onClick:()=>b(!1),children:"Fechar"})]})})}function Il({styles:t,confirmacao:a,fecharConfirmacao:o,executarConfirmacao:i}){return a!=null&&a.aberto?e.jsx("div",{style:t.overlayConfirmacao,children:e.jsxs("div",{style:t.modalConfirmacao,children:[e.jsx("div",{style:t.confirmacaoIcone,children:a.tipo==="perigo"?"⚠️":a.tipo==="sucesso"?"✅":"ℹ️"}),e.jsx("h3",{style:t.confirmacaoTitulo,children:a.titulo}),e.jsx("p",{style:t.confirmacaoTexto,children:a.mensagem}),e.jsxs("div",{style:t.confirmacaoAcoes,children:[e.jsx("button",{style:t.btnConfirmarCancelar,onClick:o,children:"Cancelar"}),e.jsx("button",{style:{...t.btnConfirmarAcao,background:a.tipo==="perigo"?"#dc3545":a.tipo==="sucesso"?"#14b8a6":"#0d6efd"},onClick:i,children:a.textoConfirmar})]})]})}):null}function Al({nome:t,setNome:a,email:o,salvando:i,onClose:n,onSave:d}){return e.jsx("div",{className:"profile-modal-backdrop",role:"presentation",onClick:n,children:e.jsxs("div",{className:"profile-modal-card",role:"dialog","aria-modal":"true","aria-label":"Meu perfil",onClick:l=>l.stopPropagation(),children:[e.jsxs("div",{className:"profile-modal-header",children:[e.jsxs("div",{children:[e.jsx("span",{children:"Perfil"}),e.jsx("h2",{children:"Meu perfil"})]}),e.jsx("button",{type:"button",onClick:n,"aria-label":"Fechar",children:"×"})]}),e.jsxs("label",{className:"profile-modal-field",children:[e.jsx("span",{children:"Nome de exibição"}),e.jsx("input",{value:t,onChange:l=>a(l.target.value),placeholder:"Digite seu nome",autoFocus:!0,maxLength:80})]}),e.jsxs("label",{className:"profile-modal-field",children:[e.jsx("span",{children:"E-mail"}),e.jsx("input",{value:o||"",readOnly:!0})]}),e.jsxs("div",{className:"profile-modal-actions",children:[e.jsx("button",{type:"button",className:"profile-modal-cancel",onClick:n,disabled:i,children:"Cancelar"}),e.jsx("button",{type:"button",className:"profile-modal-save",onClick:d,disabled:i,children:i?"Salvando...":"Salvar perfil"})]})]})})}function di({visible:t,message:a="Carregando..."}){return t?e.jsx("div",{className:"global-loader-overlay",role:"status","aria-live":"polite",children:e.jsxs("div",{className:"global-loader-card",children:[e.jsx("div",{className:"global-loader-spinner"}),e.jsx("span",{children:a})]})}):null}function qo({toast:t,onClose:a}){if(!t)return null;const o=t.type||"info";return e.jsxs("div",{className:`app-toast app-toast-${o} app-toast-global`,role:o==="erro"?"alert":"status","aria-live":o==="erro"?"assertive":"polite",onClick:a,children:[e.jsx("div",{className:`app-toast-icon app-toast-icon-${o}`,children:o==="erro"?"!":o==="sucesso"?"✓":o==="alerta"?"!":"i"}),e.jsxs("div",{className:"app-toast-content",children:[e.jsx("strong",{children:t.title||(o==="erro"?"Atenção":"Aviso")}),e.jsx("span",{children:t.message})]}),e.jsx("button",{type:"button",className:"app-toast-close","aria-label":"Fechar aviso",onClick:i=>{i.stopPropagation(),a==null||a()},children:"×"})]})}const Ii=c.createContext(null);function ci({children:t,contas:a=[],contasFiltradas:o=[],navegarPara:i}){const[n,d]=c.useState(!1),[l,m]=c.useState(""),f=c.useMemo(()=>Ei({contas:a,contasFiltradas:o}),[a,o]),b=c.useMemo(()=>({open:n,setOpen:d,toggle:()=>d(_=>!_),close:()=>d(!1),intelligence:f,lastQuestion:l,setLastQuestion:m,navegarPara:i}),[n,f,l,i]);return e.jsx(Ii.Provider,{value:b,children:t})}function Dt(){const t=c.useContext(Ii);if(!t)throw new Error("useCopilot deve ser usado dentro de CopilotProvider");return t}function pi(){const{open:t,toggle:a,intelligence:o}=Dt(),i=o.totals.vencido>0;return t?null:e.jsxs("button",{className:`copilot-floating-button no-print ${i?"has-risk":""}`,type:"button",onClick:n=>{n.preventDefault(),n.stopPropagation(),a()},"aria-label":"Abrir Copilot IA",children:[e.jsx("span",{children:"✨"}),e.jsx("strong",{children:"Copilot IA"}),i&&e.jsx("i",{})]})}function po(t){return Number(t||0).toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}function Bl(){const{intelligence:t}=Dt(),{score:a,status:o,executiveSummary:i,totals:n}=t;return e.jsxs("section",{className:`copilot-card copilot-score-${o.tone}`,children:[e.jsxs("div",{className:"copilot-card-head",children:[e.jsx("span",{children:"Executive AI Summary"}),e.jsxs("strong",{children:[a,"/100"]})]}),e.jsx("p",{children:i}),e.jsxs("div",{className:"copilot-metrics",children:[e.jsxs("div",{children:[e.jsx("small",{children:"Total"}),e.jsx("b",{children:po(n.total)})]}),e.jsxs("div",{children:[e.jsx("small",{children:"Pendente"}),e.jsx("b",{children:po(n.pendente)})]}),e.jsxs("div",{children:[e.jsx("small",{children:"Vencido"}),e.jsx("b",{children:po(n.vencido)})]})]})]})}function ql(){const{intelligence:t,navegarPara:a,close:o}=Dt();return e.jsxs("section",{className:"copilot-card",children:[e.jsxs("div",{className:"copilot-card-head",children:[e.jsx("span",{children:"Smart Priority Engine"}),e.jsx("strong",{children:t.priorities.length})]}),e.jsx("div",{className:"copilot-priority-list",children:t.priorities.map((i,n)=>e.jsxs("article",{className:`copilot-priority copilot-priority-${i.tone}`,children:[e.jsxs("div",{children:[e.jsxs("small",{children:[i.level," impacto · ",i.impact]}),e.jsx("strong",{children:i.title}),e.jsx("p",{children:i.description})]}),e.jsx("button",{type:"button",onClick:()=>{a==null||a(i.action.includes("Relatórios")?"relatorios":"contas"),o()},children:i.action})]},`${i.title}-${n}`))})]})}function Ll(){const{intelligence:t}=Dt();return e.jsxs("section",{className:"copilot-card",children:[e.jsxs("div",{className:"copilot-card-head",children:[e.jsx("span",{children:"Insights IA"}),e.jsx("strong",{children:"Live"})]}),e.jsx("div",{className:"copilot-insights",children:t.insights.map(a=>e.jsxs("p",{children:["✦ ",a]},a))})]})}function Ol(){const{intelligence:t}=Dt();return e.jsxs("section",{className:"copilot-card",children:[e.jsxs("div",{className:"copilot-card-head",children:[e.jsx("span",{children:"Recomendações acionáveis"}),e.jsx("strong",{children:t.recomendacoes.length})]}),e.jsx("div",{className:"copilot-recommendations",children:t.recomendacoes.map((a,o)=>e.jsxs("p",{children:[e.jsx("b",{children:o+1}),a]},`${a}-${o}`))})]})}function Ul(){const{intelligence:t}=Dt(),a=t.rankingCentros||[];return e.jsxs("section",{className:"copilot-card",children:[e.jsxs("div",{className:"copilot-card-head",children:[e.jsx("span",{children:"Drill-down analytics"}),e.jsxs("strong",{children:["Top ",a.length||0]})]}),e.jsx("div",{className:"copilot-drilldown",children:a.length?a.map(o=>e.jsxs("article",{children:[e.jsxs("div",{children:[e.jsx("strong",{children:o.nome}),e.jsxs("small",{children:[po(o.total)," · ",o.peso,"% do recorte · risco ",o.risco,"%"]})]}),e.jsx("span",{style:{width:`${Math.max(6,o.peso)}%`}})]},o.nome)):e.jsx("p",{children:"Sem centros suficientes para drill-down no recorte atual."})})]})}function Vl(){const{intelligence:t}=Dt(),a=t.narrativa||{},o=[["Liquidez",a.liquidez],["Concentração",a.concentracao],["Curto prazo",a.curtoPrazo],["Comportamento",a.comportamento]].filter(([,i])=>i);return e.jsxs("section",{className:"copilot-card copilot-narrative-card",children:[e.jsxs("div",{className:"copilot-card-head",children:[e.jsx("span",{children:"AI Narrative 11.8"}),e.jsx("strong",{children:"Contextual"})]}),e.jsx("p",{children:a.parecer||t.executiveSummary}),e.jsx("div",{className:"copilot-insights",children:o.map(([i,n])=>e.jsxs("p",{children:[e.jsxs("b",{children:[i,":"]})," ",n]},i))})]})}function Gl(){var o;const{intelligence:t}=Dt(),a=((o=t.narrativa)==null?void 0:o.anomalias)||[];return e.jsxs("section",{className:"copilot-card",children:[e.jsxs("div",{className:"copilot-card-head",children:[e.jsx("span",{children:"Anomalias contextuais"}),e.jsx("strong",{children:a.length})]}),e.jsx("div",{className:"copilot-insights",children:a.map((i,n)=>e.jsxs("p",{children:["⚠ ",i]},`${i}-${n}`))})]})}function Wl(){const{intelligence:t,setLastQuestion:a}=Dt();return e.jsxs("section",{className:"copilot-card copilot-questions-card",children:[e.jsx("span",{className:"copilot-mini-label",children:"Perguntas rápidas"}),e.jsx("div",{className:"copilot-questions",children:t.quickQuestions.map(o=>e.jsx("button",{type:"button",onClick:()=>a(o),children:o},o))})]})}function mi(){var n;const{open:t,close:a,intelligence:o,lastQuestion:i}=Dt();return t?e.jsxs("div",{className:"copilot-shell no-print",onClick:d=>d.stopPropagation(),children:[e.jsx("button",{className:"copilot-backdrop",type:"button","aria-label":"Fechar Copilot",onClick:a}),e.jsxs("aside",{className:"copilot-drawer","aria-label":"Painel Copilot IA",children:[e.jsxs("header",{className:"copilot-header",children:[e.jsxs("div",{children:[e.jsx("span",{children:"Copilot IA 11.8"}),e.jsx("h2",{children:"Sistema Operacional Financeiro Inteligente"}),e.jsxs("p",{children:["Status: ",o.status.label," · Score ",o.score,"/100"]}),e.jsxs("div",{className:"copilot-live-indicator",children:[e.jsx("b",{})," Analisando dados em tempo real"]})]}),e.jsx("button",{type:"button",onClick:a,"aria-label":"Fechar",children:"×"})]}),e.jsxs("main",{className:"copilot-content",children:[e.jsx(Bl,{}),e.jsx(Vl,{}),e.jsx(ql,{}),e.jsx(Gl,{}),e.jsx(Ul,{}),e.jsx(Ol,{}),e.jsx(Ll,{}),i&&e.jsxs("section",{className:"copilot-card copilot-answer",children:[e.jsx("span",{className:"copilot-mini-label",children:"Pergunta selecionada"}),e.jsx("strong",{children:i}),e.jsx("p",{children:((n=o.respostas)==null?void 0:n[i])||"Resposta executiva gerada a partir dos KPIs atuais."})]}),e.jsx(Wl,{})]})]})]}):null}function ui(){return e.jsx("style",{children:`
    ...
    `})}const Hl={semEmpresa:"Usuário sem empresa vinculada. Vincule este usuário em df_usuarios_empresas antes de continuar."};function Kl(t){var a,o;return t!=null&&t.empresa_id?{empresaId:t.empresa_id,perfil:Zt(t.perfil),nomeEmpresa:t.nome_empresa||((a=t.empresas)==null?void 0:a.nome)||((o=t.df_empresas)==null?void 0:o.nome)||"",origem:"df_usuarios_empresas"}:null}async function Yl(){const{error:t}=await D.rpc("vincular_usuario_logado");t&&console.warn("Não foi possível executar vínculo automático:",t.message)}async function Xl(t){if(!t)return null;const{data:a,error:o}=await D.from("df_usuarios_empresas").select("empresa_id, perfil").eq("user_id",t).limit(1);if(o)throw o;const i=Array.isArray(a)?a[0]:a;if(!(i!=null&&i.empresa_id))return null;let n="";const{data:d,error:l}=await D.from("df_empresas").select("nome").eq("id",i.empresa_id).limit(1);if(l)console.warn("Não foi possível carregar o nome da empresa ativa:",l.message);else{const m=Array.isArray(d)?d[0]:d;n=(m==null?void 0:m.nome)||""}return Kl({...i,nome_empresa:n})}async function fi(t){if(!t)return"";const{data:a,error:o}=await D.from("profiles").select("name").eq("id",t).limit(1);if(o)return console.warn("Não foi possível carregar o nome do perfil:",o.message),"";const i=Array.isArray(a)?a[0]:a;return(i==null?void 0:i.name)||""}function Ut(t){if(!t)throw new Error("Empresa não identificada para esta operação.");return t}function Ai(t){if(!(t!=null&&t.empresa_id))throw new Error("Operação bloqueada: empresa_id ausente no payload.");return t}function Ql(t){return!Array.isArray(t)||t.length===0||t.forEach(Ai),t}function ya(t,a,o,i="*"){return Ut(o),t.from(a).select(i).eq("empresa_id",o)}function Da(t,a,o,i={}){Ai(o);let n=t.from(a).insert([o]);return i.select&&(n=n.select(i.select===!0?"*":i.select)),n}function Jl(t,a,o,i={}){Ql(o);let n=t.from(a).insert(o);return i.select&&(n=n.select(i.select===!0?"*":i.select)),n}function Ia(t,a,o,i,n){return Ut(i),t.from(a).update(n).eq("id",o).eq("empresa_id",i)}function Zl(t,a,o,i){return Ut(i),t.from(a).delete().eq("id",o).eq("empresa_id",i)}async function ed(t,a){return Ut(a),ya(t,"df_contas",a,"*, df_centros_custo(nome), df_filiais(nome), df_contas_recorrentes(tipo_recorrencia)").eq("excluido",!1).order("data_vencimento")}async function td(t,a){return Ut(a),ya(t,"df_contas_recorrentes",a).eq("ativo",!0)}async function ad(t,a,o){if(!a)return null;Ut(o);const{data:i,error:n}=await t.from("df_centros_custo").select("id").eq("id",a).eq("empresa_id",o).maybeSingle();return n||!(i!=null&&i.id)?null:i.id}async function od(t,a,o){if(!a)return null;Ut(o);const{data:i,error:n}=await t.from("df_filiais").select("id").eq("id",a).eq("empresa_id",o).eq("ativo",!0).maybeSingle();return n||!(i!=null&&i.id)?null:i.id}async function rd(t,a){return Jl(t,"df_contas",a,{select:"*, df_centros_custo(nome), df_filiais(nome), df_contas_recorrentes(tipo_recorrencia)"})}async function id(t,a){return Da(t,"df_contas",a,{select:!0})}async function uo(t,a,o,i){return Ia(t,"df_contas",a,o,i)}async function nd(t,a,o){return Ut(o),ya(t,"df_contas_recorrentes",o).eq("id",a).maybeSingle()}async function sd(t,a,o){return Ut(a),ya(t,"df_contas_recorrentes",a).eq("ativo",!0).eq("dia_vencimento",o).order("created_at",{ascending:!1})}async function xi(t,a){const o=await Da(t,"df_contas_recorrentes",a,{select:!0});return qi(o.error,a)?Da(t,"df_contas_recorrentes",Li(a),{select:!0}):o}async function Bi(t,a,o,i){const n=await Ia(t,"df_contas_recorrentes",a,o,i);return qi(n.error,i)?Ia(t,"df_contas_recorrentes",a,o,Li(i)):n}async function $a(t,a,o,i){return uo(t,a,o,{recorrencia_id:i})}async function ld(t,a,o){return Bi(t,a,o,{ativo:!1})}async function hi(t,a,o,i){return uo(t,a,o,{status:i})}async function dd(t,a,o){return uo(t,a,o,{excluido:!0,excluido_em:new Date().toISOString()})}function qi(t,a){return!!(t&&a&&Object.prototype.hasOwnProperty.call(a,"filial_id")&&cd(t))}function cd(t){const a=String((t==null?void 0:t.message)||(t==null?void 0:t.details)||(t==null?void 0:t.hint)||"").toLowerCase();return a.includes("filial_id")&&(a.includes("schema cache")||a.includes("column")||a.includes("coluna"))}function Li(t){const{filial_id:a,...o}=t||{};return o}function pd(){const[t,a]=c.useState([]),[o,i]=c.useState([]),[n,d]=c.useState(""),[l,m]=c.useState("todas"),[f,b]=c.useState(""),[_,k]=c.useState(""),[S,g]=c.useState(""),[T,P]=c.useState(""),[z,H]=c.useState(""),[ie,V]=c.useState(!0),[q,ne]=c.useState(!1),[G,ae]=c.useState(null),[I,M]=c.useState(""),[Y,je]=c.useState(""),[ce,he]=c.useState(""),[Ce,oe]=c.useState(""),[y,pe]=c.useState(""),[A,Z]=c.useState(""),[K,Q]=c.useState(!1),[N,J]=c.useState(!1),[Me,_e]=c.useState(!1),[we,U]=c.useState("1"),[fe,Ae]=c.useState(!1),[C,be]=c.useState("mensal"),[ze,me]=c.useState(""),[$,re]=c.useState(null);function et(){ae(null),M(""),je(""),he(""),oe(""),pe(""),Z(""),Q(!1),J(!1),_e(!1),U("1"),Ae(!1),be("mensal"),me(""),re(null)}async function st(Se,X,L){return L?ad(Se,L,X):null}async function Oe(Se,X,L){return L?od(Se,L,X):null}async function It({supabase:Se,empresaAtual:X,contasAtuais:L,configWhatsapp:B,configEmail:ue,configPush:Pe,diasAlertaContas:We,diasAvisoPadrao:He}){const qe=new Date,Ke=qe.getFullYear(),Ge=qe.getMonth()+1,{data:ot,error:bt}=await td(Se,X);if(bt)return console.warn("Não foi possível carregar contas recorrentes:",bt.message),L;const Rt=[];for(const Qe of ot||[]){if(!Gs(Qe,Ke,Ge))continue;const mt=Vs(Ke,Ge,Qe.dia_vencimento);if(L.some(vt=>String(vt.descricao||"").trim().toLowerCase()===String(Qe.descricao||"").trim().toLowerCase()&&vt.data_vencimento===mt))continue;const qt=await st(Se,X,Qe.centro_custo_id),ut=await Oe(Se,X,Qe.filial_id);Rt.push({empresa_id:X,descricao:Qe.descricao,valor:Number(Qe.valor||0),data_vencimento:mt,vencimento:mt,centro_custo_id:qt,filial_id:ut,observacao:Qe.observacao||null,recorrencia_id:Qe.id,status:"pendente",excluido:!1,enviar_whatsapp:B,enviar_email:ue,enviar_push:Pe,dias_aviso:Number(We||He||1)})}if(Rt.length===0)return L;const{data:Gt,error:At}=await rd(Se,Rt);return At?(console.warn("Não foi possível gerar contas recorrentes:",At.message),L):[...L,...Gt||[]].sort((Qe,mt)=>String(Qe.data_vencimento||"").localeCompare(String(mt.data_vencimento||"")))}async function Ye(Se){const{supabase:X,empresaAtual:L,avisarErro:B,configWhatsapp:ue,configEmail:Pe,configPush:We,diasAlertaContas:He,diasAvisoPadrao:qe}=Se;if(!L)return;const{data:Ke,error:Ge}=await ed(X,L);if(Ge){B(Ge);return}const bt=await It({supabase:X,empresaAtual:L,contasAtuais:Ke||[],configWhatsapp:ue,configEmail:Pe,configPush:We,diasAlertaContas:He,diasAvisoPadrao:qe});a(bt)}function lt(Se){const{setMenuAberto:X,setMenuNavegacaoAberto:L,configWhatsapp:B,configEmail:ue,configPush:Pe,diasAvisoPadrao:We}=Se;X(!1),L(!1),et(),Q(B),J(ue),_e(Pe),U(String(We||1)),ne(!0)}async function Be({supabase:Se,empresaId:X,conta:L,dataBanco:B,descricaoConta:ue}){if(!Se||!X||!L)return null;if(L.recorrencia_id){const{data:Ge,error:ot}=await nd(Se,L.recorrencia_id,X);if(!ot&&Ge)return Ge}const Pe=Number(String(B||L.data_vencimento||"").slice(8,10));if(!Pe)return null;const{data:We,error:He}=await sd(Se,X,Pe);if(He||!Array.isArray(We))return null;const qe=String(ue||L.descricao||"").trim().toLowerCase(),Ke=Number(L.valor||0);return We.find(Ge=>{const ot=String(Ge.descricao||"").trim().toLowerCase()===qe,bt=Number(Ge.valor||0)===Ke;return ot&&bt})||null}async function pt(Se){const{conta:X,supabase:L,empresaId:B,diasAvisoPadrao:ue,formatarDataParaBanco:Pe}=Se,We=Pe(X.data_vencimento||""),He=We?String(Number(String(We).slice(8,10))):"";ae(X.id),M(X.descricao||""),je(X.valor||""),he(X.data_vencimento||""),oe(X.centro_custo_id||""),pe(X.filial_id||""),Z(X.observacao||""),Q(X.enviar_whatsapp??!1),J(X.enviar_email??!1),_e(X.enviar_push??!1),U(String(X.dias_aviso??ue??1)),Ae(!!X.recorrencia_id),re(X.recorrencia_id||null),be("mensal"),me(He),ne(!0);const qe=await Be({supabase:L,empresaId:B,conta:X,dataBanco:We,descricaoConta:X.descricao});qe&&(Ae(!0),re(qe.id),be(qe.frequencia||qe.tipo_recorrencia||"mensal"),me(String(qe.dia_vencimento||He||"")),!X.recorrencia_id&&qe.id&&await $a(L,X.id,B,qe.id))}function _t(){ne(!1),et()}async function Xe(Se){const{supabase:X,empresaId:L,mostrarAviso:B,configWhatsapp:ue,configEmail:Pe,configPush:We,diasAlertaContas:He,diasAvisoPadrao:qe,primeiraLetraMaiuscula:Ke,converterValor:Ge,formatarDataParaBanco:ot,erroEhSessaoExpirada:bt,limparEstadoAutenticacao:Rt,setUsuarioLogado:Gt,buscarContas:At,fecharConta:Qe}=Se;if(!L){B("Usuário sem empresa vinculada.","erro");return}if(!I||!Y||!ce){B("Preencha descrição, valor e vencimento.","erro");return}const mt=await st(X,L,Ce),Bt=await Oe(X,L,y),qt={descricao:Ke(I.trim()),valor:Ge(Y),data_vencimento:ot(ce),vencimento:ot(ce),centro_custo_id:mt,filial_id:Bt,observacao:A.trim()||null,enviar_whatsapp:K,enviar_email:N,enviar_push:Me,dias_aviso:Number(we||He||qe||1),empresa_id:L};let ut;if(G){if(ut=(await uo(X,G,L,qt)).error,!ut){const jt=ot(ce),s=Number(ze||String(jt).slice(8,10));if(fe){if(!s||s<1||s>31){B("Informe um dia válido para a recorrência.","erro");return}const v={empresa_id:L,descricao:Ke(I.trim()),valor:Ge(Y),centro_custo_id:mt,filial_id:Bt,tipo_recorrencia:C||"mensal",dia_vencimento:s,data_inicio:jt,ativo:!0};if($){const{error:O}=await Bi(X,$,L,v);if(O){B("A conta foi atualizada, mas a recorrência não foi salva: "+O.message,"erro");return}const{error:se}=await $a(X,G,L,$);if(se){B("A recorrência foi atualizada, mas não foi vinculada à conta: "+se.message,"erro");return}}else{const{data:O,error:se}=await xi(X,v);if(se){B("A conta foi atualizada, mas a recorrência não foi salva: "+se.message,"erro");return}const ye=Array.isArray(O)?O[0]:O;let ve=ye==null?void 0:ye.id;if(!ve){const Re=await Be({supabase:X,empresaId:L,conta:{descricao:Ke(I.trim()),valor:Ge(Y),data_vencimento:jt},dataBanco:jt,descricaoConta:Ke(I.trim())});ve=Re==null?void 0:Re.id}if(!ve){B("A recorrência foi criada, mas o sistema não conseguiu localizar o vínculo.","erro");return}const{error:ge}=await $a(X,G,L,ve);if(ge){B("A recorrência foi criada, mas não foi vinculada à conta: "+ge.message,"erro");return}re(ve),a(Re=>Re.map(le=>le.id===G?{...le,recorrencia_id:ve}:le))}}else $&&(await ld(X,$,L),await $a(X,G,L,null))}}else{const vt=await id(X,{...qt,status:"pendente",excluido:!1});if(ut=vt.error,!ut&&fe){const jt=ot(ce),s=Number(ze||String(jt).slice(8,10));if(!s||s<1||s>31){B("Informe um dia válido para a recorrência.","erro");return}const{data:v,error:O}=await xi(X,{empresa_id:L,descricao:Ke(I.trim()),valor:Ge(Y),centro_custo_id:mt,filial_id:Bt,tipo_recorrencia:C||"mensal",dia_vencimento:s,data_inicio:jt,ativo:!0});if(O)B("A conta foi criada, mas a recorrência não foi salva: "+O.message,"erro");else{const se=Array.isArray(v)?v[0]:v,ye=Array.isArray(vt.data)?vt.data[0]:vt.data;let ve=se==null?void 0:se.id;if(!ve&&(ye!=null&&ye.id)){const ge=await Be({supabase:X,empresaId:L,conta:ye,dataBanco:jt,descricaoConta:Ke(I.trim())});ve=ge==null?void 0:ge.id}if(ve&&(ye!=null&&ye.id)){const{error:ge}=await $a(X,ye.id,L,ve);if(ge){B("A recorrência foi criada, mas não foi vinculada à conta: "+ge.message,"erro");return}}}}}if(ut){bt(ut)?(await X.auth.signOut(),Rt(),Gt(null),B("Sua sessão expirou. Faça login novamente.","erro")):B(ut.message,"erro");return}Qe(),await At(),B(G?"Conta atualizada com sucesso.":"Conta criada com sucesso.","sucesso")}async function Vt(Se){const{supabase:X,id:L,empresaId:B,buscarContas:ue,mostrarAviso:Pe}=Se;await hi(X,L,B,"pago"),await ue(),Pe==null||Pe("Conta marcada como paga.","sucesso")}async function gt(Se){const{supabase:X,id:L,empresaId:B,buscarContas:ue,mostrarAviso:Pe}=Se;await hi(X,L,B,"pendente"),await ue(),Pe==null||Pe("Conta voltou para pendente.","sucesso")}async function ea(Se){const{supabase:X,id:L,empresaId:B,avisarErro:ue,buscarContas:Pe,buscarLixeira:We,mostrarAviso:He}=Se,{error:qe}=await dd(X,L,B);if(qe){ue(qe);return}await Promise.all([Pe(),We()]),He==null||He("Conta enviada para a lixeira.","sucesso")}return{contas:t,setContas:a,contasLixeira:o,setContasLixeira:i,busca:n,setBusca:d,filtroStatus:l,setFiltroStatus:m,filtroCentro:f,setFiltroCentro:b,filtroFilial:_,setFiltroFilial:k,filtroMes:S,setFiltroMes:g,dataInicial:T,setDataInicial:P,dataFinal:z,setDataFinal:H,loading:ie,setLoading:V,modalConta:q,setModalConta:ne,editandoContaId:G,setEditandoContaId:ae,descricao:I,setDescricao:M,valor:Y,setValor:je,dataVencimento:ce,setDataVencimento:he,centroCustoId:Ce,setCentroCustoId:oe,filialId:y,setFilialId:pe,observacaoConta:A,setObservacaoConta:Z,contaWhatsapp:K,setContaWhatsapp:Q,contaEmail:N,setContaEmail:J,contaPush:Me,setContaPush:_e,contaDiasAviso:we,setContaDiasAviso:U,contaRecorrente:fe,setContaRecorrente:Ae,tipoRecorrencia:C,setTipoRecorrencia:be,diaVencimentoRecorrencia:ze,setDiaVencimentoRecorrencia:me,recorrenciaContaId:$,setRecorrenciaContaId:re,buscarContas:Ye,abrirNovaConta:lt,abrirEdicaoConta:pt,fecharConta:_t,salvarConta:Xe,marcarComoPago:Vt,voltarParaPendente:gt,excluirConta:ea}}async function md(t,a){return ya(t,"df_notas",a).eq("excluido",!1).order("created_at",{ascending:!1})}async function ud(t,a){return ya(t,"df_notas",a).eq("excluido",!0).order("excluido_em",{ascending:!1})}async function fd(t,a){const o=await Da(t,"df_notas",a);return Oi(o.error,a)?Da(t,"df_notas",Ui(a)):o}async function fo(t,a,o,i){const n=await Ia(t,"df_notas",a,o,i);return Oi(n.error,i)?Ia(t,"df_notas",a,o,Ui(i)):n}async function xd(t,a,o){return fo(t,a,o,{excluido:!0,excluido_em:new Date().toISOString()})}async function hd(t,a,o){return fo(t,a.id,o,{concluida:!a.concluida})}async function gd(t,a,o){return fo(t,a,o,{excluido:!1,excluido_em:null})}async function bd(t,a,o){return Zl(t,"df_notas",a,o)}function Oi(t,a){return!!(t&&a&&Object.prototype.hasOwnProperty.call(a,"filial_id")&&vd(t))}function vd(t){const a=String((t==null?void 0:t.message)||(t==null?void 0:t.details)||(t==null?void 0:t.hint)||"").toLowerCase();return a.includes("filial_id")&&(a.includes("schema cache")||a.includes("column")||a.includes("coluna"))}function Ui(t){const{filial_id:a,...o}=t||{};return o}function gi(t=[]){return t.map(a=>`${a.id||""}:${a.excluido_em||""}:${a.updated_at||""}:${a.titulo||""}`).join("|")}function jd(t,a=[]){t((o=[])=>gi(o)===gi(a)?o:a)}function yd(){const[t,a]=c.useState([]),[o,i]=c.useState([]),[n,d]=c.useState(""),[l,m]=c.useState(!1),[f,b]=c.useState(null),[_,k]=c.useState(""),[S,g]=c.useState(""),[T,P]=c.useState("normal"),[z,H]=c.useState(""),[ie,V]=c.useState("");function q(){b(null),k(""),g(""),P("normal"),H(""),V("")}async function ne({supabase:oe,empresaAtual:y,avisarErro:pe}){if(!y)return;const{data:A,error:Z}=await md(oe,y);if(Z){pe(Z);return}a(A||[])}async function G({supabase:oe,empresaAtual:y,avisarErro:pe}){if(!y)return;const{data:A,error:Z}=await ud(oe,y);if(Z){pe(Z);return}jd(i,A||[])}function ae({setMenuAberto:oe,setMenuNavegacaoAberto:y}){oe(!1),y(!1),q(),m(!0)}function I(oe){b(oe.id),k(oe.titulo||""),g(oe.conteudo||""),P(oe.prioridade||"normal"),H(oe.data_evento||""),V(oe.filial_id||""),m(!0)}function M(){m(!1),q()}async function Y({supabase:oe,empresaId:y,mostrarAviso:pe,avisarErro:A,buscarNotas:Z}){if(!y){pe("Usuário sem empresa vinculada.","erro");return}if(!_.trim()){pe("Digite o título da nota.","erro");return}const K={titulo:kt(_.trim()),conteudo:S.trim(),prioridade:T||"normal",data_evento:z||null,concluida:!1,empresa_id:y,filial_id:ie||null};let Q;if(f?Q=(await fo(oe,f,y,K)).error:Q=(await fd(oe,K)).error,Q){A(Q);return}M(),await Z(),pe(f?"Nota atualizada com sucesso.":"Nota criada com sucesso.","sucesso")}async function je({supabase:oe,id:y,empresaId:pe,avisarErro:A,buscarNotas:Z,buscarLixeira:K,mostrarAviso:Q}){const{error:N}=await xd(oe,y,pe);if(N){A(N);return}await Promise.all([Z(),K()]),Q==null||Q("Nota enviada para a lixeira.","sucesso")}async function ce({supabase:oe,nota:y,empresaId:pe,avisarErro:A,buscarNotas:Z,mostrarAviso:K}){const{error:Q}=await hd(oe,y,pe);if(Q){A(Q);return}await Z(),K==null||K(y.concluida?"Nota reaberta.":"Nota concluída.","sucesso")}async function he({supabase:oe,id:y,empresaId:pe,avisarErro:A,buscarNotas:Z,buscarLixeira:K,mostrarAviso:Q}){const{error:N}=await gd(oe,y,pe);if(N){A(N);return}await Promise.all([Z(),K()]),Q==null||Q("Nota restaurada com sucesso.","sucesso")}async function Ce({supabase:oe,nota:y,empresaId:pe,avisarErro:A,buscarLixeira:Z,mostrarAviso:K}){const{error:Q}=await bd(oe,y.id,pe);if(Q){A(Q);return}await Z(),K==null||K("Nota excluída definitivamente.","sucesso")}return{notas:t,setNotas:a,notasLixeira:o,setNotasLixeira:i,buscaNota:n,setBuscaNota:d,modalNota:l,setModalNota:m,editandoNotaId:f,setEditandoNotaId:b,tituloNota:_,setTituloNota:k,conteudoNota:S,setConteudoNota:g,prioridadeNota:T,setPrioridadeNota:P,dataEventoNota:z,setDataEventoNota:H,filialNotaId:ie,setFilialNotaId:V,buscarNotas:ne,buscarNotasLixeira:G,abrirNovaNota:ae,abrirEdicaoNota:I,fecharNota:M,salvarNota:Y,excluirNota:je,alternarNotaConcluida:ce,restaurarNota:he,excluirNotaDefinitivo:Ce}}const mo={MASTER:"master",ADMIN:"admin",GERENTE:"gerente",OPERADOR:"operador"},wd=new Set(["donafloradm@outlook.com"]);function Go(t){return String(t||"").trim().toLowerCase()}function kd(t){const a=String(t).toLowerCase().trim();return["master","super_admin","superadmin","owner","dono"].includes(a)?mo.MASTER:["admin","adm","administrador"].includes(a)?mo.ADMIN:Zt(a)}function Cd(t){return!(!t||t.ativo===!1||t.status&&String(t.status).toLowerCase()!=="ativo")}function Ma({perfilEmpresa:t="operador",master:a=null}={}){const o=Zt(t),i=a!=null&&a.isMaster?mo.MASTER:o;return{perfilEmpresa:o,perfilGlobal:i,isMaster:!!(a!=null&&a.isMaster),canManageUsers:!!(a!=null&&a.isMaster||o==="admin"),canAccessSettings:!!(a!=null&&a.isMaster||["admin","gerente"].includes(o)),canManageCompanies:!!(a!=null&&a.isMaster),canSwitchCompany:!!(a!=null&&a.isMaster)}}async function Lo({userId:t,email:a,perfilEmpresa:o="operador"}={}){const i=Go(a),n=Ma({perfilEmpresa:o});if(wd.has(i))return Ma({perfilEmpresa:o,master:{isMaster:!0}});if(!t&&!i)return n;try{const{data:d,error:l}=await D.from("df_usuarios_master").select("*").limit(100);if(l)return console.warn("Não foi possível consultar df_usuarios_master:",l.message),n;const m=(d||[]).find(f=>{const b=t&&f.user_id&&f.user_id===t,_=i&&Go(f.email)===i;return(b||_)&&Cd(f)});return m?Ma({perfilEmpresa:o,master:{isMaster:!0,perfil:kd(m.perfil||m.tipo||mo.MASTER)}}):n}catch(d){return console.warn("Falha ao carregar permissões globais:",d.message),n}}async function Nd({isMaster:t}={}){if(!t)return[];const{data:a,error:o}=await D.from("df_empresas").select("id, nome, created_at").order("nome",{ascending:!0});if(o)throw o;return a||[]}async function bi({userId:t,email:a,isMaster:o}={}){if(o)return Nd({isMaster:o});const i=Go(a);if(!t&&!i)return[];let n=D.from("df_usuarios_empresas").select("empresa_id, perfil, nome, email, user_id");t&&i?n=n.or(`user_id.eq.${t},email.eq.${i}`):t?n=n.eq("user_id",t):n=n.eq("email",i);const{data:d,error:l}=await n;if(l)throw l;const m=new Map;(d||[]).forEach(k=>{if(!(k!=null&&k.empresa_id))return;const S=Zt(k.perfil),g=m.get(k.empresa_id);m.set(k.empresa_id,{id:k.empresa_id,nome:(g==null?void 0:g.nome)||"",perfil:(g==null?void 0:g.perfil)==="admin"?g.perfil:S})});const f=Array.from(m.keys());if(f.length===0)return[];const{data:b,error:_}=await D.from("df_empresas").select("id, nome, created_at").in("id",f).order("nome",{ascending:!0});if(_)throw _;return(b||[]).forEach(k=>{const S=m.get(k.id);S&&m.set(k.id,{...S,nome:k.nome||S.nome||"Empresa",created_at:k.created_at})}),Array.from(m.values()).sort((k,S)=>String(k.nome||"").localeCompare(String(S.nome||"")))}const x={usuarioTopo:{background:"linear-gradient(135deg, #ffffff 0%, #f0fdfa 100%)",border:"1px solid #d8eee9",borderRadius:18,padding:12,marginBottom:16,display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,boxShadow:"0 10px 24px rgba(15,118,110,0.10)",position:"relative",zIndex:20},logoMarca:{display:"flex",alignItems:"center",gap:10,background:"transparent",border:"none",padding:0,textAlign:"left",color:"#064e3b"},logoIcone:{width:42,height:42,borderRadius:14,background:"#e8f5ee",display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,boxShadow:"inset 0 0 0 1px #cfe8da"},logoImagem:{width:48,height:48,borderRadius:16,objectFit:"cover",background:"#0f766e",boxShadow:"0 8px 18px rgba(20,184,166,0.28)"},logoTexto:{display:"flex",flexDirection:"column",gap:2,lineHeight:1.05},usuarioAcoes:{display:"flex",alignItems:"center",gap:8},usuarioTexto:{display:"flex",flexDirection:"column",alignItems:"flex-end",fontSize:13,color:"#1f2937"},btnMenuTopo:{width:44,height:44,borderRadius:14,border:"1px solid #e5e7eb",background:"#ffffff",color:"#0f172a",fontSize:22,fontWeight:"bold",display:"inline-flex",alignItems:"center",justifyContent:"center",boxShadow:"0 6px 16px rgba(15,23,42,0.08)"},menuBackdrop:{position:"fixed",inset:0,background:"rgba(15, 23, 42, 0.22)",zIndex:4e3,display:"flex",justifyContent:"flex-end",alignItems:"flex-start",padding:"76px 12px 12px 12px"},menuNavegacao:{width:"min(360px, 94vw)",height:"auto",maxHeight:"calc(100dvh - 96px)",overflowY:"auto",WebkitOverflowScrolling:"touch",overscrollBehavior:"contain",touchAction:"pan-y",background:"#ffffff",border:"1px solid #d8eee9",borderRadius:22,padding:14,display:"grid",gap:8,boxShadow:"0 24px 60px rgba(15,23,42,0.25)"},menuPerfil:{display:"flex",alignItems:"center",gap:12,padding:12,borderRadius:18,background:"linear-gradient(135deg, #ecfdf5, #f0fdfa)",color:"#064e3b",marginBottom:4},menuPerfilIcone:{width:46,height:46,borderRadius:16,objectFit:"cover",background:"#0f766e"},menuSecaoTitulo:{fontSize:11,textTransform:"uppercase",letterSpacing:1,fontWeight:800,color:"#6b7280",padding:"10px 8px 2px"},menuNavItem:{width:"100%",display:"flex",alignItems:"center",gap:12,textAlign:"left",background:"#f8faf9",border:"1px solid #edf1ef",borderRadius:16,padding:"12px 14px",fontSize:15,color:"#064e3b"},menuSairItem:{width:"100%",display:"flex",alignItems:"center",gap:12,textAlign:"left",background:"#fff1f2",border:"1px solid #fecdd3",borderRadius:16,padding:"12px 14px",fontSize:15,color:"#be123c",fontWeight:700},agendaResumoCard:{background:"#ffffff",border:"1px solid #dfe7e2",borderLeft:"5px solid #14b8a6",padding:14,borderRadius:16,marginBottom:12,boxShadow:"0 2px 10px rgba(0,0,0,0.06)",display:"grid",gap:10},agendaResumoGrid:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6,fontSize:12,color:"#374151"},btnAgendaCompleta:{border:"none",borderRadius:10,background:"#14b8a6",color:"#fff",padding:"10px 12px",fontWeight:"bold"},uploadExcelBox:{border:"2px dashed #99f6e4",background:"#f0fdfa",borderRadius:16,padding:24,textAlign:"center",display:"grid",gap:6,color:"#0f766e",cursor:"pointer"},importDicasGrid:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,margin:"12px 0"},previewImportacao:{display:"grid",gap:8,marginBottom:12},previewLinha:{background:"#f8fafc",border:"1px solid #e5e7eb",borderRadius:12,padding:10,display:"grid",gap:4},alertaSucesso:{background:"#ecfdf5",border:"1px solid #a7f3d0",color:"#047857",borderRadius:12,padding:10,fontWeight:"bold"},btnSair:{background:"#fee2e2",color:"#ef4444",border:"none",padding:"8px 12px",borderRadius:8,fontWeight:"bold"},overlayConfirmacao:{position:"fixed",inset:0,background:"rgba(0,0,0,0.55)",display:"flex",alignItems:"center",justifyContent:"center",padding:18,zIndex:3e3},modalConfirmacao:{background:"#fff",borderRadius:18,padding:18,width:"100%",maxWidth:360,boxShadow:"0 12px 30px rgba(0,0,0,0.25)",textAlign:"center"},confirmacaoIcone:{fontSize:38,marginBottom:8},confirmacaoTitulo:{margin:"4px 0 8px",fontSize:20},confirmacaoTexto:{margin:"0 0 16px",color:"#444",lineHeight:1.4},confirmacaoAcoes:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10},btnConfirmarCancelar:{border:"none",borderRadius:10,padding:11,background:"#6c757d",color:"#fff",fontWeight:"bold"},btnConfirmarAcao:{border:"none",borderRadius:10,padding:11,color:"#fff",fontWeight:"bold"},headerExpansivel:{width:"100%",background:"#fff",border:"1px solid #e5e5e5",borderRadius:14,padding:"12px 14px",margin:"12px 0",display:"flex",justifyContent:"space-between",alignItems:"center",fontSize:20,fontWeight:"bold",boxShadow:"0 2px 8px rgba(0,0,0,0.04)"},page:{padding:16,maxWidth:700,margin:"auto",fontFamily:"Arial",background:"#f8fafc",minHeight:"100vh",paddingBottom:100},titulo:{fontSize:28,marginBottom:12},subtitulo:{fontSize:22,marginBottom:12},bloco:{marginTop:24},resumo:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:12},boxTotal:{background:"#fff",padding:12,borderRadius:14,display:"flex",flexDirection:"column",boxShadow:"0 2px 8px rgba(0,0,0,0.06)"},boxPago:{background:"#d4edda",padding:12,borderRadius:14,display:"flex",flexDirection:"column"},boxPendente:{background:"#fff3cd",padding:12,borderRadius:14,display:"flex",flexDirection:"column"},boxVencido:{background:"#f8d7da",padding:12,borderRadius:14,display:"flex",flexDirection:"column"},filtrosBox:{background:"#fff",padding:12,borderRadius:14,marginBottom:12,boxShadow:"0 2px 8px rgba(0,0,0,0.06)"},input:{width:"100%",padding:10,borderRadius:8,border:"1px solid #ccc",marginBottom:8,boxSizing:"border-box"},datas:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8},filtros:{display:"flex",gap:6,flexWrap:"wrap",marginBottom:8},filtro:{border:"1px solid #ccc",background:"#fff",padding:"7px 11px",borderRadius:10,fontWeight:800,cursor:"pointer"},filtroAtivo:{border:"none",background:"#0d6efd",color:"#fff",padding:"7px 11px",borderRadius:8},resumoFiltro:{background:"#fff",padding:12,borderRadius:14,marginBottom:12,boxShadow:"0 2px 8px rgba(0,0,0,0.06)",display:"flex",flexDirection:"column",gap:4,fontSize:14},cardConta:{padding:12,borderRadius:14,marginBottom:10,boxShadow:"0 2px 8px rgba(0,0,0,0.08)"},cardTopo:{display:"flex",justifyContent:"space-between",fontSize:18,marginBottom:4},cardInfo:{fontSize:13,opacity:.75},cardDashboard:{background:"#fff",padding:12,borderRadius:14,marginBottom:8,boxShadow:"0 2px 8px rgba(0,0,0,0.06)"},dashboardGrid:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:5,marginTop:6,fontSize:13},cardConfiguracao:{background:"#fff",padding:14,borderRadius:14,marginTop:14,marginBottom:10,border:"1px solid #ddd",boxShadow:"0 2px 8px rgba(0,0,0,0.06)"},switchLinha:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,padding:"10px 0",borderBottom:"1px solid #eee"},configResumo:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,fontSize:13,background:"#f8fafc",padding:10,borderRadius:10},cardAgenda:{background:"#fff",padding:12,borderRadius:14,marginTop:14,marginBottom:10,border:"1px solid #ddd",boxShadow:"0 2px 8px rgba(0,0,0,0.06)"},itemAgenda:{background:"#f8fafc",padding:10,borderRadius:10,marginTop:8,display:"flex",justifyContent:"space-between",gap:10,alignItems:"center"},agendaDireita:{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:6},textoAgenda:{display:"block",marginTop:5,color:"#444",fontWeight:"bold"},textoVencidoAgenda:{display:"block",marginTop:5,color:"#dc3545",fontWeight:"bold"},cardLixeira:{background:"#fff",padding:12,borderRadius:14,marginBottom:10,border:"1px solid #ddd",boxShadow:"0 2px 8px rgba(0,0,0,0.06)"},textoQuarentena:{display:"block",marginTop:8,color:"#64748b",fontWeight:700},textoLiberado:{display:"block",marginTop:8,color:"#64748b",fontWeight:700},cardNota:{background:"#eef2ff",padding:12,borderRadius:14,marginBottom:10,boxShadow:"0 2px 8px rgba(0,0,0,0.08)"},textoNota:{fontSize:14,whiteSpace:"pre-wrap"},acoes:{display:"flex",gap:6,flexWrap:"wrap",marginTop:8},mensagemVazia:{fontSize:13,opacity:.7},btnPago:{minHeight:38,minWidth:74,background:"#0f766e",color:"#fff",border:"1px solid #0f766e",padding:"8px 12px",borderRadius:10,fontWeight:800,cursor:"pointer",display:"inline-flex",alignItems:"center",justifyContent:"center"},btnVoltar:{minHeight:38,minWidth:74,background:"#f8fafc",color:"#475569",border:"1px solid #cbd5e1",padding:"8px 12px",borderRadius:10,fontWeight:800,cursor:"pointer",display:"inline-flex",alignItems:"center",justifyContent:"center"},btnEditar:{minHeight:38,minWidth:74,background:"#fef3c7",color:"#92400e",border:"1px solid #fcd34d",padding:"8px 12px",borderRadius:10,fontWeight:800,cursor:"pointer",display:"inline-flex",alignItems:"center",justifyContent:"center"},btnExcluir:{minHeight:38,minWidth:74,background:"#fff1f2",color:"#e11d48",border:"1px solid #fecdd3",padding:"8px 12px",borderRadius:10,fontWeight:800,cursor:"pointer",display:"inline-flex",alignItems:"center",justifyContent:"center"},btnSecundario:{background:"#f8fafc",color:"#0f766e",border:"1px solid #99f6e4",padding:"6px 10px",borderRadius:8,fontWeight:800,cursor:"pointer"},btnCinza:{background:"#64748b",color:"#fff",border:"none",padding:"7px 10px",borderRadius:8},btnRoxo:{background:"#6f42c1",color:"#fff",border:"none",padding:"7px 10px",borderRadius:8},btnVerde:{background:"#14b8a6",color:"#fff",border:"none",padding:"7px 10px",borderRadius:8},fab:{position:"fixed",right:22,bottom:22,width:54,height:54,borderRadius:18,background:"linear-gradient(135deg, #0f766e 0%, #14b8a6 100%)",color:"#ffffff",border:"1px solid rgba(255,255,255,0.22)",fontSize:28,lineHeight:1,display:"inline-flex",alignItems:"center",justifyContent:"center",boxShadow:"0 18px 38px rgba(15, 118, 110, 0.28)",zIndex:3e3,cursor:"pointer"},menuFab:{position:"fixed",right:20,bottom:86,display:"flex",flexDirection:"column",gap:8,zIndex:3001},menuItem:{background:"#fff",border:"1px solid #e5e7eb",borderRadius:14,padding:"0 14px",minWidth:190,width:190,height:48,fontSize:14,fontWeight:800,boxShadow:"0 10px 24px rgba(15,23,42,0.14)",textAlign:"left",display:"flex",alignItems:"center",justifyContent:"flex-start",gap:10,color:"#0f172a",whiteSpace:"nowrap",overflow:"visible",cursor:"pointer"},menuItemIcone:{display:"inline-flex",width:26,minWidth:26,justifyContent:"center",fontSize:18,lineHeight:1},menuItemTexto:{display:"inline-block",color:"#0f172a",fontSize:14,fontWeight:800,lineHeight:1},overlay:{position:"fixed",inset:0,background:"rgba(0,0,0,0.45)",display:"flex",justifyContent:"center",alignItems:"center",padding:16,zIndex:999},blocoNotificacaoConta:{background:"#f8fafc",border:"1px solid #e5e5e5",borderRadius:12,padding:10,marginBottom:10},blocoRecorrenciaConta:{background:"#f0fdfa",border:"1px solid #99f6e4",borderRadius:12,padding:10,marginBottom:10},switchLinhaCompacta:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"8px 0",borderBottom:"1px solid #e5e5e5",fontSize:14},textoAjuda:{display:"block",color:"#666",fontSize:11,marginTop:4},notificacaoChips:{display:"flex",gap:6,flexWrap:"wrap",marginTop:6},chipNotif:{background:"#eef6ff",color:"#0d6efd",border:"1px solid #b6d4fe",borderRadius:999,padding:"3px 7px",fontSize:11,fontWeight:"bold"},modal:{background:"#fff",padding:18,borderRadius:14,width:"100%",maxWidth:360},inputModal:{width:"100%",padding:10,marginBottom:8,borderRadius:8,border:"1px solid #ccc",boxSizing:"border-box"},textareaModal:{width:"100%",minHeight:110,padding:10,marginBottom:8,borderRadius:8,border:"1px solid #ccc",boxSizing:"border-box",fontFamily:"Arial"},btnGhostAction:{width:"auto",background:"#fff",color:"#374151",border:"1px solid #d1d5db",padding:"7px 12px",borderRadius:999,fontSize:13,fontWeight:800,cursor:"pointer",marginBottom:0},btnSalvar:{width:"100%",padding:10,border:"none",borderRadius:8,background:"#14b8a6",color:"#fff",marginBottom:8},btnCancelar:{width:"100%",padding:10,border:"none",borderRadius:8,background:"#6c757d",color:"#fff"},itemCentro:{display:"flex",justifyContent:"space-between",alignItems:"center",background:"#f1f1f1",padding:8,borderRadius:8,marginBottom:6,fontSize:13},btnMiniExcluir:{background:"#fee2e2",color:"#ef4444",border:"1px solid #f87171",borderRadius:999,padding:"8px 10px",fontSize:11},notasHeaderNovo:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:10,marginBottom:10},btnMiniVerde:{background:"#0f766e",color:"#fff",border:"none",borderRadius:12,padding:"6px 11px",fontWeight:"900",fontSize:18,lineHeight:1},notasListaNova:{display:"grid",gap:10},cardNotaAcao:{padding:12,borderRadius:16,marginBottom:10,border:"1px solid #e5e7eb",boxShadow:"0 8px 20px rgba(15,23,42,0.06)"},cardNotaNormal:{background:"#f8fafc",borderColor:"#e5e7eb"},cardNotaUrgente:{background:"#fffbeb",borderColor:"#fde68a"},cardNotaCritico:{background:"#fff7f7",borderColor:"#fecaca"},badgePrioridade:{borderRadius:999,padding:"4px 8px",fontSize:12,fontWeight:"900"},badgeNormal:{background:"#f1f5f9",color:"#475569"},badgeUrgente:{background:"#fffbeb",color:"#92400e",border:"1px solid #fde68a"},badgeCritico:{background:"#fff7f7",color:"#991b1b",border:"1px solid #fecaca"}},Sd=[{id:"principal",titulo:"Principal",items:[{tela:"dashboard",icon:"🏠",label:"Dashboard",desc:"Resumo financeiro"},{tela:"agenda",icon:"📅",label:"Agenda",desc:"Vencimentos e previsões"},{tela:"notas",icon:"📝",label:"Bloco de Notas",desc:"Pendências e histórico de notas"}]},{id:"financeiro",titulo:"Financeiro",items:[{tela:"contas",icon:"💳",label:"Contas",desc:"Contas a pagar e filtros"}]},{id:"analise",titulo:"Análise",items:[{tela:"relatorios",icon:"📊",label:"Relatórios",desc:"Análises e indicadores"}]},{id:"master",titulo:"Master",items:[{tela:"master-empresas",icon:"🏢",label:"Painel Master",desc:"Empresas e tenants SaaS",masterOnly:!0}]},{id:"sistema",titulo:"Sistema",items:[{tela:"usuarios",icon:"👥",label:"Usuários",desc:"Perfis, acessos e senhas"},{tela:"configuracoes",icon:"⚙️",label:"Configurações",desc:"Preferências da empresa"},{tela:"filiais",icon:"🏬",label:"Filiais",desc:"Unidades da empresa"},{tela:"billing",icon:"💼",label:"Billing",desc:"Planos, limites e assinatura"},{tela:"onboarding",icon:"🚀",label:"Onboarding",desc:"Implantação inicial SaaS"},{tela:"importar",icon:"📥",label:"Importar CSV",desc:"Trazer histórico do Excel"},{tela:"lixeira",icon:"🗑️",label:"Lixeira",desc:"Restaurar ou excluir definitivo"}]}],Ko="df_sessao_segura",_d=8*60*60*1e3,Ed=30*60*1e3,zd=25*60*1e3;function Oo(){try{return JSON.parse(localStorage.getItem(Ko)||"{}")}catch{return{}}}function vi(t){localStorage.setItem(Ko,JSON.stringify(t))}function Pd(){localStorage.removeItem(Ko)}function Rd(){const t=c.useRef(!1),a=c.useRef(!1),o=c.useRef(null),{globalLoading:i,toast:n,showToast:d,hideToast:l,empresaAtiva:m,setEmpresaAtiva:f,limparEmpresaAtiva:b,empresasDisponiveis:_,setEmpresasDisponiveis:k}=Di();function S(r){const p=String((r==null?void 0:r.message)||r||"").toLowerCase();return p.includes("jwt")||p.includes("expired")||p.includes("unauthorized")||p.includes("session")}function g(r,p){if(!r||p==="pago")return!1;const h=new Date;h.setHours(0,0,0,0);const j=new Date(r+"T00:00:00");return j.setHours(0,0,0,0),j<h}function T(r){return r?String(r).slice(0,7):""}function P(r){if(!r)return 0;const p=new Date(r),j=new Date-p;return Math.max(0,Math.floor(j/(1e3*60*60*24)))}function z(r){return!0}function H(r=[]){return r.map(p=>`${p.id||""}:${p.excluido_em||""}:${p.updated_at||""}`).join("|")}function ie(r,p=[]){r((h=[])=>H(h)===H(p)?h:p)}const{contas:V,setContas:q,contasLixeira:ne,setContasLixeira:G,busca:ae,setBusca:I,filtroStatus:M,setFiltroStatus:Y,filtroCentro:je,setFiltroCentro:ce,filtroFilial:he,setFiltroFilial:Ce,filtroMes:oe,setFiltroMes:y,dataInicial:pe,setDataInicial:A,dataFinal:Z,setDataFinal:K,loading:Q,setLoading:N,modalConta:J,setModalConta:Me,editandoContaId:_e,descricao:we,setDescricao:U,valor:fe,setValor:Ae,dataVencimento:C,setDataVencimento:be,centroCustoId:ze,setCentroCustoId:me,filialId:$,setFilialId:re,observacaoConta:et,setObservacaoConta:st,contaRecorrente:Oe,setContaRecorrente:It,tipoRecorrencia:Ye,setTipoRecorrencia:lt,diaVencimentoRecorrencia:Be,setDiaVencimentoRecorrencia:pt,buscarContas:_t,abrirNovaConta:Xe,abrirEdicaoConta:Vt,fecharConta:gt,salvarConta:ea,marcarComoPago:Se,voltarParaPendente:X,excluirConta:L}=pd(),{notas:B,setNotas:ue,notasLixeira:Pe,setNotasLixeira:We,buscaNota:He,setBuscaNota:qe,modalNota:Ke,setModalNota:Ge,editandoNotaId:ot,tituloNota:bt,setTituloNota:Rt,conteudoNota:Gt,setConteudoNota:At,prioridadeNota:Qe,setPrioridadeNota:mt,dataEventoNota:Bt,setDataEventoNota:qt,filialNotaId:ut,setFilialNotaId:vt,buscarNotas:jt,buscarNotasLixeira:s,abrirNovaNota:v,abrirEdicaoNota:O,fecharNota:se,salvarNota:ye,excluirNota:ve,alternarNotaConcluida:ge,restaurarNota:Re,excluirNotaDefinitivo:le}=yd(),[Te,tt]=c.useState([]),[xe,dt]=c.useState([]),[Ct,ft]=c.useState(!1),[xt,Je]=c.useState(""),[Ft,De]=c.useState(!1),[Ze,Et]=c.useState(!1),[Vi,Gi]=c.useState(!1),[Wi,Hi]=c.useState({principal:!0,financeiro:!0,analise:!0,sistema:!0}),[rt,ca]=c.useState("dashboard"),[R,zt]=c.useState(null),[Ki,wa]=c.useState(!0),[W,ka]=c.useState(null),[Ca,Yo]=c.useState(!1),[Aa,Na]=c.useState(""),[Ne,Ba]=c.useState(()=>Ma()),[xo,pa]=c.useState(""),[Yi,ho]=c.useState(!1),[Xo,Qo]=c.useState(""),[Xi,Jo]=c.useState(!1),[Zo,qa]=c.useState(""),[La,go]=c.useState([]),[Qi,er]=c.useState(!1),[Ji,bo]=c.useState(!1),[Zi,vo]=c.useState(""),[tr,ar]=c.useState(!1),[or,Oa]=c.useState({}),[en,rr]=c.useState(""),[ir,nr]=c.useState(""),[sr,lr]=c.useState(""),[dr,cr]=c.useState("operador"),[pr,mr]=c.useState(""),[ur,fr]=c.useState(""),[Sa,xr]=c.useState(""),[hr,gr]=c.useState(""),[tn,an]=c.useState(!1),[on,rn]=c.useState(!0),[nn,sn]=c.useState(!0),[ln,dn]=c.useState(()=>typeof window>"u"?!0:window.innerWidth>=980),[jo,cn]=c.useState(!0),[yo,pn]=c.useState(!0),[Ua,mn]=c.useState(!0),[wo,un]=c.useState(!0),[Va,Ga]=c.useState(null),[ko,Co]=c.useState(!0),[ta,br]=c.useState(!0),[aa,vr]=c.useState(!0),[oa,jr]=c.useState(!1),[ma,No]=c.useState("1"),[Wa,So]=c.useState("1"),[yr,_o]=c.useState(!0),[wr,Eo]=c.useState(!0),[kr,zo]=c.useState("3"),[Cr,Po]=c.useState(!0),[ra,Ro]=c.useState(""),[Nr,Fo]=c.useState(""),[Sr,$o]=c.useState(""),[yt,_r]=c.useState({aberto:!1,titulo:"",mensagem:"",textoConfirmar:"Confirmar",tipo:"padrao",acao:null}),[Er,Mo]=c.useState(null),[Wt,Ha]=c.useState([]),[zr,_a]=c.useState("");function ee(r,p="info"){d(r,p)}function Ee(r,p="Não foi possível concluir a operação."){const h=(r==null?void 0:r.message)||r||p;if(S(r)){if(a.current)return;a.current=!0,D.auth.signOut().finally(()=>{Ht(),zt(null),ca("dashboard"),wa(!1),ee("Sua sessão expirou. Faça login novamente.","erro"),window.setTimeout(()=>{a.current=!1},1200)});return}ee(String(h),"erro")}function Pr(){q([]),ue([]),tt([]),dt([]),G([]),We([]),go([]),vo(""),bo(!1),Ga(null),Me(!1),Ge(!1),ft(!1),De(!1),Et(!1),I(""),qe(""),Y("todas"),ce(""),Ce(""),y(""),A(""),K(""),Mo(null),Ha([]),_a("")}function Ht(){Pr(),k([]),ka(null),b(),Na(""),Oa({}),pa(""),qa(""),N(!1),Pd()}async function fn(){var r,p;if(R!=null&&R.id)try{const j=await fi(R.id)||((r=R==null?void 0:R.user_metadata)==null?void 0:r.name)||((p=R==null?void 0:R.user_metadata)==null?void 0:p.full_name)||"";j&&j!==xo&&pa(j)}catch(h){console.warn("Falha ao sincronizar nome do perfil:",(h==null?void 0:h.message)||h)}}c.useEffect(()=>{let r=!0;async function p(){try{const j=new Promise(F=>{window.setTimeout(()=>F({data:{session:null},error:new Error("Timeout ao validar sessão")}),8e3)}),{data:w,error:E}=await Promise.race([D.auth.getSession(),j]);if(!r)return;if(E||!(w!=null&&w.session)){Ht(),zt(null);return}zt(w.session.user)}catch(j){if(!r)return;console.warn("Falha ao validar sessão:",(j==null?void 0:j.message)||j),Ht(),zt(null)}finally{r&&wa(!1)}}p();const{data:h}=D.auth.onAuthStateChange((j,w)=>{wa(!1),zt((w==null?void 0:w.user)||null),w||Ht()});return()=>{r=!1,h.subscription.unsubscribe()}},[]),c.useEffect(()=>{if(!R)return;const r=Date.now(),p=Oo();vi({inicio:p.inicio||r,ultimaAtividade:r});function h(){const de=Oo();vi({inicio:de.inicio||Date.now(),ultimaAtividade:Date.now()}),t.current=!1}async function j(de){a.current||(a.current=!0,Ht(),zt(null),ca("dashboard"),wa(!1),await D.auth.signOut(),ee(de,"erro"),window.setTimeout(()=>{a.current=!1},1200))}function w(){const de=Oo(),Ue=Number(de.inicio||Date.now()),ct=Number(de.ultimaAtividade||Date.now()),ke=Date.now(),Le=ke-Ue,Lt=ke-ct;if(Le>=_d){j("Sua sessão expirou por segurança. Faça login novamente.");return}if(Lt>=Ed){j("Sua sessão foi encerrada por inatividade. Faça login novamente.");return}Lt>=zd&&!t.current&&(t.current=!0,wt({titulo:"Sessão quase expirada",mensagem:"Sua sessão vai expirar por segurança. Deseja continuar conectado?",textoConfirmar:"Continuar conectado",tipo:"padrao",acao:async()=>h()}))}const E=["click","keydown","mousemove","scroll","touchstart"];E.forEach(de=>window.addEventListener(de,h,{passive:!0}));const F=window.setInterval(w,60*1e3);return()=>{E.forEach(de=>window.removeEventListener(de,h)),window.clearInterval(F)}},[R]),c.useEffect(()=>{if(!R){N(!1);return}xn(R.id)},[R]),c.useEffect(()=>{if(!(R!=null&&R.id)||!W)return;let r=!1;async function p(){if(!r)try{await Promise.allSettled([Kt(W),Xa(W),Tr(W),Yt(W)])}catch(E){console.warn("Falha ao sincronizar dados do tenant:",(E==null?void 0:E.message)||E)}}function h(){window.clearTimeout(o.current),o.current=window.setTimeout(p,350)}function j(){document.visibilityState==="visible"&&h()}window.addEventListener("focus",h),document.addEventListener("visibilitychange",j);const w=D.channel(`tenant-sync-${W}`).on("postgres_changes",{event:"*",schema:"public",table:"df_centros_custo",filter:`empresa_id=eq.${W}`},h).on("postgres_changes",{event:"*",schema:"public",table:"df_filiais",filter:`empresa_id=eq.${W}`},h).on("postgres_changes",{event:"*",schema:"public",table:"df_contas",filter:`empresa_id=eq.${W}`},h).on("postgres_changes",{event:"*",schema:"public",table:"df_contas_recorrentes",filter:`empresa_id=eq.${W}`},h).subscribe();return()=>{r=!0,window.clearTimeout(o.current),window.removeEventListener("focus",h),document.removeEventListener("visibilitychange",j),D.removeChannel(w)}},[R==null?void 0:R.id,W]),c.useEffect(()=>{!Ze||!(R!=null&&R.id)||fn()},[Ze,R==null?void 0:R.id]),c.useEffect(()=>{window.history.replaceState({tela:rt},"",window.location.href);function r(p){var j;const h=((j=p.state)==null?void 0:j.tela)||"dashboard";De(!1),Et(!1),ca(h)}return window.addEventListener("popstate",r),()=>window.removeEventListener("popstate",r)},[]),c.useEffect(()=>{rt==="usuarios"&&W&&ua(W)},[rt,W]),c.useEffect(()=>{function r(p){if(p.key==="Escape"){if(yt.aberto){eo();return}J&&Pa(),Ke&&Za(),Ct&&ft(!1),Ft&&De(!1),Ze&&Et(!1)}}return window.addEventListener("keydown",r),()=>window.removeEventListener("keydown",r)},[yt.aberto,J,Ke,Ct,Ft,Ze]),c.useEffect(()=>{const r=document.body.style.overflow,p=document.documentElement.style.overflow,h=document.body.style.position,j=document.body.style.width,w=window.scrollY;return Ze&&(document.body.classList.add("mobile-nav-open"),document.documentElement.classList.add("mobile-nav-open"),document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden",document.body.style.position="fixed",document.body.style.width="100%",document.body.style.top=`-${w}px`),()=>{document.body.classList.remove("mobile-nav-open"),document.documentElement.classList.remove("mobile-nav-open"),document.body.style.overflow=r,document.documentElement.style.overflow=p,document.body.style.position=h,document.body.style.width=j,document.body.style.top="",Ze&&window.scrollTo(0,w)}},[Ze]);async function xn(r){var p,h,j,w;N(!0),qa("");try{await Yl();const E=await Xl(r),F=await fi(r),de=await Lo({userId:r,email:R==null?void 0:R.email,perfilEmpresa:(E==null?void 0:E.perfil)||"operador"}),Ue=await bi({userId:r,email:R==null?void 0:R.email,isMaster:de.isMaster});if(!(E!=null&&E.empresaId)&&!de.isMaster){ka(null),b(),Na(""),Ba(Ma()),pa(""),qa(Hl.semEmpresa);return}if(de.isMaster&&Ue.length===0){ka(null),b(),Na("master"),Ba({...de,canSwitchCompany:!0,canManageCompanies:!0}),pa(F||((p=R==null?void 0:R.user_metadata)==null?void 0:p.name)||((h=R==null?void 0:R.user_metadata)==null?void 0:h.full_name)||""),qa("Nenhuma empresa cadastrada em df_empresas para o usuário master.");return}const ke=Ue.find(na=>na.id===(m==null?void 0:m.id))||Ue.find(na=>na.id===(E==null?void 0:E.empresaId))||Ue[0]||{id:E==null?void 0:E.empresaId,nome:(E==null?void 0:E.nomeEmpresa)||"Dona Flor",perfil:(E==null?void 0:E.perfil)||"operador"},Le=ke.perfil||(E==null?void 0:E.perfil)||(de.isMaster?"master":"operador"),Lt=de.isMaster?{...de,perfilEmpresa:Nt(Le),canSwitchCompany:!0,canManageCompanies:!0}:await Lo({userId:r,email:R==null?void 0:R.email,perfilEmpresa:Le});k(Ue.length>0?Ue:[ke]),ka(ke.id),f({id:ke.id,nome:ke.nome||(E==null?void 0:E.nomeEmpresa)||"Dona Flor",perfil:Le}),Na(Le),Ba(Lt),pa(F||((j=R==null?void 0:R.user_metadata)==null?void 0:j.name)||((w=R==null?void 0:R.user_metadata)==null?void 0:w.full_name)||""),await Ka(ke.id)}catch(E){S(E)?(await D.auth.signOut(),Ht(),zt(null),ee("Sua sessão expirou. Faça login novamente.","erro")):ee(E.message,"erro")}finally{N(!1)}}async function Ka(r=W){r&&await Promise.all([Kt(r),za(r),Xa(r),Tr(r),Yt(r),Nn(r)])}function Nt(r){return Zt(r)}function Rr(r=[]){if(Ne!=null&&Ne.isMaster)return!0;const p=Nt(Aa);return r.includes(p)}function ia(){return!!(Ne!=null&&Ne.canManageUsers||Rr(["admin"]))}function Ea(){return!!(Ne!=null&&Ne.canAccessSettings||Rr(["admin","gerente"]))}function Fr(){return Sd.map(r=>({...r,items:r.items.filter(p=>!p.masterOnly||(Ne==null?void 0:Ne.canManageCompanies))})).filter(r=>r.items.length>0)}async function hn(){if(R)try{const r=await bi({userId:R.id,email:R.email,isMaster:Ne==null?void 0:Ne.isMaster});k(r)}catch(r){console.warn("Não foi possível atualizar a lista de empresas:",r.message)}}async function Ya(r){if(!r||Ca)return;const p=_.find(h=>h.id===r);if(!p){ee("Empresa selecionada não encontrada para este usuário.","erro");return}if(p.id!==W){Yo(!0),N(!0);try{const h=p.perfil||(Ne!=null&&Ne.isMaster?"master":"operador"),j=Ne!=null&&Ne.isMaster?{...Ne,perfilEmpresa:Nt(h),canSwitchCompany:!0,canManageCompanies:!0,canManageUsers:!0,canAccessSettings:!0}:await Lo({userId:R==null?void 0:R.id,email:R==null?void 0:R.email,perfilEmpresa:h});Pr(),ka(p.id),f({id:p.id,nome:p.nome||"Empresa",perfil:h}),Na(h),Ba(j),ca("dashboard"),await Ka(p.id),ee(`Empresa ativa: ${p.nome||"Empresa"}`,"sucesso")}catch(h){Ee(h,"Não foi possível trocar a empresa ativa.")}finally{Yo(!1),N(!1)}}}async function ua(r=W,p={}){if(!r)return;const h=!!(p!=null&&p.silencioso);h||er(!0),vo("");try{const[j,w]=await Promise.all([ls(r),fs(r)]),E={};(w||[]).forEach(F=>{!(F!=null&&F.usuario_id)||!(F!=null&&F.filial_id)||(E[F.usuario_id]||(E[F.usuario_id]=[]),E[F.usuario_id].push(F.filial_id))}),go(j),Oa(E),bo(!0)}catch(j){console.warn("Não foi possível carregar usuários:",j.message),go([]),Oa({}),bo(!0),vo((j==null?void 0:j.message)||"Não foi possível carregar os usuários da empresa.")}finally{h||er(!1)}}async function gn(){if(tr)return;if(!W){ee("Empresa não identificada.","erro");return}if(!ia()){ee("Apenas administradores podem adicionar usuários.","erro");return}const r=ir.trim().toLowerCase();if(!r||!r.includes("@")){ee("Informe um e-mail válido.","erro");return}const p=pr.trim();if(p.length<6){ee("Informe uma senha provisória com pelo menos 6 caracteres.","erro");return}const h=Nt(dr);try{ar(!0),await ds({empresaId:W,email:r,nome:sr,perfil:h,senhaProvisoria:p,criarAuthManual:!0}),await ua(W,{silencioso:!0})}catch(j){Ee(j);return}finally{ar(!1)}nr(""),lr(""),mr(""),cr("operador"),ee("Usuário criado manualmente. Entregue o e-mail e a senha provisória ao usuário por um canal seguro.","sucesso")}async function bn(r){if(!ia()){ee("Apenas administradores podem enviar acesso ou reset de senha.","erro");return}const p=r.nome||r.email||"este usuário";wt({titulo:"Enviar acesso",mensagem:`Deseja enviar um link de acesso/redefinição de senha para ${p}?`,textoConfirmar:"Enviar link",tipo:"padrao",acao:async()=>{try{const h=await ms({usuario:r});ee(h.mensagem,"info")}catch(h){Ee(h)}}})}async function vn(r,p){if(!ia()){ee("Apenas administradores podem alterar perfis.","erro");return}const h=Nt(p);if(r.user_id&&(R==null?void 0:R.id)&&r.user_id===R.id&&h!=="admin"&&La.filter(de=>Nt(de.perfil)==="admin").length<=1){ee("Você não pode remover o último administrador da empresa.","erro");return}if(h===Nt(r.perfil))return;const w=r.nome||r.email||"este usuário",E=kt(h);wt({titulo:"Alterar perfil",mensagem:`Deseja alterar o perfil de ${w} para ${E}?`,textoConfirmar:"Confirmar alteração",tipo:h==="admin"?"perigo":"padrao",acao:async()=>{try{await cs({empresaId:W,usuario:r,perfil:h})}catch(F){Ee(F);return}await ua()}})}async function $r(r,p){if(!ia()){ee("Apenas administradores podem alterar filiais dos usuários.","erro");return}if(!(r!=null&&r.id)){ee("Este usuário precisa estar cadastrado na empresa para receber filiais.","erro");return}const h=r.id;rr(h);try{await xs({empresaId:W,usuario:r,filialIds:p}),Oa(j=>({...j,[r.id]:p})),ee("Filiais do usuário atualizadas.","sucesso")}catch(j){Ee(j,"Não foi possível atualizar as filiais do usuário.")}finally{rr("")}}function jn(r,p){const h=or[r.id]||[],w=h.includes(p)?h.filter(E=>E!==p):[...h,p];$r(r,w)}function yn(r){$r(r,[])}async function wn(r){if(!ia()){ee("Apenas administradores podem remover usuários.","erro");return}if(r.user_id&&(R==null?void 0:R.id)&&r.user_id===R.id){ee("Você não pode remover o próprio acesso por aqui.","erro");return}if(Nt(r.perfil)==="admin"&&La.filter(j=>Nt(j.perfil)==="admin").length<=1){ee("Você não pode remover o último administrador da empresa.","erro");return}wt({titulo:"Remover usuário",mensagem:`Deseja remover ${r.nome||r.email||"este usuário"} desta empresa?`,textoConfirmar:"Remover",tipo:"perigo",acao:async()=>{try{await ps({empresaId:W,usuario:r})}catch(h){Ee(h);return}await ua()}})}async function kn(){const r=ur.trim().toLowerCase();if(!r||!r.includes("@")){ee("Informe um e-mail válido.","erro");return}const{error:p}=await D.auth.updateUser({email:r},{emailRedirectTo:window.location.origin});if(p){Ee(p);return}fr(""),ee("Solicitação enviada. Confirme o novo e-mail conforme orientação do Supabase.","sucesso")}async function Cn(){if(!Sa||Sa.length<6){ee("A senha precisa ter pelo menos 6 caracteres.","erro");return}if(Sa!==hr){ee("As senhas não conferem.","erro");return}const{error:r}=await D.auth.updateUser({password:Sa});if(r){Ee(r);return}xr(""),gr(""),ee("Senha atualizada com sucesso.","sucesso")}async function Kt(r=W){return _t({supabase:D,empresaAtual:r,avisarErro:Ee,configWhatsapp:ta,configEmail:aa,configPush:oa,diasAlertaContas:Wa,diasAvisoPadrao:ma})}async function za(r=W){return jt({supabase:D,empresaAtual:r,avisarErro:Ee})}async function Mr(r=W){if(!r)return;const{data:p,error:h}=await D.from("df_configuracoes_alertas").select("*").eq("empresa_id",r).maybeSingle();if(h){console.warn("Não foi possível carregar alertas globais:",h.message);return}if(p){So(String(p.dias_alerta_contas??1)),_o(p.alertar_contas_vencidas??!0),Eo(p.destacar_contas_criticas??!0),zo(String(p.dias_alerta_notas??3)),Po(p.destacar_notas_urgentes??!0);return}const j={empresa_id:r,dias_alerta_contas:1,alertar_contas_vencidas:!0,destacar_contas_criticas:!0,dias_alerta_notas:3,destacar_notas_urgentes:!0},{data:w,error:E}=await D.from("df_configuracoes_alertas").insert([j]).select().maybeSingle();if(E){console.warn("Não foi possível criar alertas globais:",E.message);return}w&&(So(String(w.dias_alerta_contas??1)),_o(w.alertar_contas_vencidas??!0),Eo(w.destacar_contas_criticas??!0),zo(String(w.dias_alerta_notas??3)),Po(w.destacar_notas_urgentes??!0))}async function Nn(r=W){if(!r)return;const{data:p,error:h}=await D.from("df_configuracoes").select("*").eq("empresa_id",r).limit(1);if(h){Ee(h);return}const j=Array.isArray(p)?p[0]:p;if(j){Ga(j),Co(j.notificacoes_ativas??!0),br(j.enviar_whatsapp??!0),vr(j.enviar_email??!0),jr(j.enviar_push??!1),No(String(j.dias_aviso_padrao??1)),Ro(j.nome_empresa||""),Fo(j.whatsapp_padrao||""),$o(j.email_padrao||""),await Mr(r);return}const{data:w,error:E}=await D.from("df_configuracoes").insert([{notificacoes_ativas:!0,enviar_whatsapp:!0,enviar_email:!0,enviar_push:!1,dias_aviso_padrao:1,nome_empresa:"DF Gestão Financeira",empresa_id:r}]).select();if(E){Ee(E);return}const F=Array.isArray(w)?w[0]:w;Ga(F),Co((F==null?void 0:F.notificacoes_ativas)??!0),br((F==null?void 0:F.enviar_whatsapp)??!0),vr((F==null?void 0:F.enviar_email)??!0),jr((F==null?void 0:F.enviar_push)??!1),No(String((F==null?void 0:F.dias_aviso_padrao)??1)),Ro((F==null?void 0:F.nome_empresa)||""),Fo((F==null?void 0:F.whatsapp_padrao)||""),$o((F==null?void 0:F.email_padrao)||""),await Mr(r)}async function Yt(r=W){if(!r)return;const{data:p,error:h}=await D.from("df_contas").select("*, df_centros_custo(nome), df_filiais(nome), df_contas_recorrentes(tipo_recorrencia)").eq("empresa_id",r).eq("excluido",!0).order("excluido_em",{ascending:!1});h&&Ee(h),ie(G,p||[]),await s({supabase:D,empresaAtual:r,avisarErro:Ee})}async function Xa(r=W){if(!r)return;const{data:p,error:h}=await D.from("df_centros_custo").select("*").eq("empresa_id",r).order("nome");if(h){Ee(h);return}tt(p||[])}async function Tr(r=W){if(!r){dt([]);return}try{const p=await Ho(r);dt((p||[]).filter(h=>h.ativo!==!1))}catch(p){Ee(p),dt([])}}const St=V.filter(r=>M==="pendentes"?r.status!=="pago":M==="pagas"?r.status==="pago":M==="vencidas"?g(r.data_vencimento,r.status):!0).filter(r=>!je||r.centro_custo_id===je).filter(r=>!he||r.filial_id===he).filter(r=>!oe||T(r.data_vencimento)===oe).filter(r=>!(pe&&r.data_vencimento<pe||Z&&r.data_vencimento>Z)).filter(r=>{var F,de;const p=ae.trim().toLowerCase();if(!p)return!0;const h=((F=r.df_centros_custo)==null?void 0:F.nome)||"",j=((de=r.df_filiais)==null?void 0:de.nome)||"",w=r.status==="pago"?"pago":g(r.data_vencimento,r.status)?"vencido":"pendente";return[r.descricao,r.observacao,r.categoria,r.forma_pagamento,h,j,w,Pt(r.data_vencimento),r.data_vencimento].filter(Boolean).some(Ue=>String(Ue).toLowerCase().includes(p))}),Dr=V.filter(r=>M==="pendentes"?r.status!=="pago":M==="pagas"?r.status==="pago":M==="vencidas"?g(r.data_vencimento,r.status):!0).filter(r=>!je||r.centro_custo_id===je).filter(r=>!oe||T(r.data_vencimento)===oe).filter(r=>!(pe&&r.data_vencimento<pe||Z&&r.data_vencimento>Z)).filter(r=>{var F,de;const p=ae.trim().toLowerCase();if(!p)return!0;const h=((F=r.df_centros_custo)==null?void 0:F.nome)||"",j=((de=r.df_filiais)==null?void 0:de.nome)||"",w=r.status==="pago"?"pago":g(r.data_vencimento,r.status)?"vencido":"pendente";return[r.descricao,r.observacao,r.categoria,r.forma_pagamento,h,j,w,Pt(r.data_vencimento),r.data_vencimento].filter(Boolean).some(Ue=>String(Ue).toLowerCase().includes(p))}),Qa=St.reduce((r,p)=>r+Number(p.valor||0),0),To=St.filter(r=>r.status==="pago").reduce((r,p)=>r+Number(p.valor||0),0),Ir=St.filter(r=>g(r.data_vencimento,r.status)).reduce((r,p)=>r+Number(p.valor||0),0),Ar=Qa-To,Sn=St.filter(r=>r.status!=="pago").sort((r,p)=>String(p.created_at||p.data_vencimento||"").localeCompare(String(r.created_at||r.data_vencimento||"")));Te.map(r=>{const p=St.filter(E=>E.centro_custo_id===r.id),h=p.reduce((E,F)=>E+Number(F.valor||0),0),j=p.filter(E=>E.status==="pago").reduce((E,F)=>E+Number(F.valor||0),0),w=p.filter(E=>g(E.data_vencimento,E.status)).reduce((E,F)=>E+Number(F.valor||0),0);return{id:r.id,nome:r.nome,total:h,pago:j,pendente:h-j,vencido:w}}).filter(r=>r.total>0||r.pago>0||r.pendente>0||r.vencido>0);const Br={critico:0,urgente:1,normal:2},qr=B.filter(r=>(!he||r.filial_id===he)&&`${r.titulo||""} ${r.conteudo||""}`.toLowerCase().includes(He.toLowerCase())).sort((r,p)=>{const h=r.concluida?1:0,j=p.concluida?1:0;if(h!==j)return h-j;const w=Br[r.prioridade||"normal"]??2,E=Br[p.prioridade||"normal"]??2;if(w!==E)return w-E;const F=r.data_evento||"9999-12-31",de=p.data_evento||"9999-12-31";return String(F).localeCompare(String(de))}),Ja=qr.filter(r=>!r.concluida),Lr=Ja.filter(r=>r.prioridade==="critico").length,Or=Ja.filter(r=>r.prioridade==="urgente").length;function _n(){return Xe({setMenuAberto:De,setMenuNavegacaoAberto:Et,configWhatsapp:ta,configEmail:aa,configPush:oa,diasAvisoPadrao:ma})}async function En(r){return Vt({conta:r,supabase:D,empresaId:W,diasAvisoPadrao:ma,formatarDataParaBanco:ro})}function Pa(){return gt()}async function zn(){return ea({supabase:D,empresaId:W,mostrarAviso:ee,configWhatsapp:ta,configEmail:aa,configPush:oa,diasAlertaContas:Wa,diasAvisoPadrao:ma,primeiraLetraMaiuscula:kt,converterValor:Ni,formatarDataParaBanco:ro,erroEhSessaoExpirada:S,limparEstadoAutenticacao:Ht,setUsuarioLogado:zt,buscarContas:Kt,fecharConta:Pa})}async function Do(r){return Se({supabase:D,id:r,empresaId:W,buscarContas:Kt,mostrarAviso:ee})}async function Pn(r){return X({supabase:D,id:r,empresaId:W,buscarContas:Kt,mostrarAviso:ee})}async function Rn(r){return L({supabase:D,id:r,empresaId:W,avisarErro:Ee,buscarContas:Kt,buscarLixeira:Yt,mostrarAviso:ee})}function Fn(){return v({setMenuAberto:De,setMenuNavegacaoAberto:Et})}function Ur(r){return O(r)}function Za(){return se()}async function $n(){return ye({supabase:D,empresaId:W,mostrarAviso:ee,avisarErro:Ee,buscarNotas:za})}async function Vr(r){return ve({supabase:D,id:r,empresaId:W,avisarErro:Ee,buscarNotas:za,buscarLixeira:Yt,mostrarAviso:ee})}async function Gr(r){return ge({supabase:D,nota:r,empresaId:W,avisarErro:Ee,buscarNotas:za,mostrarAviso:ee})}async function Mn(){if(!W){ee("Usuário sem empresa vinculada.","erro");return}const r=Number(ma),p=Number(Wa),h=Number(kr);if(isNaN(r)||r<0||isNaN(p)||p<0||isNaN(h)||h<0){ee("Informe uma quantidade válida para os dias de alerta.","erro");return}const j={notificacoes_ativas:ko,enviar_whatsapp:ta,enviar_email:aa,enviar_push:oa,dias_aviso_padrao:r,nome_empresa:ra.trim()||null,whatsapp_padrao:Nr.trim()||null,email_padrao:Sr.trim()||null,empresa_id:W};let w;if(Va!=null&&Va.id?w=await D.from("df_configuracoes").update(j).eq("id",Va.id).eq("empresa_id",W).select():w=await D.from("df_configuracoes").insert([j]).select(),w.error){Ee(w.error);return}const E=Array.isArray(w.data)?w.data[0]:w.data;Ga(E);const{error:F}=await D.from("df_configuracoes_alertas").upsert([{empresa_id:W,dias_alerta_contas:p,alertar_contas_vencidas:yr,destacar_contas_criticas:wr,dias_alerta_notas:h,destacar_notas_urgentes:Cr}],{onConflict:"empresa_id"});if(F){ee("Configurações principais salvas, mas os alertas globais não foram atualizados: "+F.message,"erro");return}ee("Configurações salvas com sucesso.","info")}async function Tn(r){const{error:p}=await D.from("df_contas").update({excluido:!1,excluido_em:null}).eq("id",r).eq("empresa_id",W);if(p){Ee(p);return}Kt(),Yt(),ee("Conta restaurada com sucesso.","sucesso")}async function Dn(r){return Re({supabase:D,id:r,empresaId:W,avisarErro:Ee,buscarNotas:za,buscarLixeira:Yt,mostrarAviso:ee})}async function In(r){const{error:p}=await D.from("df_contas").delete().eq("id",r.id).eq("empresa_id",W);if(p){Ee(p);return}Yt(),ee("Conta excluída definitivamente.","sucesso")}async function An(r){return le({supabase:D,nota:r,empresaId:W,avisarErro:Ee,buscarLixeira:Yt,mostrarAviso:ee})}async function Bn(){if(!W){ee("Usuário sem empresa vinculada.","erro");return}const r=kt(xt.trim());if(!r){ee("Digite o centro de custo.","erro");return}if(Te.some(w=>String(w.nome||"").trim().toLowerCase()===r.toLowerCase())){ee("Este centro de custo já existe nesta empresa.","erro");return}const{data:h,error:j}=await D.from("df_centros_custo").insert([{nome:r,empresa_id:W}]).select("*").single();if(j){Ee(j);return}Je(""),tt(w=>[...w.filter(F=>F.id!==h.id),h].sort((F,de)=>String(F.nome||"").localeCompare(String(de.nome||"")))),await Xa(W),ee("Centro de custo criado com sucesso.","sucesso")}async function qn(r){const{error:p}=await D.from("df_centros_custo").delete().eq("id",r).eq("empresa_id",W);if(p){ee("Não foi possível excluir. Verifique se existem contas usando este centro.","erro");return}Xa(),Kt()}function Ln(){const r=["Descricao","Valor","Vencimento","Status","Filial","Centro"],p=St.map(F=>{var de,Ue;return[F.descricao||"",Number(F.valor||0).toFixed(2).replace(".",","),Pt(F.data_vencimento),g(F.data_vencimento,F.status)?"vencido":F.status,((de=F.df_filiais)==null?void 0:de.nome)||"",((Ue=F.df_centros_custo)==null?void 0:Ue.nome)||""]}),h=[r,...p].map(F=>F.map(de=>`"${String(de).replaceAll('"','""')}"`).join(";")).join(`
`),j=new Blob([h],{type:"text/csv;charset=utf-8;"}),w=URL.createObjectURL(j),E=document.createElement("a");E.href=w,E.download="relatorio-contas.csv",E.click(),URL.revokeObjectURL(w)}function On(){const r=w=>String(w??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;"),p=St.map(w=>{var F,de;const E=g(w.data_vencimento,w.status)?"Vencido":w.status==="pago"?"Pago":"Pendente";return`
        <tr>
          <td>
            <strong>${r(w.descricao||"-")}</strong>
            ${w.observacao?`<small>Obs: ${r(w.observacao)}</small>`:""}
          </td>
          <td>${r(((F=w.df_filiais)==null?void 0:F.nome)||"-")}</td>
          <td>${r(((de=w.df_centros_custo)==null?void 0:de.nome)||"-")}</td>
          <td>${r(Pt(w.data_vencimento))}</td>
          <td><span class="status ${E.toLowerCase()}">${E}</span></td>
          <td class="valor">${r(it(w.valor))}</td>
        </tr>
      `}).join(""),h=`
      <!doctype html>
      <html lang="pt-BR">
        ...
        <body>
          <div class="page">
            ...
            <section class="summary">
              <div class="box"><span>Total</span><strong>${r(it(Qa))}</strong></div>
              <div class="box"><span>Pago</span><strong>${r(it(To))}</strong></div>
              <div class="box"><span>Pendente</span><strong>${r(it(Ar))}</strong></div>
              <div class="box"><span>Vencido</span><strong>${r(it(Ir))}</strong></div>
            </section>
    ...
    `,j=window.open("","_blank");if(!j){ee("O navegador bloqueou a visualização do PDF. Permita pop-ups para abrir o relatório.","erro");return}j.document.open(),j.document.write(h),j.document.close()}function Un(){I(""),Y("todas"),ce(""),Ce(""),y(""),A(""),K("")}function wt({titulo:r,mensagem:p,textoConfirmar:h="Confirmar",tipo:j="padrao",acao:w}){_r({aberto:!0,titulo:r,mensagem:p,textoConfirmar:h,tipo:j,acao:w})}function eo(){_r({aberto:!1,titulo:"",mensagem:"",textoConfirmar:"Confirmar",tipo:"padrao",acao:null})}async function Wr(){typeof yt.acao=="function"&&await yt.acao(),eo()}function Hr(r){return String(r||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim()}function Ra(r,p){const h=Object.entries(r||{});for(const j of p){const w=Hr(j),E=h.find(([F])=>Hr(F)===w);if(E)return E[1]}return""}function Vn(r){if(!r)return null;if(typeof r=="number"){const h=new Date(Date.UTC(1899,11,30));return h.setUTCDate(h.getUTCDate()+r),h.toISOString().slice(0,10)}const p=String(r).trim();if(!p)return null;if(/^\d{4}-\d{2}-\d{2}$/.test(p))return p;if(/^\d{2}\/\d{2}\/\d{4}$/.test(p)){const[h,j,w]=p.split("/");return`${w}-${j}-${h}`}return ro(p)}function Gn(r){if(typeof r=="number")return r;const p=String(r||"").replace(/R\$/gi,"").replace(/\./g,"").replace(",",".").trim();return Number(p||0)}function Kr(r){const p=[];let h="",j=!1;for(let w=0;w<r.length;w+=1){const E=r[w],F=r[w+1];if(E==='"'&&F==='"'){h+='"',w+=1;continue}if(E==='"'){j=!j;continue}if((E===";"||E===",")&&!j){p.push(h.trim()),h="";continue}h+=E}return p.push(h.trim()),p}function Wn(r){const p=String(r||"").replace(/^﻿/,"").split(/\r?\n/).filter(j=>j.trim());if(p.length<2)return[];const h=Kr(p[0]);return p.slice(1).map(j=>{const w=Kr(j);return h.reduce((E,F,de)=>(E[F]=w[de]||"",E),{})})}async function Hn(r){var w,E;const p=(w=r.target.files)==null?void 0:w[0];if(Mo(p||null),Ha([]),_a(""),!p)return;if(((E=p.name.split(".").pop())==null?void 0:E.toLowerCase())!=="csv"){_a("Para evitar erro no deploy, esta versão importa CSV. No Excel, use: Arquivo > Salvar como > CSV UTF-8.");return}const j=new FileReader;j.onload=F=>{const Ue=Wn(F.target.result).map((ct,ke)=>{const Le=Ra(ct,["descricao","descrição","conta","nome","fornecedor"]),Lt=Ra(ct,["valor","valor pago","total"]),na=Ra(ct,["vencimento","data vencimento","data_vencimento","data"]),$t=String(Ra(ct,["status","situacao","situação"])||"pendente").toLowerCase(),sa=Ra(ct,["centro","centro de custo","categoria","setor"]);return{linha:ke+2,descricao:kt(String(Le||"").trim()),valor:Gn(Lt),data_vencimento:Vn(na),status:$t.includes("pag")?"pago":"pendente",centro:String(sa||"").trim()}}).filter(ct=>ct.descricao||ct.valor||ct.data_vencimento);Ha(Ue),_a(`${Ue.length} linha(s) preparada(s) para revisão.`)},j.readAsText(p,"UTF-8")}async function Kn(){if(!W){ee("Usuário sem empresa vinculada.","erro");return}const r=Wt.filter(w=>!w.descricao||!w.valor||!w.data_vencimento);if(r.length>0){ee(`Existem ${r.length} linha(s) sem descrição, valor ou vencimento. Corrija a planilha e importe novamente.`,"erro");return}const p={...Object.fromEntries(Te.map(w=>[w.nome.toLowerCase(),w.id]))};for(const w of Wt)if(w.centro&&!p[w.centro.toLowerCase()]){const{data:E,error:F}=await D.from("df_centros_custo").insert([{nome:kt(w.centro),empresa_id:W}]).select();if(F){Ee(F);return}const de=Array.isArray(E)?E[0]:E;p[w.centro.toLowerCase()]=de==null?void 0:de.id}const h=Wt.map(w=>({descricao:w.descricao,valor:w.valor,data_vencimento:w.data_vencimento,vencimento:w.data_vencimento,status:w.status,centro_custo_id:w.centro&&p[w.centro.toLowerCase()]||null,enviar_whatsapp:ta,enviar_email:aa,enviar_push:oa,dias_aviso:Number(ma||1),empresa_id:W})),{error:j}=await D.from("df_contas").insert(h);if(j){Ee(j);return}_a(`${h.length} conta(s) importada(s) com sucesso.`),Mo(null),Ha([]),await Ka(W),Fe("contas")}async function to(){Ht(),zt(null),wa(!1),ca("contas"),await D.auth.signOut()}function fa({titulo:r,aberto:p,onClick:h}){const j=String(r||"").split(" "),w=j[0]||"",E=j.slice(1).join(" ")||r;return e.jsxs("button",{style:x.headerExpansivel,onClick:h,children:[e.jsxs("span",{style:{display:"flex",alignItems:"center",gap:10,color:"#0f172a",fontWeight:900,lineHeight:1.1},children:[e.jsx("span",{style:{fontSize:24,lineHeight:1},children:w}),e.jsx("span",{children:E})]}),e.jsx("strong",{style:{color:"#0f172a"},children:p?"−":"+"})]})}function Fe(r){var p;De(!1),Et(!1),ca(r),((p=window.history.state)==null?void 0:p.tela)!==r&&window.history.pushState({tela:r},"",window.location.href)}function Yn(){Fe("dashboard")}function Xt(){var h,j;const r=xo||((h=R==null?void 0:R.user_metadata)==null?void 0:h.name)||((j=R==null?void 0:R.user_metadata)==null?void 0:j.full_name);if(r)return String(r).split(" ")[0];const p=(R==null?void 0:R.email)||"usuário";return kt(p.split("@")[0])}function Yr(){var h,j;const r=xo||((h=R==null?void 0:R.user_metadata)==null?void 0:h.name)||((j=R==null?void 0:R.user_metadata)==null?void 0:j.full_name);if(r)return String(r).trim();const p=(R==null?void 0:R.email)||"";return p?kt(p.split("@")[0]):""}function Xr(){Qo(Yr()),ho(!0)}async function Xn(){const r=String(Xo||"").trim().replace(/\s+/g," ");if(r.length<2){ee("Informe um nome com pelo menos 2 caracteres.","erro");return}Jo(!0);try{await us({userId:R==null?void 0:R.id,email:R==null?void 0:R.email,nome:r}),pa(r),zt(p=>p&&{...p,user_metadata:{...p.user_metadata||{},name:r,full_name:r}}),W&&await ua(W),ho(!1),ee("Perfil atualizado com sucesso.","sucesso")}catch(p){Ee(p,"Não foi possível atualizar o perfil.")}finally{Jo(!1)}}function Qn(){return yt.aberto?e.jsx("div",{style:x.overlayConfirmacao,children:e.jsxs("div",{style:x.modalConfirmacao,children:[e.jsx("div",{style:x.confirmacaoIcone,children:yt.tipo==="perigo"?"⚠️":yt.tipo==="sucesso"?"✅":"ℹ️"}),e.jsx("h3",{style:x.confirmacaoTitulo,children:yt.titulo}),e.jsx("p",{style:x.confirmacaoTexto,children:yt.mensagem}),e.jsxs("div",{style:x.confirmacaoAcoes,children:[e.jsx("button",{style:x.btnConfirmarCancelar,onClick:eo,children:"Cancelar"}),e.jsx("button",{style:{...x.btnConfirmarAcao,background:yt.tipo==="perigo"?"#dc3545":yt.tipo==="sucesso"?"#14b8a6":"#0d6efd"},onClick:Wr,children:yt.textoConfirmar})]})]})}):null}function Qr(){return e.jsxs(e.Fragment,{children:[J&&e.jsx(Ml,{styles:x,editandoContaId:_e,descricao:we,setDescricao:U,valor:fe,setValor:Ae,dataVencimento:C,setDataVencimento:be,centroCustoId:ze,setCentroCustoId:me,centros:Te,filialId:$,setFilialId:re,filiais:xe,observacaoConta:et,setObservacaoConta:st,contaRecorrente:Oe,setContaRecorrente:It,tipoRecorrencia:Ye,setTipoRecorrencia:lt,diaVencimentoRecorrencia:Be,setDiaVencimentoRecorrencia:pt,fecharConta:Pa,salvarConta:zn,primeiraLetraMaiuscula:kt,limitarDataInput:Io,formatarDataParaBanco:ro,fecharNota:Za,setModalCentro:ft,setMenuAberto:De,setMenuNavegacaoAberto:Et}),Ke&&e.jsx(Tl,{styles:x,editandoNotaId:ot,tituloNota:bt,setTituloNota:Rt,prioridadeNota:Qe,setPrioridadeNota:mt,dataEventoNota:Bt,setDataEventoNota:qt,conteudoNota:Gt,setConteudoNota:At,filialNotaId:ut,setFilialNotaId:vt,filiais:xe,salvarNota:$n,fecharNota:Za,fecharConta:Pa,setModalCentro:ft,setMenuAberto:De,setMenuNavegacaoAberto:Et,primeiraLetraMaiuscula:kt,limitarDataInput:Io}),Ct&&e.jsx(Dl,{styles:x,novoCentro:xt,setNovoCentro:Je,salvarCentro:Bn,centros:Te,abrirConfirmacao:wt,excluirCentro:qn,fecharConta:Pa,fecharNota:Za,setModalCentro:ft,setMenuAberto:De,setMenuNavegacaoAberto:Et}),Yi&&e.jsx(Al,{nome:Xo,setNome:Qo,email:R==null?void 0:R.email,salvando:Xi,onClose:()=>ho(!1),onSave:Xn})]})}function Jr(){return e.jsx(zl,{styles:x,nomeEmpresa:ra,navegarPara:Fe,menuNavegacaoAberto:Ze,setMenuNavegacaoAberto:Et,canSwitchCompany:Ne==null?void 0:Ne.canSwitchCompany,empresasDisponiveis:_,empresaId:W,trocarEmpresaAtiva:Ya,trocandoEmpresa:Ca,nomeUsuario:Xt,abrirPerfilUsuario:Xr,sairDoSistema:to})}function Zr(){return e.jsxs(e.Fragment,{children:[Ft&&e.jsxs("div",{className:"global-fab-menu",style:x.menuFab,onClick:r=>r.stopPropagation(),children:[e.jsxs("button",{style:x.menuItem,type:"button",onClick:r=>{r.preventDefault(),r.stopPropagation(),_n()},"aria-label":"Nova conta",children:[e.jsx("span",{style:x.menuItemIcone,children:"💰"}),e.jsx("span",{style:x.menuItemTexto,children:"Nova conta"})]}),e.jsxs("button",{style:x.menuItem,type:"button",onClick:r=>{r.preventDefault(),r.stopPropagation(),Fn()},"aria-label":"Nova nota",children:[e.jsx("span",{style:x.menuItemIcone,children:"📝"}),e.jsx("span",{style:x.menuItemTexto,children:"Nova nota"})]})]}),e.jsx("button",{className:"global-fab",style:x.fab,onClick:r=>{r.stopPropagation(),De(!Ft)},children:Ft?"×":"+"})]})}function ei(){return e.jsx("style",{children:`
      ...
      `})}function at(r){return e.jsx(ci,{contas:V,contasFiltradas:St,navegarPara:Fe,children:e.jsxs("div",{className:"app-page app-frame",style:x.page,children:[e.jsx("style",{children:`
      ...
      `}),ti(),ei(),e.jsx(ui,{}),Jn(),Jr(),ai(),oi(),e.jsx("main",{className:"app-frame-content",children:r}),Zr(),e.jsx(pi,{}),e.jsx(mi,{}),Qn(),Qr(),e.jsx(di,{visible:i}),e.jsx(qo,{toast:n,onClose:l})]})})}function ao({icon:r,title:p,description:h}){return e.jsxs("div",{className:"empty-state-card",children:[e.jsx("div",{className:"empty-state-icon",children:r}),e.jsx("strong",{children:p}),e.jsx("p",{children:h})]})}function Zn(r){Hi(p=>({...p,[r]:!p[r]}))}function ai(){return e.jsx(Fl,{sidebarCompacta:Vi,setSidebarCompacta:Gi,nomeUsuario:Xt,nomeUsuarioAtual:Xt(),normalizarPerfil:Nt,perfilUsuario:Aa,menuSections:Fr(),telaAtual:rt,navegarPara:Fe,gruposMenu:Wi,toggleGrupoMenu:Zn,sairDoSistema:to})}function oi(){return e.jsx($l,{visible:Ze,styles:x,setMenuNavegacaoAberto:Et,nomeUsuario:Xt,nomeUsuarioAtual:Xt(),normalizarPerfil:Nt,perfilUsuario:Aa,menuSections:Fr(),navegarPara:Fe,sairDoSistema:to,canSwitchCompany:Ne==null?void 0:Ne.canSwitchCompany,empresasDisponiveis:_,empresaId:W,trocarEmpresaAtiva:Ya,trocandoEmpresa:Ca,abrirPerfilUsuario:Xr})}if(Ki)return e.jsx("div",{style:x.page,children:e.jsx("h2",{children:"Carregando..."})});if(!R)return e.jsxs(e.Fragment,{children:[e.jsx(El,{onLogin:zt}),e.jsx(qo,{toast:n,onClose:l})]});if(Zo)return e.jsxs("div",{style:x.page,children:[e.jsx("h2",{children:"⚠️ Empresa não vinculada"}),e.jsx("p",{children:Zo}),e.jsx("button",{style:x.btnSair,onClick:to,children:"Sair"})]});if(rt==="contas")return at(e.jsx(Zs,{styles:x,busca:ae,setBusca:I,mostrarFiltros:tn,setMostrarFiltros:an,limparFiltros:Un,imprimirPDF:On,exportarCSV:Ln,filtroStatus:M,setFiltroStatus:Y,centros:Te,filtroCentro:je,setFiltroCentro:ce,filiais:xe,filtroFilial:he,setFiltroFilial:Ce,filtroMes:oe,setFiltroMes:y,dataInicial:pe,setDataInicial:A,dataFinal:Z,setDataFinal:K,limitarDataInput:Io,contasFiltradas:St,total:Qa,formatarValor:it,loading:Q,HeaderExpansivel:fa,mostrarContas:on,setMostrarContas:rn,estaVencida:g,formatarData:Pt,formatarTipoRecorrencia:Pi,obterTipoRecorrenciaConta:zi,abrirConfirmacao:wt,marcarComoPago:Do,voltarParaPendente:Pn,abrirEdicaoConta:En,excluirConta:Rn,navegarPara:Fe}));if(rt==="relatorios")return at(e.jsx(Bs,{voltar:()=>Fe("contas"),empresaId:W,usuario:R,mostrarAviso:ee}));if(rt==="notas")return at(e.jsx(tl,{styles:x,navegarPara:Fe,notasFiltradas:qr,notasPendentes:Ja,notasCriticas:Lr,notasUrgentes:Or,buscaNota:He,setBuscaNota:qe,formatarData:Pt,alternarNotaConcluida:Gr,abrirEdicaoNota:Ur,abrirConfirmacao:wt,excluirNota:Vr,loading:Q,nomeUsuario:Xt(),filiais:xe,filtroFilial:he,setFiltroFilial:Ce,contasOperacionaisFiliais:Dr}));if(rt==="importar")return at(e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:x.titulo,children:"📥 Importar planilha"}),e.jsx("button",{style:x.btnCinza,onClick:()=>Fe("dashboard"),children:"← Voltar"}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx("h2",{style:x.subtitulo,children:"1. Enviar arquivo"}),e.jsx("p",{style:x.textoNota,children:"Importe sua planilha do ano em CSV para alimentar o histórico e liberar os relatórios do app."}),e.jsxs("label",{style:x.uploadExcelBox,children:[e.jsx("strong",{children:"📊 Selecionar arquivo CSV"}),e.jsx("small",{children:"No Excel: Arquivo > Salvar como > CSV UTF-8"}),e.jsx("input",{type:"file",accept:".csv",onChange:Hn,style:{display:"none"}})]}),Er&&e.jsxs("p",{style:x.textoNota,children:["Arquivo: ",e.jsx("strong",{children:Er.name})]}),zr&&e.jsx("p",{style:x.alertaSucesso,children:zr})]}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx("h2",{style:x.subtitulo,children:"2. Colunas esperadas"}),e.jsxs("div",{style:x.importDicasGrid,children:[e.jsx("span",{children:"Descrição"}),e.jsx("span",{children:"Valor"}),e.jsx("span",{children:"Vencimento"}),e.jsx("span",{children:"Status"}),e.jsx("span",{children:"Centro de custo"})]}),e.jsx("p",{style:x.textoAjuda,children:"O app também aceita nomes parecidos, como Conta, Data, Categoria e Situação."})]}),Wt.length>0&&e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx("h2",{style:x.subtitulo,children:"3. Revisar dados"}),e.jsx("div",{style:x.previewImportacao,children:Wt.slice(0,8).map(r=>e.jsxs("div",{style:x.previewLinha,children:[e.jsx("strong",{children:r.descricao||`Linha ${r.linha}`}),e.jsxs("small",{children:[Pt(r.data_vencimento)," • ",it(r.valor)," • ",r.status," • ",r.centro||"Sem centro"]})]},r.linha))}),Wt.length>8&&e.jsxs("small",{style:x.textoAjuda,children:["Mostrando 8 de ",Wt.length," linhas."]}),e.jsxs("button",{style:x.btnSalvar,onClick:Kn,children:["Importar ",Wt.length," conta(s)"]})]})]}));if(rt==="master-empresas")return Ne!=null&&Ne.canManageCompanies?at(e.jsx(dl,{styles:x,usuarioLogado:R,nomeUsuarioCompleto:Yr,empresaId:W,empresasDisponiveis:_,trocarEmpresaAtiva:Ya,trocandoEmpresa:Ca,mostrarAviso:ee,onEmpresasAtualizadas:hn,voltarPainel:Yn,abaInicial:"empresas"})):at(e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:x.titulo,children:"🏢 Painel Master"}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx("h2",{style:x.subtitulo,children:"Acesso restrito"}),e.jsx("p",{style:x.textoNota,children:"Seu perfil atual não permite acessar o painel master."}),e.jsx("button",{style:x.btnCinza,onClick:()=>Fe("dashboard"),children:"← Voltar"})]})]}));if(rt==="onboarding")return Ea()?at(e.jsx(yl,{styles:x,empresaId:W,empresaNome:ra,filiais:xe,centros:Te,contas:V,mostrarAviso:ee,onRefresh:()=>Ka(W),voltarPainel:()=>Fe("configuracoes"),abrirDashboard:()=>Fe("dashboard")})):at(e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:x.titulo,children:"🚀 Onboarding SaaS"}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx("h2",{style:x.subtitulo,children:"Acesso restrito"}),e.jsx("p",{style:x.textoNota,children:"Seu perfil atual não permite acessar o onboarding."}),e.jsx("button",{style:x.btnCinza,onClick:()=>Fe("dashboard"),children:"← Voltar"})]})]}));if(rt==="billing")return Ea()?at(e.jsx(vl,{styles:x,empresaId:W,empresaNome:ra,filiais:xe,usuarios:La,mostrarAviso:ee,podeEditar:ia(),voltarPainel:()=>Fe("configuracoes")})):at(e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:x.titulo,children:"💼 Billing"}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx("h2",{style:x.subtitulo,children:"Acesso restrito"}),e.jsx("p",{style:x.textoNota,children:"Seu perfil atual não permite acessar o billing."}),e.jsx("button",{style:x.btnCinza,onClick:()=>Fe("dashboard"),children:"← Voltar"})]})]}));if(rt==="filiais")return Ea()?at(e.jsx(pl,{styles:x,empresaId:W,empresaNome:ra,mostrarAviso:ee,voltarPainel:()=>Fe("configuracoes")})):at(e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:x.titulo,children:"🏬 Filiais"}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx("h2",{style:x.subtitulo,children:"Acesso restrito"}),e.jsx("p",{style:x.textoNota,children:"Seu perfil atual não permite gerenciar filiais."}),e.jsx("button",{style:x.btnCinza,onClick:()=>Fe("dashboard"),children:"← Voltar"})]})]}));if(rt==="usuarios")return at(e.jsx(kl,{styles:x,EmptyState:ao,podeAcessarConfiguracoes:Ea,podeAdministrarUsuarios:ia,navegarPara:Fe,usuarioLogado:R,normalizarPerfil:Nt,perfilUsuario:Aa,permissoesUsuario:Ne,novoEmailUsuario:ur,setNovoEmailUsuario:fr,novaSenhaUsuario:Sa,setNovaSenhaUsuario:xr,confirmarNovaSenhaUsuario:hr,setConfirmarNovaSenhaUsuario:gr,salvarMeuEmail:kn,salvarMinhaSenha:Cn,empresasDisponiveis:_,empresaId:W,trocandoEmpresa:Ca,trocarEmpresaAtiva:Ya,buscarUsuariosEmpresa:ua,primeiraLetraMaiuscula:kt,nomeConviteUsuario:sr,setNomeConviteUsuario:lr,emailConviteUsuario:ir,setEmailConviteUsuario:nr,senhaConviteUsuario:pr,setSenhaConviteUsuario:mr,perfilConviteUsuario:dr,setPerfilConviteUsuario:cr,criandoUsuarioManual:tr,adicionarUsuarioEmpresa:gn,usuariosCarregando:Qi,usuariosInicializados:Ji,usuariosErro:Zi,usuariosEmpresa:La,filiais:xe,filiaisUsuariosEmpresa:or,salvandoFilialUsuario:en,liberarTodasFiliaisUsuario:yn,alternarFilialUsuario:jn,atualizarPerfilUsuarioEmpresa:vn,enviarAcessoUsuarioEmpresa:bn,removerUsuarioEmpresa:wn}));if(rt==="configuracoes")return Ea()?at(e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:x.titulo,children:"⚙️ Configurações"}),e.jsx("button",{style:x.btnCinza,onClick:()=>Fe("dashboard"),children:"← Voltar"}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx(fa,{titulo:"🔔 Notificações",aberto:yo,onClick:()=>pn(!yo)}),yo&&e.jsxs(e.Fragment,{children:[e.jsxs("label",{className:"checkbox-row-fix",style:x.switchLinha,children:[e.jsxs("div",{children:[e.jsx("strong",{children:"Notificações ativas"}),e.jsx("small",{children:"Controle geral dos disparos automáticos da empresa."})]}),e.jsx("input",{type:"checkbox",checked:ko,onChange:r=>Co(r.target.checked)})]}),e.jsxs("div",{style:x.configResumo,children:[e.jsx("strong",{children:"Contas"}),e.jsx("span",{children:"Regras aplicadas automaticamente em todas as contas, sem checkbox individual no formulário."})]}),e.jsx("input",{style:x.input,type:"number",min:"0",placeholder:"Avisar contas antes do vencimento. Ex: 1",value:Wa,onChange:r=>{So(r.target.value),No(r.target.value)}}),e.jsxs("label",{className:"checkbox-row-fix",style:x.switchLinha,children:[e.jsxs("div",{children:[e.jsx("strong",{children:"Notificar contas vencidas"}),e.jsx("small",{children:"Exibir contas em atraso nas notificações e destaques."})]}),e.jsx("input",{type:"checkbox",checked:yr,onChange:r=>_o(r.target.checked)})]}),e.jsxs("label",{className:"checkbox-row-fix",style:x.switchLinha,children:[e.jsxs("div",{children:[e.jsx("strong",{children:"Destacar contas críticas"}),e.jsx("small",{children:"Dar prioridade visual para contas vencidas ou muito próximas do vencimento."})]}),e.jsx("input",{type:"checkbox",checked:wr,onChange:r=>Eo(r.target.checked)})]}),e.jsxs("div",{style:x.configResumo,children:[e.jsx("strong",{children:"Notas"}),e.jsx("span",{children:"Regras para pendências e prioridades do bloco de notas."})]}),e.jsx("input",{style:x.input,type:"number",min:"0",placeholder:"Avisar notas pendentes após quantos dias. Ex: 3",value:kr,onChange:r=>zo(r.target.value)}),e.jsxs("label",{className:"checkbox-row-fix",style:x.switchLinha,children:[e.jsxs("div",{children:[e.jsx("strong",{children:"Destacar notas urgentes"}),e.jsx("small",{children:"Manter notas urgentes e críticas no topo do acompanhamento."})]}),e.jsx("input",{type:"checkbox",checked:Cr,onChange:r=>Po(r.target.checked)})]}),e.jsxs("div",{style:x.configResumo,children:[e.jsx("strong",{children:"Canais preparados"}),e.jsxs("span",{children:["WhatsApp: ",ta?"Ligado":"Desligado"," • E-mail: ",aa?"Ligado":"Desligado"," • Push: ",oa?"Ligado":"Desligado"]})]})]})]}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx(fa,{titulo:"🏢 Dados do negócio",aberto:jo,onClick:()=>cn(!jo)}),jo&&e.jsxs(e.Fragment,{children:[e.jsx("input",{style:x.input,placeholder:"Nome da empresa",value:ra,onChange:r=>Ro(kt(r.target.value))}),e.jsx("input",{style:x.input,placeholder:"WhatsApp padrão. Ex: 5511999999999",value:Nr,onChange:r=>Fo(r.target.value)}),e.jsx("input",{style:x.input,placeholder:"E-mail padrão",value:Sr,onChange:r=>$o(r.target.value)})]})]}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx(fa,{titulo:"🔁 Recorrências",aberto:wo,onClick:()=>un(!wo)}),wo&&e.jsxs(e.Fragment,{children:[e.jsx("p",{style:x.textoNota,children:"As recorrências são cadastradas e editadas dentro de Nova Conta ou Editar Conta, mantendo o mesmo padrão de campos da conta original."}),e.jsxs("div",{style:x.configResumo,children:[e.jsx("strong",{children:"Padrão atual"}),e.jsx("span",{children:"Frequência mensal • dia de vencimento configurável • geração automática no mês vigente quando ainda não existir."})]})]})]}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx(fa,{titulo:"🏷 Centros de custo",aberto:Ua,onClick:()=>mn(!Ua)}),Ua&&e.jsxs(e.Fragment,{children:[e.jsx("p",{style:x.textoNota,children:"Cadastre e gerencie os centros usados nas contas e nos relatórios."}),e.jsxs("div",{style:x.configResumo,children:[e.jsxs("span",{children:["Total de centros: ",Te.length]}),e.jsx("span",{children:"Uso nos filtros e relatórios"})]}),e.jsx("button",{style:x.btnSalvar,onClick:()=>ft(!0),children:"Gerenciar centros"})]})]}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx(fa,{titulo:"🏬 Filiais / Unidades",aberto:Ua,onClick:()=>Fe("filiais")}),e.jsx("p",{style:x.textoNota,children:"Cadastre lojas, unidades, produção ou delivery dentro da empresa ativa. Na próxima fase, contas poderão ser vinculadas a uma filial."}),e.jsxs("div",{style:x.configResumo,children:[e.jsx("span",{children:"Organização: empresa → filial → centro de custo → conta"}),e.jsx("span",{children:"Isolamento por empresa ativo"})]}),e.jsx("button",{style:x.btnSalvar,onClick:()=>Fe("filiais"),children:"Gerenciar filiais"})]}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx("h2",{style:x.subtitulo,children:"🧠 Como o sistema vai usar"}),e.jsx("p",{style:x.textoNota,children:"O envio automático seguirá as regras globais da empresa. Os formulários ficam mais limpos e as contas/notas passam a obedecer ao mesmo padrão configurado aqui."}),e.jsxs("div",{style:x.configResumo,children:[e.jsxs("span",{children:["Geral: ",ko?"Ligado":"Desligado"]}),e.jsxs("span",{children:["WhatsApp: ",ta?"Ligado":"Desligado"]}),e.jsxs("span",{children:["E-mail: ",aa?"Ligado":"Desligado"]}),e.jsxs("span",{children:["Push: ",oa?"Ligado":"Desligado"]})]})]}),e.jsx("button",{style:x.btnSalvar,onClick:Mn,children:"Salvar configurações"})]})):at(e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:x.titulo,children:"⚙️ Configurações"}),e.jsxs("section",{style:x.cardConfiguracao,children:[e.jsx("h2",{style:x.subtitulo,children:"Acesso restrito"}),e.jsx("p",{style:x.textoNota,children:"Seu perfil atual não permite acessar configurações."}),e.jsx("button",{style:x.btnCinza,onClick:()=>Fe("contas"),children:"← Voltar"})]})]}));if(rt==="agenda"){let r=function({titulo:ke,total:Le,lista:Lt,cor:na}){return e.jsxs("section",{style:x.cardAgenda,children:[e.jsxs("div",{style:x.cardTopo,children:[e.jsx("strong",{children:ke}),e.jsx("span",{children:it(Le)})]}),Lt.length===0&&e.jsx(ao,{icon:"✅",title:"Agenda limpa",description:"Não há contas neste grupo de vencimento no momento."}),Lt.map($t=>{var ri;const sa=ha($t.data_vencimento);return e.jsxs("div",{style:{...x.itemAgenda,borderLeft:`5px solid ${na}`},children:[e.jsxs("div",{children:[e.jsx("strong",{children:$t.descricao}),e.jsxs("div",{style:x.cardInfo,children:[Pt($t.data_vencimento)," • ",((ri=$t.df_centros_custo)==null?void 0:ri.nome)||"Sem centro"]}),e.jsx("small",{style:sa<0?x.textoVencidoAgenda:x.textoAgenda,children:sa<0?`Vencida há ${Math.abs(sa)} dia(s)`:sa===0?"Vence hoje":`Vence em ${sa} dia(s)`})]}),e.jsxs("div",{style:x.agendaDireita,children:[e.jsx("strong",{children:it($t.valor)}),e.jsx("button",{style:x.btnPago,onClick:()=>wt({titulo:"Confirmar pagamento",mensagem:`Deseja marcar a conta ${$t.descricao} como paga?`,textoConfirmar:"Marcar como pago",tipo:"sucesso",acao:()=>Do($t.id)}),children:"Pago"})]})]},$t.id)})]})};const p=[...V].filter(ke=>ke.status!=="pago").sort((ke,Le)=>Ta(ke.data_vencimento)-Ta(Le.data_vencimento)),h=p.filter(ke=>ha(ke.data_vencimento)<0),j=p.filter(ke=>ha(ke.data_vencimento)===0),w=p.filter(ke=>{const Le=ha(ke.data_vencimento);return Le>0&&Le<=7}),E=p.filter(ke=>ha(ke.data_vencimento)>7&&Us(ke.data_vencimento)),F=h.reduce((ke,Le)=>ke+Number(Le.valor||0),0),de=j.reduce((ke,Le)=>ke+Number(Le.valor||0),0),Ue=w.reduce((ke,Le)=>ke+Number(Le.valor||0),0),ct=E.reduce((ke,Le)=>ke+Number(Le.valor||0),0);return at(e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:x.titulo,children:"📅 Agenda Financeira"}),e.jsx("button",{className:"btn-back-page",style:x.btnCinza,onClick:()=>Fe("dashboard"),children:"← Voltar"}),e.jsxs("section",{className:"agenda-summary-grid",style:x.resumo,children:[e.jsxs("div",{style:x.boxVencido,children:[e.jsx("span",{children:"Vencidas"}),e.jsx("strong",{children:it(F)})]}),e.jsxs("div",{style:x.boxPendente,children:[e.jsx("span",{children:"Hoje"}),e.jsx("strong",{children:it(de)})]}),e.jsxs("div",{style:x.boxTotal,children:[e.jsx("span",{children:"7 dias"}),e.jsx("strong",{children:it(Ue)})]}),e.jsxs("div",{style:x.boxPago,children:[e.jsx("span",{children:"Mês"}),e.jsx("strong",{children:it(ct)})]})]}),e.jsxs("div",{className:"agenda-page-grid",children:[e.jsx(r,{titulo:"🚨 Vencidas",total:F,lista:h,cor:"#dc3545"}),e.jsx(r,{titulo:"📌 Vencem hoje",total:de,lista:j,cor:"#ffc107"}),e.jsx(r,{titulo:"🗓️ Próximos 7 dias",total:Ue,lista:w,cor:"#0d6efd"}),e.jsx(r,{titulo:"📆 Restante do mês",total:ct,lista:E,cor:"#14b8a6"})]})]}))}return rt==="lixeira"?at(e.jsxs(e.Fragment,{children:[e.jsx("h1",{style:x.titulo,children:"🗑️ Lixeira"}),e.jsx("button",{className:"btn-back-page",style:x.btnCinza,onClick:()=>Fe("dashboard"),children:"← Voltar"}),e.jsxs("section",{className:"trash-section trash-section-accounts",style:x.bloco,children:[e.jsx("h2",{style:x.subtitulo,children:"💰 Contas excluídas"}),ne.length===0&&e.jsx(ao,{icon:"🧹",title:"Nenhuma conta na lixeira",description:"As contas excluídas aparecerão aqui durante o período de quarentena."}),ne.map(r=>{var h;const p=P(r.excluido_em);return z(r.excluido_em),e.jsxs("div",{className:"trash-card trash-card-account",style:x.cardLixeira,children:[e.jsxs("div",{style:x.cardTopo,children:[e.jsx("strong",{children:r.descricao}),e.jsx("span",{children:it(r.valor)})]}),e.jsxs("div",{style:x.cardInfo,children:["Venc.: ",Pt(r.data_vencimento)," • Centro: ",((h=r.df_centros_custo)==null?void 0:h.nome)||"Sem centro"," • Lixeira há ",p," dia(s)"]}),e.jsxs("small",{style:x.textoLiberado,children:["Excluída há ",p," dia(s). Pode restaurar em até 60 dias. Após 60 dias será removida automaticamente."]}),e.jsxs("div",{style:x.acoes,children:[e.jsx("button",{style:x.btnPago,onClick:()=>wt({titulo:"Restaurar conta",mensagem:`Deseja restaurar a conta ${r.descricao}?`,textoConfirmar:"Restaurar",tipo:"sucesso",acao:()=>Tn(r.id)}),children:"Restaurar"}),e.jsx("button",{style:x.btnExcluir,onClick:()=>wt({titulo:"Excluir definitivamente",mensagem:`Excluir definitivamente a conta ${r.descricao}? Essa ação não poderá ser desfeita.`,textoConfirmar:"Excluir definitivo",tipo:"perigo",acao:()=>In(r)}),children:"Excluir definitivo"})]})]},r.id)})]}),e.jsxs("section",{className:"trash-section trash-section-notes",style:x.bloco,children:[e.jsx("h2",{style:x.subtitulo,children:"📝 Notas excluídas"}),Pe.length===0&&e.jsx(ao,{icon:"🗒️",title:"Nenhuma nota na lixeira",description:"As notas excluídas aparecerão aqui antes da remoção definitiva."}),Pe.map(r=>{const p=P(r.excluido_em);return z(r.excluido_em),e.jsxs("div",{className:"trash-card trash-card-note",style:x.cardLixeira,children:[e.jsx("strong",{children:r.titulo}),r.conteudo&&e.jsx("p",{style:x.textoNota,children:r.conteudo}),e.jsxs("small",{style:x.textoLiberado,children:["Excluída há ",p," dia(s). Pode restaurar em até 60 dias. Após 60 dias será removida automaticamente."]}),e.jsxs("div",{style:x.acoes,children:[e.jsx("button",{style:x.btnPago,onClick:()=>wt({titulo:"Restaurar nota",mensagem:`Deseja restaurar a nota ${r.titulo}?`,textoConfirmar:"Restaurar",tipo:"sucesso",acao:()=>Dn(r.id)}),children:"Restaurar"}),e.jsx("button",{style:x.btnExcluir,onClick:()=>wt({titulo:"Excluir definitivamente",mensagem:`Excluir definitivamente a nota ${r.titulo}? Essa ação não poderá ser desfeita.`,textoConfirmar:"Excluir definitivo",tipo:"perigo",acao:()=>An(r)}),children:"Excluir definitivo"})]})]},r.id)})]})]})):e.jsx(ci,{contas:V,contasFiltradas:St,navegarPara:Fe,children:e.jsxs("div",{className:"app-page",style:x.page,onClick:()=>{Ft&&De(!1)},children:[e.jsx("style",{children:`
          .print-header,
          .print-footer {
            display: none;
          }
        ...
        `}),ti(),ei(),e.jsx(ui,{}),e.jsxs("div",{className:"print-header",children:[e.jsx("h1",{children:"Relatório Financeiro"}),e.jsxs("p",{children:["Gerado em ",new Date().toLocaleDateString("pt-BR")]})]}),e.jsx("div",{className:"print-footer",children:"Relatório gerado pelo Sistema DF Gestão Financeira"}),Jr(),ai(),oi(),Zr(),e.jsx(pi,{}),e.jsx(mi,{}),e.jsx("style",{children:`
      ...
      `}),e.jsx("section",{className:"dashboard-page-context","aria-label":"Contexto da página",children:e.jsxs("h1",{className:"dashboard-greeting-title",children:["Olá, ",Xt()]})}),e.jsx(Qs,{styles:x,formatarValor:it,total:Qa,pago:To,pendente:Ar,vencido:Ir,contas:St,diferencaDias:ha,navegarPara:Fe,contasAbertasDashboard:Sn,mostrarContasDashboard:nn,setMostrarContasDashboard:sn,busca:ae,setBusca:I,estaVencida:g,formatarData:Pt,abrirConfirmacao:wt,marcarComoPago:Do,notasPendentes:Ja,notasCriticas:Lr,notasUrgentes:Or,mostrarNotas:ln,setMostrarNotas:dn,alternarNotaConcluida:Gr,abrirEdicaoNota:Ur,excluirNota:Vr,loading:Q,nomeUsuario:Xt(),filiais:xe,filtroFilial:he,setFiltroFilial:Ce,contasOperacionaisFiliais:Dr}),Qr(),e.jsx(di,{visible:i}),e.jsx(qo,{toast:n,onClose:l}),e.jsx(Il,{styles:x,confirmacao:yt,fecharConfirmacao:eo,executarConfirmacao:Wr})]})})}es.createRoot(document.getElementById("root")).render(e.jsx(ts.StrictMode,{children:e.jsx(_l,{children:e.jsx(Rd,{})})}));
