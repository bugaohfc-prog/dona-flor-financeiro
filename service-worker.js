const CACHE_NAME = "dona-flor-v26-estruturada";
...
/* ==========================================================
   DONA FLOR - V23 BUILD LIMPA NOTAS + PDF
   Correções profundas:
   - Reescreve o Bloco de notas por completo após todos os patches antigos
   - Remove duplicações visuais no bloco de notas
   - Prioridade vira botão dentro de cada nota, sem select visível
   - PDF não abre nova aba, não usa iframe, não usa document.write
   - PDF abre uma prévia limpa dentro do app; usuário clica Imprimir/Salvar PDF
   - Mantém CSV funcionando
   ========================================================== */
(function(){
  if (window.__DONA_FLOR_V23_BUILD_LIMPA__) return;
  window.__DONA_FLOR_V23_BUILD_LIMPA__ = true;

  let contasRelatorioV23 = [];
  ...
  function cssV23(){
    if(document.getElementById("df-v23-css")) return;
    const style = document.createElement("style");
    style.id = "df-v23-css";
    style.textContent = `
      /* Esconde resíduos de versões anteriores no bloco de notas */
      #notasLista .df-prioridade-box-v223,
      #notasLista .df-prioridade-box-v225,
      #notasLista select,
      #notasLista .df-prioridade-select-original-v223,
      #notasLista .df-prioridade-select-original-v225{
        display:none !important;
      }
      ...
      .df-v23-prio-badge.normal{background:#E0F2FE !important;color:#075985 !important;}
      .df-v23-prio-badge.urgente{background:#FEE2E2 !important;color:#B91C1C !important;}
      .df-v23-prio-badge.critico{background:#7F1D1D !important;color:#fff !important;}
      ...
      .df-v23-btn-edit{background:#2563EB !important;color:#fff !important;}
      .df-v23-btn-del{background:#B91C1C !important;color:#fff !important;}
      ...
      .df-v23-btn-prio.normal{background:#ECFDF5 !important;color:#047857 !important;border-color:#A7F3D0 !important;}
      .df-v23-btn-prio.urgente{background:#FEE2E2 !important;color:#B91C1C !important;border-color:#FECACA !important;}
      .df-v23-btn-prio.critico{background:#7F1D1D !important;color:#fff !important;border-color:#450A0A !important;}
      ...
      .df-v23-prio-box.open .df-v23-prio-menu{
        display:block !important;
      }
      ...
      .df-v23-prio-option:last-child{border-bottom:0 !important;}
      ...
      .df-v23-report-bg.open{display:flex !important;}
      ...
      .df-v23-report-actions .light{
        background:#fff !important;
        color:#000 !important;
      }

      .df-v23-report h1{color:#0f766e !important;margin:0 !important;font-size:24px !important;}
      .df-v23-report h2{font-size:18px !important;margin:18px 0 8px !important;}
      .df-v23-report .sub{color:#64748b !important;font-size:12px !important;margin-top:4px !important;}
      .df-v23-report .cards{display:grid !important;grid-template-columns:repeat(4,1fr) !important;gap:8px !important;margin:12px 0 !important;}
      .df-v23-report .card-mini{border:1px solid #e2e8f0 !important;border-radius:10px !important;padding:10px !important;background:#fafaf9 !important;}
      .df-v23-report .label{font-size:10px !important;text-transform:uppercase !important;color:#64748b !important;font-weight:bold !important;}
      .df-v23-report .num{font-size:17px !important;font-weight:bold !important;margin-top:3px !important;}
      .df-v23-report .centros{display:grid !important;grid-template-columns:repeat(2,1fr) !important;gap:8px !important;margin:8px 0 14px !important;}
      .df-v23-report .centro{display:flex !important;justify-content:space-between !important;border:1px solid #e2e8f0 !important;border-radius:10px !important;padding:8px !important;}
      .df-v23-report .centro small{display:block !important;color:#64748b !important;}
      .df-v23-report table{width:100% !important;border-collapse:collapse !important;font-size:12px !important;}
      .df-v23-report th{background:#0f766e !important;color:white !important;text-align:left !important;padding:7px !important;}
      .df-v23-report td{border-bottom:1px solid #e2e8f0 !important;padding:7px !important;vertical-align:top !important;}
      .df-v23-report .valor{font-weight:bold !important;white-space:nowrap !important;}
      .df-v23-report .status{border-radius:999px !important;padding:3px 7px !important;font-weight:bold !important;font-size:11px !important;display:inline-block !important;}
      .df-v23-report .pago{background:#dcfce7 !important;color:#15803d !important;}
      .df-v23-report .aberto{background:#fef3c7 !important;color:#92400e !important;}

      @media(max-width:760px){
        .df-v23-report-box{padding:14px !important;border-radius:16px !important;}
        .df-v23-report-actions{justify-content:flex-start !important;}
        .df-v23-report .cards{grid-template-columns:1fr 1fr !important;}
        .df-v23-report .centros{grid-template-columns:1fr !important;}
        .df-v23-report table{font-size:11px !important;}
      }

      @media print{
        body > *:not(#df-v23-report-bg){
          display:none !important;
        }
        #df-v23-report-bg{
          display:block !important;
        ...
        #df-v23-report-bg .df-v23-report-box{
          max-height:none !important;
          overflow:visible !important;
          box-shadow:none !important;
          border:0 !important;
  ...
  async function setPrioridadeV23(id, prioridade){
    const p = labelPrio(prioridade);
    try{
      if(typeof alterarPrioridadeNotaDF === "function"){
        await alterarPrioridadeNotaDF(id, p);
        return;
      }
    }catch(e){}
  ...
  window.renderNotasV23 = function(){
    cssV23();
    const lista = document.getElementById("notasLista");
    if(!lista) return;

    const arr = getNotasV23().slice(0,20);
    ...
    lista.innerHTML = arr.map(n => {
      const p = labelPrio(n.prioridade || "Normal");
      const pc = classPrio(p);
      const id = esc(n.id);
      return `
        <div class="df-v23-nota-card" data-nota-id="${id}">
          <div class="df-v23-nota-top">
            <div>
              <div class="df-v23-nota-title">${esc(n.titulo || "Sem título")}</div>
              <div class="df-v23-nota-text">${esc(n.texto || n.recado || "")}</div>
              <div class="df-v23-nota-meta">${esc(n.data_lembrete || n.data || "Sem data")}${n.loja ? " • " + esc(n.loja) : ""}</div>
            </div>
            <span class="df-v23-prio-badge ${pc}">${emojiPrio(p)} ${p}</span>
          </div>

          <div class="df-v23-nota-actions no-print">
            <button type="button" class="df-v23-btn df-v23-btn-edit" onclick="editarNotaDF('${id}')">✏️ Editar</button>

            <div class="df-v23-prio-box">
              <button type="button" class="df-v23-btn df-v23-btn-prio ${pc}">
                <span>${emojiPrio(p)} Prioridade</span>
                <strong>${p}</strong>
              </button>
              <div class="df-v23-prio-menu">
                <button type="button" class="df-v23-prio-option" data-id="${id}" data-p="Normal">🟢 Normal</button>
                <button type="button" class="df-v23-prio-option" data-id="${id}" data-p="Urgente">🔴 Urgente</button>
                <button type="button" class="df-v23-prio-option" data-id="${id}" data-p="Crítico">🔥 Crítico</button>
              </div>
            </div>

            <button type="button" class="df-v23-btn df-v23-btn-del" onclick="moverNotaLixeiraDF('${id}')">🗑️ Excluir</button>
          </div>
        </div>
      `;
    }).join("");
  ...
  function bindNotasV23(){
    document.addEventListener("click", async function(e){
      const btnPrio = e.target.closest(".df-v23-btn-prio");
      if(btnPrio){
        e.preventDefault();
        e.stopPropagation();
        const box = btnPrio.closest(".df-v23-prio-box");
        document.querySelectorAll(".df-v23-prio-box.open").forEach(b => {
          if(b !== box) b.classList.remove("open");
        });
        box.classList.toggle("open");
        return;
      ...
      const op = e.target.closest(".df-v23-prio-option");
      if(op){
        e.preventDefault();
        e.stopPropagation();
        const id = op.dataset.id;
        const p = op.dataset.p;
        const box = op.closest(".df-v23-prio-box");
        if(box) box.classList.remove("open");
        await setPrioridadeV23(id, p);
        setTimeout(renderNotasV23, 300);
        return;
      }

      if(!e.target.closest(".df-v23-prio-box")){
        document.querySelectorAll(".df-v23-prio-box.open").forEach(b => b.classList.remove("open"));
      }
    }, true);
  }

  function instalarRenderNotas(){
    cssV23();
    window.renderNotas = window.renderNotasV23;
    window.renderNotasMelhoradoDF = window.renderNotasV23;
    renderNotasV23();
  }

  /* PDF limpo */
  function filtrosRelatorioV23(){
    return {
      centro: document.getElementById("df224Centro")?.value || document.getElementById("df222Centro")?.value || "",
      status: document.getElementById("df224Status")?.value || document.getElementById("df222Status")?.value || "",
      dataInicio: document.getElementById("df224Inicio")?.value || document.getElementById("df222Inicio")?.value || "",
  ...
  function filtrarContasV23(f){
    const base = contasRelatorioV23.length ? contasRelatorioV23 : getContasBaseV23();
  ...
  function resumoContasV23(contas){
    const hoje = new Date().toISOString().slice(0,10);
    const abertas = contas.filter(c => String(c.status || "").toLowerCase() !== "pago");
    const pagas = contas.filter(c => String(c.status || "").toLowerCase() === "pago");
    const vencidas = abertas.filter(c => String(c.vencimento || c.data_vencimento || "").slice(0,10) < hoje);
  ...
  function montarRelatorioV23(f){
    const contas = filtrarContasV23(f);
    const r = resumoContasV23(contas);
    const centros = porCentroV23(contas);

    const cards = f.resumo ? `
      <div class="cards">
        <div class="card-mini"><div class="label">Quantidade</div><div class="num">${r.qtd}</div></div>
        <div class="card-mini"><div class="label">Total aberto</div><div class="num">${moedaV23(r.totalAberto)}</div></div>
        <div class="card-mini"><div class="label">Pago</div><div class="num">${moedaV23(r.totalPago)}</div></div>
        <div class="card-mini"><div class="label">Vencidas</div><div class="num">${moedaV23(r.totalVencido)}</div></div>
      </div>
    ` : "";
    ...
    const centroHTML = f.centroResumo ? `
      ...
      <div class="centros">
        ${centros.length ? centros.map(([centro,info]) => `
          <div class="centro"><div><strong>${esc(centro)}</strong><small>${info.qtd} conta(s)</small></div><b>${moedaV23(info.total)}</b></div>
        `).join("") : `<div class="empty">Nenhum centro encontrado.</div>`}
      </div>
    ` : "";
    ...
    const linhas = contas.map(c => {
      ...
      return `
        <tr>
          ...
          <td>${dataBR(c.vencimento || c.data_vencimento)}</td>
          <td><span class="status ${pago ? "pago" : "aberto"}">${esc(status)}</span></td>
          <td class="valor">${moedaV23(c.valor)}</td>
          <td>${esc(c.observacao || "")}</td>
        </tr>
      `;
    }).join("");
  ...
  window.df23GerarPDF = function(){
    cssV23();
    const f = filtrosRelatorioV23();

    let bg = document.getElementById("df-v23-report-bg");
    if(!bg){
      bg = document.createElement("div");
      bg.id = "df-v23-report-bg";
      bg.className = "df-v23-report-bg";
      bg.innerHTML = `
        <div class="df-v23-report-box">
          <div class="df-v23-report-actions no-print">
            <button type="button" onclick="window.print()">Imprimir / Salvar PDF</button>
            <button type="button" class="light" onclick="document.getElementById('df-v23-report-bg').classList.remove('open')">Fechar</button>
          </div>
          <div id="df-v23-report-content"></div>
        </div>
      `;
      document.body.appendChild(bg);
      bg.addEventListener("click", function(e){
    ...
    document.getElementById("df-v23-report-content").innerHTML = montarRelatorioV23(f);
    bg.classList.add("open");
  };

  // Sobrescreve somente o PDF; CSV fica intacto.
  window.df224GerarPDF = window.df23GerarPDF;
  window.df222GerarPDF = window.df23GerarPDF;
  window.df226GerarPDF = window.df23GerarPDF;

  function corrigirBotoesPDF(){
    document.querySelectorAll("button").forEach(btn => {
      const t = (btn.innerText || btn.textContent || "").trim().toLowerCase();
      const old = btn.getAttribute("onclick") || "";
      if(t.includes("gerar pdf") || t.includes("imprimir") || old.includes("df224GerarPDF") || old.includes("df222GerarPDF") || old.includes("df226GerarPDF")){
        btn.setAttribute("onclick", "window.df23GerarPDF()");
      }
    });
  }
  ...
  // roda depois dos scripts antigos para limpar o que eles recriam
...
/* ==========================================================
   ...
   - Não usa nova aba
   - Não usa iframe
   - Não usa Blob HTML para PDF
   - Não usa document.write
   - Não deixa scripts antigos sobrescreverem o botão
   - PDF imprime APENAS o relatório dentro do app
   - CSV mantido com integração real
   ========================================================== */
(function(){
  if (window.__DONA_FLOR_V24_PDF_FINAL__) return;
  window.__DONA_FLOR_V24_PDF_FINAL__ = true;
  ...
  function moedaV24(v){
    try {
      if (typeof moeda === "function") return moeda(v);
    } catch(e){}
    return Number(v || 0).toLocaleString("pt-BR", {style:"currency", currency:"BRL"});
  }
  ...
  async function buscarContasV24(){
    const url = supaURL();
    const key = supaKEY();
      ...
      if(url && key){
        ...
        if(r.ok){
          ...
          if(Array.isArray(data)){
            contasCacheV24 = data.filter(c => !c.deletado);
            return contasCacheV24;
          }
        }
      }
    }catch(e){
      console.warn("V24 relatório: fallback local", e);
    }
    ...
    try{
      if(Array.isArray(window.contasDados)){
        contasCacheV24 = window.contasDados.filter(c => !c.deletado);
        return contasCacheV24;
      }
    }catch(e){}
  ...
  function centrosV24(){
    return Array.from(new Set((contasCacheV24 || []).map(c => c.centro || c.centro_custo || c.loja).filter(Boolean))).sort();
  }

  function lerFiltrosV24(){
    return {
      centro: document.getElementById("df24Centro")?.value || "",
      status: document.getElementById("df24Status")?.value || "",
      inicio: document.getElementById("df24Inicio")?.value || "",
      fim: document.getElementById("df24Fim")?.value || "",
      resumo: document.getElementById("df24Resumo")?.checked !== false,
      centros: document.getElementById("df24Centros")?.checked !== false,
      detalhes: document.getElementById("df24Detalhes")?.checked !== false,
      aberto: document.getElementById("df24Aberto")?.checked || false
    };
  }

  function filtrarV24(f){
    return (contasCacheV24 || []).filter(c => {
      const centro = c.centro || c.centro_custo || c.loja || "";
      const status = c.status || "Aberto";
      const data = String(c.vencimento || c.data_vencimento || "").slice(0,10);
  ...
  function cssV24(){
    if(document.getElementById("df-v24-css")) return;
    const style = document.createElement("style");
    style.id = "df-v24-css";
    style.textContent = `
      .df-v221-report-actions,
      ...
      .df-v24-report .pago{background:#dcfce7 !important;color:#15803d !important;}
      .df-v24-report .aberto{background:#fef3c7 !important;color:#92400e !important;}

      @media(max-width:760px){
        .df-v24-box{padding:14px !important;border-radius:16px !important;}
        .df-v24-top{display:block !important;}
        .df-v24-actions{justify-content:flex-start !important;margin-top:10px !important;}
        .df-v24-grid,.df-v24-checks,.df-v24-report .centros{grid-template-columns:1fr !important;}
        .df-v24-report .cards{grid-template-columns:1fr 1fr !important;}
        .df-v24-report table{font-size:11px !important;}
      }
      ...
      @media print{
        ...
        #df-v24-report-bg .df-v24-actions{
          display:none !important;
        }

        #df-v24-report-content{
          display:block !important;
        }
  ...
  function montarRelatorioV24(f){
    const contas = filtrarV24(f);
    const r = resumoV24(contas);
    const centros = porCentroV24(contas);
    ...
    const cards = f.resumo ? `
      <div class="cards">
        <div class="card-mini"><div class="label">Quantidade</div><div class="num">${r.qtd}</div></div>
        <div class="card-mini"><div class="label">Total aberto</div><div class="num">${moedaV24(r.totalAberto)}</div></div>
        <div class="card-mini"><div class="label">Pago</div><div class="num">${moedaV24(r.totalPago)}</div></div>
        <div class="card-mini"><div class="label">Vencidas</div><div class="num">${moedaV24(r.totalVencido)}</div></div>
      </div>
    ` : "";
    ...
    const linhas = contas.map(c => {
      ...
      return `
        <tr>
          ...
          <td>${dataBR(c.vencimento || c.data_vencimento)}</td>
          <td><span class="status ${pago ? "pago" : "aberto"}">${esc(status)}</span></td>
          <td class="valor">${moedaV24(c.valor)}</td>
          <td>${esc(c.observacao || "")}</td>
        </tr>
      `;
    }).join("");
  ...
  async function abrirFiltrosV24(){
    cssV24();
    await buscarContasV24();

    let bg = document.getElementById("df-v24-filter-bg");
    if(!bg){
      bg = document.createElement("div");
      bg.id = "df-v24-filter-bg";
      bg.className = "df-v24-bg";
      document.body.appendChild(bg);
    ...
    const centros = centrosV24().map(c => `<option value="${esc(c)}">${esc(c)}</option>`).join("");

    bg.innerHTML = `
      <div class="df-v24-box">
        <div class="df-v24-top">
          <div>
            <h1 class="df-v24-title">Filtros do relatório</h1>
            <div class="df-v24-sub">Base carregada: ${contasCacheV24.length} conta(s).</div>
          </div>
          <div class="df-v24-actions">
            <button type="button" class="light" id="df24FecharFiltros">Fechar</button>
          </div>
        </div>

        <div class="df-v24-grid">
          <div class="df-v24-field"><label>Centro</label><select id="df24Centro"><option value="">Todos</option>${centros}</select></div>
          <div class="df-v24-field"><label>Status</label><select id="df24Status"><option value="">Todos</option><option>Aberto</option><option>Pago</option></select></div>
          <div class="df-v24-field"><label>Data inicial</label><input id="df24Inicio" type="date"></div>
          <div class="df-v24-field"><label>Data final</label><input id="df24Fim" type="date"></div>
        </div>

        <div class="df-v24-checks">
          <label class="df-v24-check"><input id="df24Resumo" type="checkbox" checked> Mostrar resumo</label>
          <label class="df-v24-check"><input id="df24Centros" type="checkbox" checked> Mostrar centros</label>
          <label class="df-v24-check"><input id="df24Detalhes" type="checkbox" checked> Mostrar detalhes</label>
          <label class="df-v24-check"><input id="df24Aberto" type="checkbox"> Somente em aberto</label>
        </div>

        <div class="df-v24-actions" style="margin-top:16px;justify-content:flex-start!important">
          <button type="button" id="df24GerarPdfBtn">Gerar PDF</button>
          <button type="button" id="df24CsvBtn">Exportar CSV</button>
        </div>
      </div>
    `;

    document.getElementById("df24FecharFiltros").addEventListener("click", () => bg.classList.remove("open"));
    document.getElementById("df24GerarPdfBtn").addEventListener("click", abrirPreviewPDFV24);
    document.getElementById("df24CsvBtn").addEventListener("click", exportarCSVV24);

    bg.classList.add("open");
  }

  function abrirPreviewPDFV24(e){
    if(e){
      e.preventDefault();
      e.stopPropagation();
      e.stopImmediatePropagation();
    ...
    filtrosV24 = lerFiltrosV24();

    const filtro = document.getElementById("df-v24-filter-bg");
    if(filtro) filtro.classList.remove("open");

    let bg = document.getElementById("df-v24-report-bg");
    if(!bg){
      bg = document.createElement("div");
      bg.id = "df-v24-report-bg";
      bg.className = "df-v24-bg";
      bg.innerHTML = `
        <div class="df-v24-box">
          <div class="df-v24-actions no-print">
            <button type="button" id="df24PrintBtn">Salvar PDF</button>
            <button type="button" class="light" id="df24CloseReportBtn">Fechar</button>
          </div>
          <div id="df-v24-report-content"></div>
        </div>
      `;
      document.body.appendChild(bg);
      ...
      document.getElementById("df24PrintBtn").addEventListener("click", function(evt){
        evt.preventDefault();
        evt.stopPropagation();
        evt.stopImmediatePropagation();
        setTimeout(() => window.print(), 150);
      }, true);
      document.getElementById("df24CloseReportBtn").addEventListener("click", () => bg.classList.remove("open"));
    }

    document.getElementById("df-v24-report-content").innerHTML = montarRelatorioV24(filtrosV24);
    bg.classList.add("open");
  }

  async function exportarCSVV24(e){
    if(e){
      e.preventDefault();
      e.stopPropagation();
      e.stopImmediatePropagation();
  ...
  function limparBotoesRelatorioAntigos(){
    document.querySelectorAll(".df-v221-report-actions").forEach(el => el.remove());
  }

  function configurarSelectV24(){
    cssV24();
    limparBotoesRelatorioAntigos();
    ...
    if(!sel.dataset.df24Bound){
      sel.dataset.df24Bound = "1";
  ...
  // Bloqueia funções antigas de PDF para não imprimirem código.
  window.df24AbrirFiltros = abrirFiltrosV24;
  window.df24GerarPdf = abrirPreviewPDFV24;
  window.df24Csv = exportarCSVV24;

  window.gerarRelatorioFinanceiroDF = abrirFiltrosV24;
  window.executarRelatorio = function(){
    const sel = document.getElementById("acaoRelatorio");
  ...
  window.df226GerarPDF = abrirPreviewPDFV24;
  window.df224GerarPDF = abrirPreviewPDFV24;
  window.df222GerarPDF = abrirPreviewPDFV24;
  window.df23GerarPDF = abrirPreviewPDFV24;

  if(document.readyState === "loading"){
    document.addEventListener("DOMContentLoaded", configurarSelectV24, {once:true});
  }else{
    configurarSelectV24();
  }

  setTimeout(configurarSelectV24, 700);
