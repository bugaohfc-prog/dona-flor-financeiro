...
function obterDestaqueVisualCiclo(ciclo) {
  ...
  if (atencao && atencao <= hoje) return { classe: 'is-due-soon', rotulo: 'Aten��o' }
                        ...
                        >
                          <div className="ferias-cycle-main">
                            ...
                            <div className="ferias-cycle-metrics">
                              ...
                              <span><small>Aten��o</small><strong>{formatarDataCurta(calcularDataAtencaoLimite(ciclo.data_limite_gozo))}</strong></span>
