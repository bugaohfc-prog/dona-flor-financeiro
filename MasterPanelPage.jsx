export default function CopilotStyles() {
  return (
    <style>{`
      ...
      /* FASE 11.8.1 — AI Narrative & Insights */
      .copilot-narrative-card {
        border-color: rgba(20,184,166,.28);
        background: linear-gradient(145deg, rgba(15,118,110,.12), rgba(15,23,42,.82));
      }
      .copilot-narrative-lead {
        font-size: 13px;
        line-height: 1.65;
        color: rgba(240,253,250,.92) !important;
      }
      .copilot-narrative-grid { display: grid; gap: 10px; margin-top: 12px; }
      .copilot-narrative-grid article {
        padding: 11px;
        border: 1px solid rgba(148,163,184,.18);
        border-radius: 16px;
        background: rgba(15,23,42,.45);
      }
      .copilot-narrative-grid small,
      .copilot-anomaly-list span {
        display: inline-flex;
        margin-bottom: 5px;
        color: #5eead4;
        font-weight: 800;
      ...
      .copilot-narrative-grid p,
      .copilot-anomaly-list p {
        margin: 0;
        color: rgba(226,232,240,.86) !important;
        line-height: 1.5;
        font-size: 12px;
      }
      .copilot-anomaly-list { display: grid; gap: 9px; margin-top: 12px; }
      .copilot-anomaly-list article {
        display: grid;
      ...
      .copilot-anomaly-list strong { display: block; color: #f8fafc; margin-bottom: 3px; }
      .copilot-anomaly-list small { display: block; margin-top: 6px; color: rgba(94,234,212,.88); font-weight: 700; }
